...
;(function(n, t) {
  ...
  function tt() {
    ...
    p(i.screens, function(n) {
      t > n
        ? (i.screensCss.gt && r('gt-' + n), i.screensCss.gte && r('gte-' + n))
        : t < n
        ? (i.screensCss.lt && r('lt-' + n), i.screensCss.lte && r('lte-' + n))
        : t === n &&
          (i.screensCss.lte && r('lte-' + n), i.screensCss.eq && r('e-q' + n), i.screensCss.gte && r('gte-' + n))
    })
  ...
  u.feature = function(n, t, i) {
    return n
      ? (Object.prototype.toString.call(t) === '[object Function]' && (t = t.call()),
        r((t ? '' : 'no-') + n),
        (u[n] = !!t),
        i || (k('no-' + n), k(n), u.feature()),
        u)
      : ((c.className += ' ' + a.join(' ')), (a = []), u)
  }
  u.feature('js', !0)
  ...
  s =
    /(chrome|firefox)[ \/]([\w.]+)/.exec(s) ||
    /(iphone|ipad|ipod)(?:.*version)?[ \/]([\w.]+)/.exec(s) ||
    /(android)(?:.*version)?[ \/]([\w.]+)/.exec(s) ||
    /(webkit|opera)(?:.*version)?[ \/]([\w.]+)/.exec(s) ||
    /(msie) ([\w.]+)/.exec(s) ||
    /(trident).+rv:(\w.)+/.exec(s) ||
    []
  o = s[1]
  ...
  for (u.browser = { name: o, version: h }, u.browser[o] = !0, l = 0, d = i.browsers.length; l < d; l++)
    for (f in i.browsers[l])
      if (o === f)
        for (r(f), g = i.browsers[l][f].min, nt = i.browsers[l][f].max, e = g; e <= nt; e++)
          h > e
            ? (i.browserCss.gt && r('gt-' + f + e), i.browserCss.gte && r('gte-' + f + e))
            : h < e
            ? (i.browserCss.lt && r('lt-' + f + e), i.browserCss.lte && r('lte-' + f + e))
            : h === e &&
              (i.browserCss.lte && r('lte-' + f + e),
  ...
  i.html5 &&
    ...
    h < 9 &&
    p(
      'abbr|article|aside|audio|canvas|details|figcaption|figure|footer|header|hgroup|main|mark|meter|nav|output|progress|section|summary|time|video'.split(
        '|'
      ),
      function(n) {
        y.createElement(n)
    ...
    f = {
      gradient: function() {
        ...
        return (
          (i.cssText = (
            n +
            s.join('gradient(linear,left top,right bottom,from(#9f9),to(#fff));' + n) +
            s.join('linear-gradient(left top,#eee,#fff);' + n)
          ).slice(0, -n.length)),
          !!i.backgroundImage
        )
      },
...
;(function(n, t) {
  ...
  function v(n) {
    var t = {},
      i,
      r
    if (typeof n == 'object') for (i in n) !n[i] || (t = { name: i, url: n[i] })
  ...
  function rt(t, i) {
    ...
    function o(f) {
      f = f || n.event
      ;(f.type === 'load' || (/loaded|complete/.test(u.readyState) && (!r.documentMode || r.documentMode < 9))) &&
    ...
    h === 'css'
      ...
      : ((u = r.createElement('script')), (u.type = 'text/' + (t.type || 'javascript')), (u.src = t.url))
  ...
  function k() {
    r.addEventListener
      ...
      : r.readyState === 'complete' && (r.detachEvent('onreadystatechange', k), e())
  }
  var r = n.document,
    d = [],
    h = {},
