...
!(function (n, e) {
  ...
  var v = 'hljs-ln',
    ...
    y = /\r\n|\r|\n/g
  hljs
    ? ((hljs.initLineNumbersOnLoad = r), (hljs.lineNumbersBlock = l), (hljs.lineNumbersValue = o), t())
...
const Plugin = {
      ...
      if (highlightSteps.length > 1) {
        ...
        highlightSteps.slice(1).forEach(function (highlight) {
          ...
          fragmentBlock.addEventListener(
            'visible',
            Plugin.scrollHighlightedLineIntoView.bind(Plugin, fragmentBlock, scrollState)
          )
          fragmentBlock.addEventListener(
            'hidden',
            Plugin.scrollHighlightedLineIntoView.bind(Plugin, fragmentBlock.previousSibling, scrollState)
          )
        })
  ...
  scrollHighlightedLineIntoView: function (block, scrollState, skipAnimation) {
    ...
    var targetTop =
      highlightBounds.top +
      (Math.min(highlightBounds.bottom - highlightBounds.top, viewportHeight) - viewportHeight) / 2
      ...
      highlightSteps[0].forEach(function (highlight) {
        ...
        if (typeof highlight.end === 'number') {
          elementsToHighlight = [].slice.call(
            block.querySelectorAll('table tr:nth-child(n+' + highlight.start + '):nth-child(-n+' + highlight.end + ')')
          )
        }
