...
var J,
  ...
  Ze = function (e, t) {
    ...
    return (
      $e(e) &&
        ('function' != typeof (n = e.constructor) || (n !== Array && !$e(n.prototype))
...
We
  ? (Q = (J = We.split('.'))[0] + J[1])
  : Fe && (!(J = Fe.match(/Edge\/(\d+)/)) || J[1] >= 74) && (J = Fe.match(/Chrome\/(\d+)/)) && (Q = J[1])
var Be = Q && +Q,
  Ve = De('species'),
  Ke = function (e) {
    return (
...
var et = function (e) {
  ...
  it = { forEach: rt(0), map: rt(1), filter: rt(2), some: rt(3), every: rt(4), find: rt(5), findIndex: rt(6) },
  ot = function (e, t) {
    var n = [][e]
    return (
      !!n &&
...
var wt =
    ...
    function (e, t) {
      var n
      return (
        null !== e ? ((mt.prototype = A(e)), (n = new mt()), (mt.prototype = null), (n[bt] = e)) : (n = xt()),
        void 0 === t ? n : vt(n, t)
      )
    },
  St = De('unscopables'),
...
var Et,
  ...
  It = De('iterator'),
  Ct = !1
;[].keys && ('next' in (Tt = [].keys()) ? (At = Pt(Pt(Tt))) !== Object.prototype && (Et = At) : (Ct = !0)),
  null == Et && (Et = {}),
  m(Et, It) ||
    R(Et, It, function () {
      return this
...
var Lt = { IteratorPrototype: Et, BUGGY_SAFARI_ITERATORS: Ct },
  ...
  Nt = De('toStringTag'),
  qt = function (e, t, n) {
    e && !m((e = n ? e : e.prototype), Nt) && Mt(e, Nt, { configurable: !0, value: t })
  },
  ...
  Bt = function (e, t, n, r, i, o, a) {
    ...
    if (
      (y &&
        ...
        Ft !== Object.prototype &&
          l.next &&
          (Pt(l) !== Ft && (Zt ? Zt(l, Ft) : 'function' != typeof l[Ht] && R(l, Ht, Wt)), qt(l, h, !0))),
      'values' == i &&
        d &&
        'values' !== d.name &&
        ((p = !0),
...
ze(
  { target: 'Array', proto: !0, forced: !en || !tn },
  {
    slice: function (e, t) {
      ...
      if (
        $e(o) &&
        ('function' != typeof (n = o.constructor) || (n !== Array && !$e(n.prototype))
      ...
      if (o) a = e
        ...
        if (void 0 !== (p = l) && (Rt.Array === p || kn[mn] === p)) {
          for (s = 0, c = ce(e.length); c > s; s++)
            if ((u = i ? g(A((h = e[s]))[0], h[1]) : g(e[s])) && u instanceof t) return u
          return new t(!1)
        }
        a = l.call(e)
      }
      for (f = a.next; !(h = f.call(a)).done; )
        if ('object' == typeof (u = wn(a, g, h.value, i)) && u && u instanceof t) return u
      return new t(!1)
    }).stop = function (e) {
      return new t(!0, e)
    }
...
;(Cn && Ln) ||
  ...
  'process' == f(Mn)
    ...
    : Nn && !Pn
    ? ((jn = (Rn = new Nn()).port2), (Rn.port1.onmessage = Gn), (On = tt(jn.postMessage, jn, 1)))
    : !r.addEventListener || 'function' != typeof postMessage || r.importScripts || i(Hn) || 'file:' === In.protocol
    ? (On =
...
var cr,
          ...
          try {
            f
              ? (o || (2 === t.rejection && Dr(e, t), (t.rejection = 1)),
                ...
                l === u.promise ? p(Er('Promise-chain cycle')) : (s = Cr(l)) ? s.call(l, h, p) : h(l))
              : p(i)
          } catch (e) {
            g && !c && g.exit(), p(e)
          }
  ...
  Mr = function (e, t, n) {
    var i, o
    $r
      ? (((i = Ar.createEvent('Event')).promise = t), (i.reason = n), i.initEvent(e, !1, !0), r.dispatchEvent(i))
...
Pr &&
  ...
  ((cr = function (e) {
    wr(this, { type: kr, done: !1, notified: !1, parent: !1, reactions: [], rejection: !1, state: 0, value: void 0 })
...
if (
  ...
  for (
    var oi = function (e, t) {
        ...
        ri ? i && !o && (e = e.source) : e instanceof oi && (o && (t = Wr.call(e)), (e = e.source)),
...
Bt(
  ...
  function () {
    var e,
      ...
      n = t.string,
      r = t.index
    return r >= n.length ? { value: void 0, done: !0 } : ((e = wi(n, r)), (t.index += e.length), { value: e, done: !1 })
  }
)
var Ei = De('species'),
  Ai = !i(function () {
    ...
    if (!a || !l || ('replace' === e && (!Ai || !Ti || Ri)) || ('split' === e && !ji)) {
      var s = /./[o],
        c = n(
          ...
          { REPLACE_KEEPS_$0: Ti, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: Ri }
        ),
        u = c[0],
        f = c[1]
  ...
  return [
    ...
    function (e, r) {
      ...
      for (var v, y = '', b = 0, m = 0; m < g.length; m++) {
        d = g[m]
        for (var k = String(d[0]), x = Ci(Li(le(d.index), u.length), 0), w = [], S = 1; S < d.length; S++)
      ...
      (r =
        ...
        ''.split(/.?/).length
          ? function (e, n) {
              ...
              return (
                u === r.length ? (!l && f.test('')) || s.push('') : s.push(r.slice(u)), s.length > i ? s.slice(0, i) : s
              )
            }
      ...
      [
        ...
        function (e, i) {
          ...
          for (var p = 0, g = 0, d = []; g < l.length; ) {
            ...
            if (null === y || (v = Ui(ce(f.lastIndex + (Zi ? 0 : g)), l.length)) === p) g = Pi(l, g, c)
            else {
  ...
  { target: 'Array', proto: !0, forced: !Ho || !Wo },
  {
    splice: function (e, t) {
      var n,
        ...
        f = arguments.length
      if (
        (0 === f ? (n = r = 0) : 1 === f ? ((n = 0), (r = c - u)) : ((n = f - 2), (r = Vo(Bo(le(t), 0), c - u))),
      ...
      uo(e, [
            ...
            if (t) {
              for (
                var n,
                  ...
                  u = t[2],
                  f = u.length > 1,
                  h = { type: 'list', raw: c, ordered: f, start: f ? +u : '', loose: !1, items: [] },
                ...
                (c = n = p[v]),
                  ...
                  h.items.push({ type: 'list_item', raw: c, task: l, checked: s, loose: a, text: n })
              return h
            }
          },
        },
            ...
            if (t) {
              ...
              if (n.header.length === n.align.length) {
                ...
                for (i = n.cells.length, r = 0; r < i; r++)
                  n.cells[r] = _a(n.cells[r].replace(/^ *\| *| *\| *$/g, ''), n.header.length)
                return n
              }
            }
          },
        ...
        },
        {
          ...
          value: function (e) {
            ...
            if (t) {
              ...
              return (
                r && i && (n = n.substring(1, n.length - 1)), (n = Ea(n, !0)), { type: 'codespan', raw: t[0], text: n }
              )
            }
          },
        },
        ...
        },
        {
          ...
          value: function (e, t) {
            ...
            if (i)
              return (
                (r = '@' === i[2] ? 'mailto:' + (n = Ea(this.options.mangle ? t(i[1]) : i[1])) : (n = Ea(i[1]))),
        ...
        },
        {
          ...
          value: function (e, t) {
            ...
            if ((n = this.rules.inline.url.exec(e))) {
              var r, i
              if ('@' === n[2]) i = 'mailto:' + (r = Ea(this.options.mangle ? t(n[0]) : n[0]))
              else {
                var o
                do {
...
;($a.def = ja($a.def).replace('label', $a._label).replace('title', $a._title).getRegex()),
  ($a.bullet = /(?:[*+-]|\d{1,9}\.)/),
  ($a.item = /^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/),
  ...
  ($a.paragraph = ja($a._paragraph)
    ...
    .replace('tag', $a._tag)
    .getRegex()),
  ($a.blockquote = ja($a.blockquote).replace('paragraph', $a.paragraph).getRegex()),
  ($a.normal = za({}, $a)),
  ($a.gfm = za({}, $a.normal, {
    nptable:
...
;(Pa.em = ja(Pa.em)
  ...
  (Pa._email = /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/),
  (Pa.autolink = ja(Pa.autolink).replace('scheme', Pa._scheme).replace('email', Pa._email).getRegex()),
  (Pa._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
  (Pa.tag = ja(Pa.tag).replace('comment', $a._comment).replace('attribute', Pa._attribute).getRegex()),
  (Pa._label = /(?:\[[^\[\]]*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
  (Pa._href = /<(?:\\[<>]?|[^\s<>\\])*>|[^\s\x00-\x1f]*/),
  (Pa._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
  (Pa.link = ja(Pa.link).replace('label', Pa._label).replace('href', Pa._href).replace('title', Pa._title).getRegex()),
  ...
  (Pa.gfm.url = ja(Pa.gfm.url, 'i').replace('email', Pa.gfm._extended_email).getRegex()),
  (Pa.breaks = za({}, Pa.gfm, {
...
var Da = (function () {
    function e(t) {
      ...
      this.options.pedantic
        ...
        : this.options.gfm && ((n.block = La.gfm), this.options.breaks ? (n.inline = Ma.breaks) : (n.inline = Ma.gfm)),
            ...
            value: function (e) {
              for (
                ...
                if ((t = this.tokenizer.escape(e))) (e = e.substring(t.raw.length)), n.push(t)
                  ...
                  (e = e.substring(t.raw.length)), (t.tokens = this.inlineTokens(t.text, [], r, i)), n.push(t)
                else if ((t = this.tokenizer.autolink(e, qa))) (e = e.substring(t.raw.length)), n.push(t)
                else if (r || !(t = this.tokenizer.url(e, qa))) {
                  if ((t = this.tokenizer.inlineText(e, i, Na))) (e = e.substring(t.raw.length)), n.push(t)
                  else if (e) {
              ...
              for (t = 0; t < x; t++)
                switch ((u = e[t]).type) {
                  ...
                  case 'blockquote':
                    ...
                    continue
                  case 'list':
                    for (f = u.ordered, h = u.start, p = u.loose, i = u.items.length, c = '', n = 0; n < i; n++)
...
function nl(e, t, n) {
  ...
  try {
    ...
    if (((e.message += '\nPlease report this to https://github.com/markedjs/marked.'), t.silent))
      return '<p>An error occurred:</p><pre>' + Ja(e.message + '', !0) + '</pre>'
    throw e
  }
}
...
export default function () {
  ...
  function i(e, t) {
    ...
    return (
      2 === n.length && (e = n[0] + '<aside class="notes">' + rl(n[1].trim()) + '</aside>'),
    ...
    for (var h = '', p = 0, g = f.length; p < g; p++)
      f[p] instanceof Array
        ? ((h += '<section ' + t.attributes + '>'),
          ...
          (h += '</section>'))
        : (h += '<section ' + t.attributes + ' data-markdown>' + i(f[p], t) + '</section>')
    return h
  }
  function a(e) {
            ...
            if (null != n && null != n.childNodes && n.childNodes.length > 0)
              for (var a = n, s = 0; s < n.childNodes.length; s++) {
                ...
                'section' == c.nodeName && ((h = c), (a = c)),
                  ('function' != typeof c.setAttribute && c.nodeType != Node.COMMENT_NODE) || e(h, c, a, i, o)
              }
    ...
    init: function (t) {
      ...
      return (
        (n.code = function (e, t) {
          ...
          return (
            il.test(t) &&
              ((n = t.match(il)[1].trim()), (n = 'data-line-numbers="'.concat(n, '"')), (t = t.replace(il, '').trim())),
