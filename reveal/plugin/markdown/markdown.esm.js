...
function i(e, t) {
  ...
  if (Object.getOwnPropertySymbols) {
    ...
    for (r = 0; r < i.length; r++)
      (n = i[r]), t.indexOf(n) >= 0 || (Object.prototype.propertyIsEnumerable.call(e, n) && (u[n] = e[n]))
  }
  return u
}
function o(e, t) {
...
var E = function (e, t) {
  ...
  C = D(function () {
    ...
    ? function (e) {
        return 'String' == F(e) ? b.call(e, '') : Object(e)
      }
    : Object,
  x = function (e) {
...
var ve = ge.inspectSource,
  Ae = ve,
  ye = p.WeakMap,
  Ee = 'function' == typeof ye && /native code/.test(Ae(ye)),
  me = { exports: {} },
  ke = De
...
var Fe,
  ...
  we = Math.random(),
  Be = function (e) {
    return 'Symbol(' + String(void 0 === e ? '' : e) + ')_' + (++xe + we).toString(36)
  },
  Se = me.exports,
  _e = Be,
  Te = Se('keys'),
...
var Ve = {
    ...
    getterFor: function (e) {
      return function (t) {
        var n
        if (!Ie(t) || (n = be(t)).type !== e) throw TypeError('Incompatible receiver, ' + e + ' required')
        return n
      }
    },
  },
...
;(se.exports = function (e, t, n, r) {
  var u,
    ...
    a = !!r && !!r.noTargetGet
  'function' == typeof n &&
    ('string' != typeof t || Xe(n, 'name') || Ke(n, 'name', t),
    (u = et(n)).source || (u.source = tt.join('string' == typeof t ? t : ''))),
    e !== Ye ? (i ? !a && e[t] && (o = !0) : delete e[t], o ? (e[t] = n) : Ke(e, t, n)) : o ? (e[t] = n) : We(t, n)
})(Function.prototype, 'toString', function () {
  return ('function' == typeof this && Qe(this).source) || Je(this)
})
var nt = p,
  rt = p,
  ut = function (e) {
  ...
  it = function (e, t) {
    return arguments.length < 2 ? ut(nt[e]) || ut(rt[e]) : (nt[e] && nt[e][t]) || (rt[e] && rt[e][t])
  },
  ot = {},
  at = Math.ceil,
  lt = Math.floor,
  ...
  xt = function (e, t) {
    ...
    for (; t.length > u; ) kt(r, (n = t[u++])) && (~bt(i, n) || i.push(n))
    return i
  },
  wt = [
    'constructor',
...
var Tt = ot,
  ...
  en = function (e, t) {
    var n,
      ...
      l = e.global,
      s = e.stat
    if ((n = l ? Vt : s ? Vt[a] || Wt(a, {}) : (Vt[a] || {}).prototype))
      for (r in t) {
        if (
          ((i = t[r]),
          (u = e.noTargetGet ? (o = Yt(n, r)) && o.value : n[r]),
          !Qt(l ? r : a + (s ? '.' : '#') + r, e.forced) && void 0 !== u)
        ) {
          if (typeof i == typeof u) continue
          Jt(i, u)
        }
        ;(e.sham || (u && u.sham)) && Kt(i, 'sham', !0), Xt(n, r, i, e)
      }
  },
  tn = ee,
  nn = function () {
...
var an = nn,
  ...
  fn = sn('native-string-replace', String.prototype.replace),
  pn = cn,
  hn = (function () {
    var e = /a/,
      t = /b*/g
    return cn.call(e, 'a'), cn.call(t, 'a'), 0 !== e.lastIndex || 0 !== t.lastIndex
  })(),
...
var vn,
  ...
  Fn = kn && kn.v8
Fn
  ? (An = (vn = Fn.split('.'))[0] < 4 ? 1 : vn[0] + vn[1])
  : En && (!(vn = En.match(/Edge\/(\d+)/)) || vn[1] >= 74) && (vn = En.match(/Chrome\/(\d+)/)) && (An = vn[1])
var bn = An && +An,
  Cn = bn,
  xn = D,
  wn =
  ...
  Pn = function (e) {
    return (
      (Tn(In, e) && (Rn || 'string' == typeof In[e])) ||
        (Rn && Tn(zn, e) ? (In[e] = zn[e]) : (In[e] = $n('Symbol.' + e))),
      In[e]
    )
  },
  Ln = se.exports,
  ...
  Wn = function (e, t, n, r) {
    ...
    if (!i || !o || ('replace' === e && (!Hn || !Vn || Kn)) || ('split' === e && !Xn)) {
      var a = /./[u],
        l = n(
          u,
          ''[e],
          ...
          { REPLACE_KEEPS_$0: Vn, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: Kn }
        ),
        s = l[0],
        c = l[1]
    ...
    return function (t, n) {
      ...
      return o < 0 || o >= a
        ? e
          ? ''
          : void 0
        : (r = i.charCodeAt(o)) < 55296 || r > 56319 || o + 1 === a || (u = i.charCodeAt(o + 1)) < 56320 || u > 57343
        ? e
          ? i.charAt(o)
          : r
        : e
  ...
  fr = function (e, t) {
    ...
    if ('RegExp' !== sr(e)) throw TypeError('RegExp#exec called on incompatible receiver')
    return cr.call(e, t)
  },
  pr = Wn,
  hr = ee,
      ...
      or.call(i, l, function (i, l) {
        ...
        switch (l.charAt(0)) {
          ...
          default:
            ...
            if (c > a) {
              var f = ir(c / 10)
              return 0 === f ? i : f <= a ? (void 0 === r[f - 1] ? l.charAt(1) : r[f - 1] + l.charAt(1)) : i
            }
            s = r[c - 1]
        }
        return void 0 === s ? '' : s
  ...
  return [
    ...
    function (e, r) {
      ...
      for (var h = []; ; ) {
        ...
        if (null === D) break
        if ((h.push(D), !f)) break
        '' === String(D[0]) && (l.lastIndex = vr(s, Dr(l.lastIndex), p))
      }
      for (var g, d = '', v = 0, A = 0; A < h.length; A++) {
        D = h[A]
        for (var y = String(D[0]), E = Er(mr(gr(D.index), s.length), 0), m = [], k = 1; k < D.length; k++)
...
var kr = _,
  Fr = ee,
  br = function (e) {
    if (!kr(e) && null !== e) throw TypeError("Can't set " + String(e) + ' as a prototype')
    return e
  },
  Cr =
    ...
    ('__proto__' in {}
      ? (function () {
          ...
          return function (n, r) {
            return Fr(n), br(r), t ? e.call(n, r) : (n.__proto__ = r), n
          }
        })()
      : void 0),
  xr = _,
...
if (
  ...
  Lr(
    ...
    !tu ||
      nu ||
      Vr(function () {
        return (eu[Xr] = !1), Wr(Qr) != Qr || Wr(eu) == eu || '/a/i' != Wr(Qr, 'i')
      })
  )
) {
  for (
    var ru = function (e, t) {
        ...
        tu ? u && !i && (e = e.source) : e instanceof ru && (i && (t = Zr.call(e)), (e = e.source)),
          nu && (n = !!t && t.indexOf('y') > -1) && (t = t.replace(/y/g, ''))
        var o = Mr(tu ? new Wr(e, t) : Wr(e, t), r ? this : Jr, ru)
        nu && n && (Yr(o).sticky = !0)
        return o
      },
      uu = function (e) {
  ...
  au(
    ...
    function () {
      var e = lu(this),
        t = String(e.source),
        n = e.flags
      return '/' + t + '/' + String(void 0 === n && e instanceof RegExp && !('flags' in fu) ? cu.call(e) : n)
    },
    { unsafe: !0 }
  )
var gu = ee,
...
Wn('match', 1, function (e, t, n) {
  return [
    ...
    function (e) {
      ...
      var o = u.unicode
      u.lastIndex = 0
      for (var a, l = [], s = 0; null !== (a = yu(u, i)); ) {
        var c = String(a[0])
        ;(l[s] = c), '' === c && (u.lastIndex = Au(i, du(u.lastIndex), o)), s++
      }
      return 0 === s ? null : l
    },
  ]
...
var Ou = function (e) {
  ...
  zu = function (e, t) {
    var n,
      r = Ru(e).constructor
    return void 0 === r || null == (n = Ru(r)[Iu]) ? t : ju(n)
  },
  $u = Wn,
  Pu = Tr,
  Lu = ee,
          ...
          ? function (e, n) {
              ...
              for (
                ...
                !(
                  ...
                  i.length > 1 && i.index < r.length && Vu.apply(l, i.slice(1)),
                  (a = i[0].length),
                  (c = o),
                  l.length >= u)
                );
              ...
              return (
                c === r.length ? (!a && f.test('')) || l.push('') : l.push(r.slice(c)), l.length > u ? l.slice(0, u) : l
              )
            }
      ...
      [
        ...
        function (e, u) {
          ...
          var o = Lu(e),
            ...
            l = Nu(o, RegExp),
            s = o.unicode,
            c = (o.ignoreCase ? 'i' : '') + (o.multiline ? 'm' : '') + (o.unicode ? 'u' : '') + (Hu ? 'g' : 'y'),
            f = new l(Hu ? '^(?:' + o.source + ')' : o, c),
          ...
          for (var h = 0, D = 0, g = []; D < a.length; ) {
            ...
            if (null === v || (d = Yu(qu(f.lastIndex + (Hu ? D : 0)), a.length)) === h) D = Uu(a, D, s)
            else {
...
var Ku = x,
  ...
  Qu = function (e) {
    return function (t) {
      var n = String(Ku(t))
      return 1 & e && (n = n.replace(Wu, '')), 2 & e && (n = n.replace(Ju, '')), n
    }
  },
...
var ui = {
  ...
  pi = function (e, t) {
    ...
    return (
      ci(e) &&
        ('function' != typeof (n = e.constructor) || (n !== Array && !ci(n.prototype))
          ? si(n) && null === (n = n[fi]) && (n = void 0)
          : (n = void 0)),
  ...
  bi = xu('forEach')
    ? [].forEach
    : function (e) {
        return mi(this, e, arguments.length > 1 ? arguments[1] : void 0)
      },
  Ci = le
for (var xi in Fi) {
  var wi = ki[xi],
...
var _i = '[object z]' === String(Si),
  ...
  Ii = Ti
    ...
    : function (e) {
        ...
        return void 0 === e
          ...
          : ji
          ? Oi(t)
          : 'Object' == (r = Oi(t)) && 'function' == typeof t.callee
          ? 'Arguments'
          : r
      },
  zi = Ii,
  ...
  Li = se.exports,
  Mi = $i
Pi || Li(Object.prototype, 'toString', Mi, { unsafe: !0 })
var Ni = p.Promise,
  Ui = se.exports,
  qi = J.f,
  Zi = $,
  Gi = Pn('toStringTag'),
  Hi = function (e, t, n) {
    e && !Zi((e = n ? e : e.prototype), Gi) && qi(e, Gi, { configurable: !0, value: t })
  },
  Vi = {},
  Yi = Vi,
  Ki = Pn('iterator'),
  ...
  uo = oi,
  io = function (e) {
    if (null != e) return e[Qi] || e['@@iterator'] || Ji[Wi(e)]
  },
  oo = function (e) {
    var t = e.return
...
var po,
  ...
  $o = function (e) {
    yo.postMessage(e + '', xo.protocol + '//' + xo.host)
  }
;(wo && Bo) ||
  ((wo = function (e) {
  ...
  Co
    ...
    : _o && !bo
    ? ((Do = (ho = new _o()).port2), (ho.port1.onmessage = zo), (po = mo(Do.postMessage, Do, 1)))
    : yo.addEventListener &&
      ...
      'file:' !== xo.protocol &&
      !Eo($o)
    ? ((po = $o), yo.addEventListener('message', zo, !1))
    : (po =
...
var Po,
  ...
  Jo = Vo,
  Qo = Ao,
  ea = Yo.MutationObserver || Yo.WebKitMutationObserver,
  ta = Yo.document,
  na = Yo.process,
  ra = Yo.Promise,
...
var ca,
  ...
  Oa = function (e, t, n) {
    var r,
      ...
      d = function (e) {
        return f ? (to(e), h ? D(e[0], e[1], g) : D(e[0], e[1])) : h ? D(e, g) : D(e)
      }
    if (p) r = e
    else {
      if ('function' != typeof (u = io(e))) throw TypeError('Target is not iterable')
      if (no(u)) {
        for (i = 0, o = ro(e.length); o > i; i++) if ((a = d(e[i])) && a instanceof ao) return a
        return new ao(!1)
      }
      r = u.call(e)
    }
    for (l = r.next; !(s = l.call(r)).done; ) {
      ...
      if ('object' == typeof a && a && a instanceof ao) return a
    }
    return new ao(!1)
  },
  Ra = function (e, t) {
  ...
  ll = Ua(Va, function () {
    ...
    return ((t.constructor = {})[Ha] = n), !(al = t.then(function () {}) instanceof n) || (!e && qa && !ol)
  }),
  sl =
    ll ||
    !Ra(function (e) {
  ...
  cl = function (e) {
    var t
    return !(!Ba(e) || 'function' != typeof (t = e.then)) && t
  },
  fl = function (e, t) {
    if (!e.notified) {
      e.notified = !0
      ...
      za(function () {
        for (var r = e.value, u = 1 == e.state, i = 0; n.length > i; ) {
          ...
          try {
            c
              ? (u || (2 === e.rejection && gl(e), (e.rejection = 1)),
                !0 === c ? (o = r) : (h && h.enter(), (o = c(r)), h && (h.exit(), (l = !0))),
                o === s.promise ? p(el('Promise-chain cycle')) : (a = cl(o)) ? a.call(o, f, p) : f(o))
              : p(r)
          } catch (e) {
            h && !l && h.exit(), p(e)
          }
        }
        ;(e.reactions = []), (e.notified = !1), t && !e.rejection && hl(e)
      })
    }
  },
  pl = function (e, t, n) {
    var r, u
    il
      ? (((r = tl.createEvent('Event')).promise = t), (r.reason = n), r.initEvent(e, !1, !0), Ea.dispatchEvent(r))
      : (r = { promise: t, reason: n }),
      !ol && (u = Ea['on' + e]) ? u(r) : 'unhandledrejection' === e && Pa('Unhandled promise rejection', n)
  },
  hl = function (e) {
    Ia.call(Ea, function () {
      var t,
      ...
      if (
        Dl(e) &&
        ((t = Ma(function () {
          Za ? nl.emit('unhandledRejection', r, n) : pl('unhandledrejection', n, r)
        })),
  ...
  gl = function (e) {
    Ia.call(Ea, function () {
      var t = e.facade
      Za ? nl.emit('rejectionHandled', t) : pl('rejectionhandled', t, e.value)
    })
  },
  dl = function (e, t, n) {
    return function (r) {
  ...
  vl = function (e, t, n) {
    e.done || ((e.done = !0), n && (e = n), (e.value = t), (e.state = 2), fl(e, !0))
  },
  Al = function (e, t, n) {
    if (!e.done) {
      ;(e.done = !0), n && (e = n)
...
if (
  ...
  ((ca = function (e) {
    Ka(this, { type: Va, done: !1, notified: !1, parent: !1, reactions: [], rejection: !1, state: 0, value: void 0 })
  }).prototype = ba(Qa, {
    then: function (e, t) {
      var n = Xa(this),
        r = rl(ja(this, Ja))
  ...
  (fa = function () {
    var e = new ca(),
      t = Ya(e)
    ;(this.promise = e), (this.resolve = dl(Al, t)), (this.reject = dl(vl, t))
  }),
  (La.f = rl =
    function (e) {
...
ya({ global: !0, wrap: !0, forced: ll }, { Promise: Ja }),
  xa(Ja, Va, !1),
  wa(Va),
  (pa = ma(Va)),
  ya(
...
wl(
  { target: 'Array', proto: !0, forced: !Il },
  {
    slice: function (e, t) {
      ...
      if (
        Sl(i) &&
        ('function' != typeof (n = i.constructor) || (n !== Array && !Sl(n.prototype))
          ? Bl(n) && null === (n = n[zl]) && (n = void 0)
          : (n = void 0),
        n === Array || void 0 === n)
      )
        return $l.call(i, a, l)
      for (r = new (void 0 === n ? Array : n)(Pl(l - a, 0)), u = 0; a < l; a++, u++) a in i && Rl(r, u, i[a])
      return (r.length = u), r
    },
  }
)
var Ll,
  ...
  Hl = g
    ...
    : function (e, t) {
        Zl(e)
        for (var n, r = Gl(t), u = r.length, i = 0; u > i; ) ql.f(e, (n = r[i++]), t[n])
        return e
      },
  Vl = ee,
  Yl = Hl,
  ...
  ns = function () {
    ...
    ns = Ll
      ...
      : (((t = Jl('iframe')).style.display = 'none'),
        ...
        e.close(),
        e.F)
    for (var n = Kl.length; n--; ) delete ns.prototype[Kl[n]]
    return ns()
  }
Xl[Ql] = !0
var rs =
    ...
    function (e, t) {
      var n
      return (
        null !== e ? ((es.prototype = Vl(e)), (n = new es()), (es.prototype = null), (n[Ql] = e)) : (n = ns()),
        void 0 === t ? n : Yl(n, t)
      )
    },
  us = rs,
  ...
  os = Pn('unscopables'),
  as = Array.prototype
null == as[os] && is.f(as, os, { configurable: !0, value: us(null) })
var ls,
  ss,
  cs,
  fs = function (e) {
  ...
  Fs = Pn('iterator'),
  bs = !1
;[].keys && ('next' in (cs = [].keys()) ? (ss = Es(Es(cs))) !== Object.prototype && (ls = ss) : (bs = !0)),
  (null == ls ||
    ys(function () {
      var e = {}
...
var Cs = { IteratorPrototype: ls, BUGGY_SAFARI_ITERATORS: bs },
  ...
  Rs = function (e, t, n) {
    var r = t + ' Iterator'
    return (e.prototype = ws(xs, { next: Bs(1, n) })), Ss(e, r, !1), (_s[r] = Ts), e
  },
  js = As,
  Is = Cr,
  zs = Hi,
  ...
  Zs = function (e, t, n, r, u, i, o) {
    ...
    if (
      (d &&
        ...
        Ms !== Object.prototype &&
          a.next &&
          (js(a) !== Ms && (Is ? Is(a, Ms) : 'function' != typeof a[Us] && $s(a, Us, qs)), zs(a, f, !0))),
      'values' == u &&
        D &&
        'values' !== D.name &&
        ((p = !0),
      ...
      if (((l = { values: c('values'), keys: i ? g : c('keys'), entries: c('entries') }), o))
        for (s in l) (Ns || p || !(s in h)) && Ps(h, s, l[s])
      else Os({ target: t, proto: !0, forced: Ns || p }, l)
    return l
  },
  Gs = S,
  Hs = fs,
  ...
  Js = Ks(
    ...
    'Array',
    function (e, t) {
      Xs(this, { type: 'Array Iterator', target: Gs(e), index: 0, kind: t })
    },
    function () {
      var e = Ws(this),
        t = e.target,
...
tc(
  ...
  'String',
  function (e) {
    nc(this, { type: 'String Iterator', string: String(e), index: 0 })
  },
  function () {
    var e,
      t = rc(this),
      n = t.string,
      r = t.index
    return r >= n.length ? { value: void 0, done: !0 } : ((e = Qs(n, r)), (t.index += e.length), { value: e, done: !1 })
  }
)
var uc = p,
  ic = ui,
    ...
    concat: function (e) {
      ...
      for (t = -1, r = arguments.length; t < r; t++)
        if (Sc((i = -1 === t ? o : arguments[t]))) {
          if (l + (u = mc(i.length)) > 9007199254740991) throw TypeError('Maximum allowed index exceeded')
          for (n = 0; n < u; n++, l++) n in i && kc(a, l, i[n])
        } else {
...
en(
  ...
  {
    includes: function (e) {
      return Oc(this, e, arguments.length > 1 ? arguments[1] : void 0)
    },
  }
),
  Rc('includes')
var jc = Tr,
  Ic = Pn('match'),
  zc = function (e) {
    if (jc(e)) throw TypeError("The method doesn't accept regular expressions")
    return e
  },
  $c = x
en(
  ...
  {
    includes: function (e) {
      return !!~String($c(this)).indexOf(zc(e), arguments.length > 1 ? arguments[1] : void 0)
    },
  }
)
var Pc = x,
  ...
  Nc = function (e, t, n, r) {
    var u = String(Pc(e)),
      i = '<' + t
    return '' !== n && (i += ' ' + n + '="' + String(r).replace(Lc, '&quot;') + '"'), i + '>' + u + '</' + t + '>'
  }
en(
  {
    target: 'String',
  ...
  { target: 'Array', proto: !0, forced: !Xc },
  {
    splice: function (e, t) {
      var n,
        ...
        f = arguments.length
      if (
        (0 === f ? (n = r = 0) : 1 === f ? ((n = 0), (r = s - c)) : ((n = f - 2), (r = Jc(Wc(Gc(t), 0), s - c))),
        s + n - r > 9007199254740991)
      )
        throw TypeError('Maximum allowed length exceeded')
      for (u = Yc(l, r), i = 0; i < r; i++) (o = c + i) in l && Kc(u, i, l[o])
      if (((u.length = r), n < r)) {
        for (i = c; i < s - r; i++) (a = i + n), (o = i + r) in l ? (l[a] = l[o]) : delete l[a]
        for (i = s; i > s - r + n; i--) delete l[i - 1]
      } else if (n > r) for (i = s - r; i > c; i--) (a = i + n - 1), (o = i + r - 1) in l ? (l[a] = l[o]) : delete l[a]
...
var hf = {},
  ...
  df = /^([^:]+:\/*[^/]*)[\s\S]*$/
function vf(e, t) {
  hf[' ' + e] || (Df.test(e) ? (hf[' ' + e] = e + '/') : (hf[' ' + e] = Af(e, '/', !0)))
...
var yf = function (e, t) {
  ...
  mf = function (e, t) {
    ...
    var n = {
      replace: function (t, r) {
        return (r = (r = r.source || r).replace(cf, '$1')), (e = e.replace(t, r)), n
      },
      getRegex: function () {
  ...
  kf = function (e, t, n) {
    if (e) {
      var r
      try {
        r = decodeURIComponent(sf(n)).replace(ff, '').toLowerCase()
      } catch (e) {
        return null
      }
...
function If(e, t, n) {
  ...
  return '!' !== e[0].charAt(0)
    ...
    : { type: 'image', raw: n, href: r, title: u, text: Rf(i) }
}
var zf = (function () {
    function e(n) {
      ...
      r(e, [
          ...
          value: function (e) {
            ...
            if (t) {
              ...
              return {
                ...
                text: this.options.pedantic ? n : Tf(n, '\n'),
              }
            }
          },
        },
              ...
              var n = t[0],
                r = (function (e, t) {
                  ...
                  return t
                    ...
                    .map(function (e) {
                      var t = e.match(/^\s+/)
                      return null === t ? e : o(t, 1)[0].length >= r.length ? e.slice(r.length) : e
                    })
                    .join('\n')
                })(n, t[3] || '')
              ...
              if (n.header.length === n.align.length) {
                ...
                for (r = 0; r < u; r++)
                  /^ *-+: *$/.test(n.align[r])
                    ...
                    ? (n.align[r] = 'left')
                    : (n.align[r] = null)
                for (u = n.cells.length, r = 0; r < u; r++) n.cells[r] = Of(n.cells[r], n.header.length)
                return n
              }
            }
          },
          ...
          value: function (e) {
            ...
            if (t) {
              var n,
                ...
                p = t[2],
                h = p.length > 1,
                D = { type: 'list', raw: f, ordered: h, start: h ? +p.slice(0, -1) : '', loose: !1, items: [] },
              ...
              for (var A = 0; A < v; A++) {
                if (
                  ...
                  if (
                    ...
                    this.options.pedantic ? i[1].length > u[1].length : i[1].length >= u[0].length || i[1].length > 3)
                  ) {
                    g.splice(
                      A,
                      2,
                ...
                ;(r = n.length),
                  ...
                  this.options.gfm &&
                    ((s = void 0),
                    (l = /^\[[ xX]\] /.test(n)) && ((s = ' ' !== n[1]), (n = n.replace(/^\[[ xX]\] +/, '')))),
                  D.items.push({ type: 'list_item', raw: f, task: l, checked: s, loose: a, text: n })
              }
              return D
            }
          },
          ...
          value: function (e) {
            ...
            if (t)
              return {
                ...
                text: this.options.sanitize ? (this.options.sanitizer ? this.options.sanitizer(t[0]) : Rf(t[0])) : t[0],
              }
          },
        },
        {
            ...
            if (t) {
              ...
              if (n.header.length === n.align.length) {
                ...
                for (u = n.cells.length, r = 0; r < u; r++)
                  n.cells[r] = Of(n.cells[r].replace(/^ *\| *| *\| *$/g, ''), n.header.length)
                return n
              }
            }
          },
        ...
        },
        {
          ...
          value: function (e) {
            ...
            if (t) return { type: 'escape', raw: t[0], text: Rf(t[1]) }
          },
        },
        {
          key: 'tag',
        ...
        },
        {
          ...
          value: function (e) {
            ...
            if (t) {
              ...
              return (
                (o = o.trim()),
                /^</.test(o) && (o = this.options.pedantic && !/>$/.test(n) ? o.slice(1) : o.slice(1, -1)),
                If(
                  t,
                  {
                ...
                for (c.lastIndex = 0, t = t.slice(-1 * e.length + a); null != (r = c.exec(t)); )
                  if ((i = r[1] || r[2] || r[3] || r[4] || r[5] || r[6]))
                    if (((o = i.length), r[3] || r[4])) l += o
                      ...
                      if (!((l -= o) > 0)) {
                        if (
                          (l + s - o <= 0 && !t.slice(c.lastIndex).match(c) && (o = Math.min(o, o + l + s)),
                          Math.min(a, o) % 2)
                        )
                          return { type: 'em', raw: e.slice(0, a + r.index + o + 1), text: e.slice(1, a + r.index + o) }
                        if (Math.min(a, o) % 2 == 0)
                          return {
                            type: 'strong',
          ...
          value: function (e) {
            ...
            if (t) {
              var n = t[2].replace(/\n/g, ' '),
                ...
                u = /^ /.test(n) && / $/.test(n)
              return (
                r && u && (n = n.substring(1, n.length - 1)), (n = Rf(n, !0)), { type: 'codespan', raw: t[0], text: n }
              )
            }
          },
        },
        ...
        },
        {
          ...
          value: function (e, t) {
            ...
            if (u)
              return (
                (r = '@' === u[2] ? 'mailto:' + (n = Rf(this.options.mangle ? t(u[1]) : u[1])) : (n = Rf(u[1]))),
                { type: 'link', raw: u[0], text: n, href: r, tokens: [{ type: 'text', raw: n, text: n }] }
              )
          },
        },
        {
          ...
          value: function (e, t) {
            ...
            if ((n = this.rules.inline.url.exec(e))) {
              var r, u
              if ('@' === n[2]) u = 'mailto:' + (r = Rf(this.options.mangle ? t(n[0]) : n[0]))
              else {
                var i
                do {
                  ;(i = n[0]), (n[0] = this.rules.inline._backpedal.exec(n[0])[0])
                } while (i !== n[0])
                ;(r = Rf(n[0])), (u = 'www.' === n[1] ? 'http://' + r : r)
              }
              return { type: 'link', raw: n[0], text: r, href: u, tokens: [{ type: 'text', raw: r, text: r }] }
            }
          },
        },
        {
                ...
                (r = t
                  ? this.options.sanitize
                    ? this.options.sanitizer
                      ...
                      : Rf(u[0])
                    : u[0]
                  : Rf(this.options.smartypants ? n(u[0]) : u[0])),
...
;(Mf.def = Pf(Mf.def).replace('label', Mf._label).replace('title', Mf._title).getRegex()),
  (Mf.bullet = /(?:[*+-]|\d{1,9}[.)])/),
  (Mf.item = /^( *)(bull) ?[^\n]*(?:\n(?! *bull ?)[^\n]*)*/),
  (Mf.item = Pf(Mf.item, 'gm').replace(/bull/g, Mf.bullet).getRegex()),
  ...
  (Mf.paragraph = Pf(Mf._paragraph)
    ...
    .replace('tag', Mf._tag)
    .getRegex()),
  (Mf.blockquote = Pf(Mf.blockquote).replace('paragraph', Mf.paragraph).getRegex()),
  (Mf.normal = Lf({}, Mf)),
  (Mf.gfm = Lf({}, Mf.normal, {
    nptable:
...
;(Nf.punctuation = Pf(Nf.punctuation)
  ...
  (Nf.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
  (Nf.escapedEmSt = /\\\*|\\_/g),
  (Nf._comment = Pf(Mf._comment).replace('(?:--\x3e|$)', '--\x3e').getRegex()),
  (Nf.emStrong.lDelim = Pf(Nf.emStrong.lDelim).replace(/punct/g, Nf._punctuation).getRegex()),
  (Nf.emStrong.rDelimAst = Pf(Nf.emStrong.rDelimAst, 'g').replace(/punct/g, Nf._punctuation).getRegex()),
  (Nf.emStrong.rDelimUnd = Pf(Nf.emStrong.rDelimUnd, 'g').replace(/punct/g, Nf._punctuation).getRegex()),
  (Nf._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
  (Nf._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/),
  (Nf._email =
    /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/),
  (Nf.autolink = Pf(Nf.autolink).replace('scheme', Nf._scheme).replace('email', Nf._email).getRegex()),
  (Nf._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
  (Nf.tag = Pf(Nf.tag).replace('comment', Nf._comment).replace('attribute', Nf._attribute).getRegex()),
  (Nf._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
  (Nf._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/),
  (Nf._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
  (Nf.link = Pf(Nf.link).replace('label', Nf._label).replace('href', Nf._href).replace('title', Nf._title).getRegex()),
  (Nf.reflink = Pf(Nf.reflink).replace('label', Nf._label).getRegex()),
  (Nf.reflinkSearch = Pf(Nf.reflinkSearch, 'g').replace('reflink', Nf.reflink).replace('nolink', Nf.nolink).getRegex()),
  (Nf.normal = Lf({}, Nf)),
  ...
  (Nf.gfm = Lf({}, Nf.normal, {
    escape: Pf(Nf.escape).replace('])', '~|])').getRegex(),
  ...
  (Nf.gfm.url = Pf(Nf.gfm.url, 'i').replace('email', Nf.gfm._extended_email).getRegex()),
  (Nf.breaks = Lf({}, Nf.gfm, {
...
var Xf = (function () {
    function e(n) {
      t(this, e),
        ...
        (this.options = n || Zf),
        (this.options.tokenizer = this.options.tokenizer || new qf()),
        (this.tokenizer = this.options.tokenizer),
        (this.tokenizer.options = this.options)
      var r = { block: Gf.normal, inline: Hf.normal }
      this.options.pedantic
        ? ((r.block = Gf.pedantic), (r.inline = Hf.pedantic))
        : this.options.gfm && ((r.block = Gf.gfm), this.options.breaks ? (r.inline = Hf.breaks) : (r.inline = Hf.gfm)),
          ...
          },
          {
            ...
            value: function (e) {
              ...
              for (this.options.pedantic && (e = e.replace(/^ +$/gm, '')); e; )
                if ((t = this.tokenizer.space(e))) (e = e.substring(t.raw.length)), t.type && i.push(t)
                ...
                else if ((t = this.tokenizer.nptable(e))) (e = e.substring(t.raw.length)), i.push(t)
                else if ((t = this.tokenizer.hr(e))) (e = e.substring(t.raw.length)), i.push(t)
                else if ((t = this.tokenizer.blockquote(e)))
                  (e = e.substring(t.raw.length)), (t.tokens = this.blockTokens(t.text, [], o)), i.push(t)
                  ...
                  (e = e.substring(t.raw.length)),
                    this.tokens.links[t.tag] || (this.tokens.links[t.tag] = { href: t.href, title: t.title })
                ...
                else if (o && (t = this.tokenizer.paragraph(e))) (e = e.substring(t.raw.length)), i.push(t)
              ...
              for (t = 0; t < a; t++)
                switch ((o = e[t]).type) {
                  ...
                  case 'heading':
                    ...
                    break
                  case 'table':
                    for (o.tokens = { header: [], cells: [] }, u = o.header.length, n = 0; n < u; n++)
                      (o.tokens.header[n] = []), this.inlineTokens(o.header[n], o.tokens.header[n])
          ...
          },
          {
            ...
            value: function (e) {
              ...
              for (; null != (r = this.tokenizer.rules.inline.escapedEmSt.exec(s)); )
                s = s.slice(0, r.index) + '++' + s.slice(this.tokenizer.rules.inline.escapedEmSt.lastIndex)
              for (; e; )
                if ((u || (i = ''), (u = !1), (t = this.tokenizer.escape(e))))
                  ...
                  var f = o[o.length - 1]
                  f && 'text' === t.type && 'text' === f.type ? ((f.raw += t.raw), (f.text += t.text)) : o.push(t)
                  ...
                  (e = e.substring(t.raw.length)), (t.tokens = this.inlineTokens(t.text, [], a, l)), o.push(t)
                else if ((t = this.tokenizer.codespan(e))) (e = e.substring(t.raw.length)), o.push(t)
                else if ((t = this.tokenizer.br(e))) (e = e.substring(t.raw.length)), o.push(t)
                else if ((t = this.tokenizer.del(e)))
                  (e = e.substring(t.raw.length)), (t.tokens = this.inlineTokens(t.text, [], a, l)), o.push(t)
                else if ((t = this.tokenizer.autolink(e, Kf))) (e = e.substring(t.raw.length)), o.push(t)
                else if (a || !(t = this.tokenizer.url(e, Kf))) {
                  if ((t = this.tokenizer.inlineText(e, l, Yf)))
                    (e = e.substring(t.raw.length)),
                      '_' !== t.raw.slice(-1) && (i = t.raw.slice(-1)),
                      (u = !0),
                      (n = o[o.length - 1]) && 'text' === n.type ? ((n.raw += t.raw), (n.text += t.text)) : o.push(t)
                  else if (e) {
    ...
    return (
      r(e, [
        ...
        },
        {
          key: 'link',
          value: function (e, t, n) {
            if (null === (e = Jf(this.options.sanitize, this.options.baseUrl, e))) return n
            var r = '<a href="' + Qf(e) + '"'
  ...
  sp = (function () {
    function e(n) {
      t(this, e),
        (this.options = n || op),
        (this.options.renderer = this.options.renderer || new rp()),
                ...
                switch ((c = e[t]).type) {
                  ...
                  case 'heading':
                    E += this.renderer.heading(
                      ...
                      c.depth,
                      ap(this.parseInline(c.tokens, this.textRenderer)),
                      this.slugger
                    )
                    continue
                  case 'code':
                  ...
                  case 'table':
                    ...
                    for (l += this.renderer.tablerow(a), s = '', u = c.cells.length, n = 0; n < u; n++) {
                      for (a = '', i = (o = c.tokens.cells[n]).length, r = 0; r < i; r++)
                        a += this.renderer.tablecell(this.parseInline(o[r]), { header: !1, align: c.align[r] })
                  ...
                  case 'blockquote':
                    ...
                    continue
                  case 'list':
                    for (f = c.ordered, p = c.start, h = c.loose, u = c.items.length, s = '', n = 0; n < u; n++)
                            ...
                            ? g.tokens.length > 0 && 'text' === g.tokens[0].type
                              ? ((g.tokens[0].text = A + ' ' + g.tokens[0].text),
                                g.tokens[0].tokens &&
                                  ...
                                  (g.tokens[0].tokens[0].text = A + ' ' + g.tokens[0].tokens[0].text))
                  ...
                  case 'paragraph':
                    ...
                    continue
                  case 'text':
                    for (s = c.tokens ? this.parseInline(c.tokens) : c.text; t + 1 < m && 'text' === e[t + 1].type; )
...
function Ep(e, t, n) {
  ...
  if (('function' == typeof t && ((n = t), (t = null)), (t = Dp({}, Ep.defaults, t || {})), gp(t), n)) {
    var r,
      u = t.highlight
    try {
      r = lp.lex(e, t)
  ...
  try {
    var a = lp.lex(e, t)
    return t.walkTokens && Ep.walkTokens(a, t.walkTokens), sp.parse(a, t)
  } catch (e) {
    if (((e.message += '\nPlease report this to https://github.com/markedjs/marked.'), t.silent))
      return '<p>An error occurred:</p><pre>' + dp(e.message + '', !0) + '</pre>'
    throw e
  }
}
;(Ep.options = Ep.setOptions =
  ...
  (Ep.parseInline = function (e, t) {
    ...
    try {
      ...
      return t.walkTokens && Ep.walkTokens(n, t.walkTokens), sp.parseInline(n, t)
    } catch (e) {
      if (((e.message += '\nPlease report this to https://github.com/markedjs/marked.'), t.silent))
        return '<p>An error occurred:</p><pre>' + dp(e.message + '', !0) + '</pre>'
      throw e
...
export default function () {
  ...
  function r(e) {
    for (var t = e.attributes, n = [], r = 0, u = t.length; r < u; r++) {
      var i = t[r].name,
        o = t[r].value
      ;/data\-(markdown|separator|vertical|notes)/gi.test(i) || (o ? n.push(i + '="' + o + '"') : n.push(i))
    }
    return n.join(' ')
  }
  function o(e) {
  ...
  function a(e, t) {
    ...
    return (
      2 === n.length && (e = n[0] + '<aside class="notes">' + mp(n[1].trim()) + '</aside>'),
      '<script type="text/template">' + (e = e.replace(/<\/script>/g, '__SCRIPT_END__')) + '</script>'
    )
  }
  function l(e, t) {
    t = o(t)
    for (
      var n,
        r,
        u,
        i = new RegExp(t.separator + (t.verticalSeparator ? '|' + t.verticalSeparator : ''), 'mg'),
                ...
                return new Promise(function (t, n) {
                  ...
                  null != i && '' != i && r.overrideMimeType('text/html; charset=' + i),
                    (r.onreadystatechange = function (e, r) {
                      4 === r.readyState && ((r.status >= 200 && r.status < 300) || 0 === r.status ? t(r, u) : n(r, u))
                    }.bind(this, e, r)),
                    r.open('GET', u, !0)
                  try {
                    r.send()
  ...
  function c(e, t, n) {
    ...
    if ((r = i.exec(a))) {
      var l = r[1]
      for (a = a.substring(0, r.index) + a.substring(i.lastIndex), e.nodeValue = a; (u = o.exec(l)); )
    ...
    if (null != t && null != t.childNodes && t.childNodes.length > 0)
      for (var i = t, o = 0; o < t.childNodes.length; o++) {
        ...
        'section' == a.nodeName && ((p = a), (i = a)),
          ('function' != typeof a.setAttribute && a.nodeType != Node.COMMENT_NODE) || f(p, a, i, r, u)
      }
  ...
  return {
    ...
    init: function (n) {
      ...
      return (
        o ||
          ((o = new mp.Renderer()).code = function (e, t) {
            var n = ''
            return (
              kp.test(t) &&
                ((n = t.match(kp)[1].trim()),
