!(function (e, t) {
  ...
  var Q,
    ...
    te = {
      ...
      getterFor: function (e) {
        return function (t) {
          var n
          if (!v(t) || (n = C(t)).type !== e) throw TypeError('Incompatible receiver, ' + e + ' required')
          return n
        }
      },
    },
    ne = t(function (e) {
      ...
      ;(e.exports = function (e, t, o, a) {
        ...
        'function' == typeof o &&
          ...
          e !== r ? (l ? !c && e[t] && (s = !0) : delete e[t], s ? (e[t] = o) : R(e, t, o)) : s ? (e[t] = o) : j(t, o)
    ...
    oe = function (e, t) {
      return arguments.length < 2 ? ie(re[e]) || ie(r[e]) : (re[e] && re[e][t]) || (r[e] && r[e][t])
    },
    ae = Math.ceil,
    le = Math.floor,
    se = function (e) {
    ...
    Ue = function (e) {
      return m(Ne, e) || (Le && m(qe, e) ? (Ne[e] = qe[e]) : (Ne[e] = De('Symbol.' + e))), Ne[e]
    },
    Ze = Ue('species'),
    Fe = function (e, t) {
      var n
      return (
        Pe(e) &&
          ('function' != typeof (n = e.constructor) || (n !== Array && !Pe(n.prototype))
  ...
  Be
    ? (ee = (Q = Be.split('.'))[0] + Q[1])
    : Ge && (!(Q = Ge.match(/Edge\/(\d+)/)) || Q[1] >= 74) && (Q = Ge.match(/Chrome\/(\d+)/)) && (ee = Q[1])
  var Ve = ee && +ee,
    Ke = Ue('species'),
    Xe = function (e) {
      return (
  ...
  var rt = function (e) {
    ...
    lt = { forEach: at(0), map: at(1), filter: at(2), some: at(3), every: at(4), find: at(5), findIndex: at(6) },
    st = function (e, t) {
      var n = [][e]
      return (
        !!n &&
    ...
    pt = function (e, t) {
      ...
      return (ut[e] =
        ...
        !i(function () {
          if (r && !o) return !0
          var e = { length: -1 }
          r ? ct(e, 1, { enumerable: !0, get: ft }) : (e[1] = 1), n.call(e, a, l)
        }))
    },
    ht = lt.forEach,
    gt = st('forEach'),
  ...
  var yt,
    ...
    mt = o
      ...
      : function (e, t) {
          A(e)
          for (var n, r = bt(t), i = r.length, o = 0; i > o; ) O.f(e, (n = r[o++]), t[n])
          return e
        },
  ...
  var _t =
      ...
      function (e, t) {
        var n
        return (
          null !== e ? ((wt.prototype = A(e)), (n = new wt()), (wt.prototype = null), (n[xt] = e)) : (n = Et()),
          void 0 === t ? n : mt(n, t)
        )
      },
    At = Ue('unscopables'),
  ...
  var Ot,
    ...
    Mt = Ue('iterator'),
    Nt = !1
  ;[].keys && ('next' in (jt = [].keys()) ? (Rt = Lt(Lt(jt))) !== Object.prototype && (Ot = Rt) : (Nt = !0)),
    null == Ot && (Ot = {}),
    m(Ot, Mt) ||
      R(Ot, Mt, function () {
        return this
  ...
  var qt = { IteratorPrototype: Ot, BUGGY_SAFARI_ITERATORS: Nt },
    ...
    Ut = Ue('toStringTag'),
    Zt = function (e, t, n) {
      e && !m((e = n ? e : e.prototype), Ut) && Dt(e, Ut, { configurable: !0, value: t })
    },
    ...
    Qt = function (e, t, n, r, i, o, a) {
      ...
      if (
        (y &&
          ...
          Wt !== Object.prototype &&
            l.next &&
            (Lt(l) !== Wt && (Ht ? Ht(l, Wt) : 'function' != typeof l[Vt] && R(l, Vt, Jt)), Zt(l, p, !0))),
        i == Xt &&
          d &&
          d.name !== Xt &&
          ((h = !0),
  ...
  $e(
    { target: 'Array', proto: !0, forced: !sn || !cn },
    {
      slice: function (e, t) {
        ...
        if (
          Pe(o) &&
          ('function' != typeof (n = o.constructor) || (n !== Array && !Pe(n.prototype))
            ? v(n) && null === (n = n[un]) && (n = void 0)
            : (n = void 0),
          n === Array || void 0 === n)
        )
          return fn.call(o, l, s)
        for (r = new (void 0 === n ? Array : n)(pn(s - l, 0)), i = 0; l < s; l++, i++) l in o && Ce(r, i, o[l])
        return (r.length = i), r
      },
    }
  )
        ...
        if (o) a = e
          ...
          if (void 0 !== (h = l) && ($t.Array === h || On[Tn] === h)) {
            for (s = 0, c = ue(e.length); c > s; s++)
              if ((u = i ? g(A((p = e[s]))[0], p[1]) : g(e[s])) && u instanceof t) return u
            return new t(!1)
          }
          a = l.call(e)
        }
        for (f = a.next; !(p = f.call(a)).done; )
          if ('object' == typeof (u = jn(a, g, p.value, i)) && u && u instanceof t) return u
        return new t(!1)
      }).stop = function (e) {
        return new t(!0, e)
      }
  ...
  ;(Fn && Gn) ||
    ...
    'process' == f(Hn)
      ...
      : Wn && !Un
      ? ((Nn = (Mn = new Wn()).port2), (Mn.port1.onmessage = Qn), (Ln = it(Nn.postMessage, Nn, 1)))
      : !r.addEventListener || 'function' != typeof postMessage || r.importScripts || i(er) || 'file:' === Zn.protocol
      ? (Ln =
          Xn in w('script')
            ? function (e) {
  ...
  var br,
    ...
    Fr = je(Rr, function () {
      ...
      return ((e.constructor = {})[Or] = t), !(e.then(function () {}) instanceof t)
    }),
    Gr =
      Fr ||
      !(function (e, t) {
            ...
            try {
              f
                ? (o || (2 === t.rejection && Xr(e, t), (t.rejection = 1)),
                  !0 === f ? (l = i) : (g && g.enter(), (l = f(i)), g && (g.exit(), (c = !0))),
                  l === u.promise ? h(Ir('Promise-chain cycle')) : (s = Hr(l)) ? s.call(l, p, h) : p(l))
                : h(i)
            } catch (e) {
              g && !c && g.exit(), h(e)
            }
    ...
    Br = function (e, t, n) {
      var i, o
      Ur
        ? (((i = Cr.createEvent('Event')).promise = t), (i.reason = n), i.initEvent(e, !1, !0), r.dispatchEvent(i))
    ...
    Jr = function (e, t, n, r) {
      t.done || ((t.done = !0), r && (t = r), (t.value = n), (t.state = 2), Wr(e, t, !0))
    },
    Qr = function (e, t, n, r) {
      if (!t.done) {
        ;(t.done = !0), r && (t = r)
  ...
  Fr &&
    ...
    ((br = function (e) {
      zr(this, { type: Rr, done: !1, notified: !1, parent: !1, reactions: [], rejection: !1, state: 0, value: void 0 })
    ...
    (mr = function () {
      var e = new br(),
        t = jr(e)
      ;(this.promise = e), (this.resolve = Yr(Qr, e, t)), (this.reject = Yr(Jr, e, t))
    }),
    (Er.f = Nr = function (e) {
  ...
  if (
    ...
    je(
      ...
      !hi ||
        gi ||
        i(function () {
          return (pi[si] = !1), ci(fi) != fi || ci(pi) == pi || '/a/i' != ci(fi, 'i')
        })
    )
  ) {
    for (
      var di = function (e, t) {
          ...
          hi ? i && !o && (e = e.source) : e instanceof di && (o && (t = ni.call(e)), (e = e.source)),
  ...
  var mi = RegExp.prototype.exec,
    ...
    wi = (function () {
      var e = /a/,
        t = /b*/g
      return mi.call(e, 'a'), mi.call(t, 'a'), 0 !== e.lastIndex || 0 !== t.lastIndex
    })(),
    ...
    ne(
      ...
      function () {
        var e = A(this),
          t = String(e.source),
          n = e.flags
        return '/' + t + '/' + String(void 0 === n && e instanceof RegExp && !('flags' in Ti) ? ni.call(e) : n)
      },
      { unsafe: !0 }
    )
  var zi = function (e) {
      return function (t, n) {
        ...
        return a < 0 || a >= l
          ? e
            ? ''
            : void 0
          : (r = o.charCodeAt(a)) < 55296 || r > 56319 || a + 1 === l || (i = o.charCodeAt(a + 1)) < 56320 || i > 57343
          ? e
            ? o.charAt(a)
            : r
          : e
  ...
  var Mi = Ue('species'),
    ...
    Fi = function (e, t, n, r) {
      ...
      if (!a || !l || ('replace' === e && (!Ni || !qi || Ui)) || ('split' === e && !Zi)) {
        var s = /./[o],
          c = n(
            o,
            ''[e],
            ...
            { REPLACE_KEEPS_$0: qi, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: Ui }
          ),
          u = c[0],
          f = c[1]
    ...
    return [
      ...
      function (e) {
        ...
        for (var l, s = [], c = 0; null !== (l = Wi(i, o)); ) {
          var u = String(l[0])
          ;(s[c] = u), '' === u && (i.lastIndex = Hi(o, ue(i.lastIndex), a)), c++
        }
        return 0 === c ? null : s
      },
    ]
    ...
    return [
      ...
      function (e, r) {
        ...
        for (var v, y = '', b = 0, m = 0; m < g.length; m++) {
          d = g[m]
          for (var k = String(d[0]), x = Bi(Vi(se(d.index), u.length), 0), w = [], S = 1; S < d.length; S++)
            ...
            ? function (e, n) {
                ...
                for (
                  ...
                  !(
                    ...
                    o.length > 1 && o.index < r.length && Ji.apply(s, o.slice(1)),
                    (l = o[0].length),
                    (u = a),
                    s.length >= i)
                  );
                ...
                return (
                  u === r.length ? (!l && f.test('')) || s.push('') : s.push(r.slice(u)),
        ...
        [
          ...
          function (e, i) {
            ...
            var a = A(e),
              ...
              s = Dn(a, RegExp),
              c = a.unicode,
              u = (a.ignoreCase ? 'i' : '') + (a.multiline ? 'm' : '') + (a.unicode ? 'u' : '') + (to ? 'y' : 'g'),
            ...
            for (var h = 0, g = 0, d = []; g < l.length; ) {
              ...
              if (null === y || (v = Qi(ue(f.lastIndex + (to ? 0 : g)), l.length)) === h) g = Hi(l, g, c)
              else {
                if ((d.push(l.slice(h, g)), d.length === p)) return d
                for (var b = 1; b <= y.length - 1; b++) if ((d.push(y[b]), d.length === p)) return d
                g = h = v
              }
            }
  ...
  var no = '\t\n\v\f\r                　\u2028\u2029\ufeff',
    ...
    ao = function (e) {
      return function (t) {
        var n = String(g(t))
        return 1 & e && (n = n.replace(io, '')), 2 & e && (n = n.replace(oo, '')), n
      }
    },
  ...
  $e(
    ...
    {
      indexOf: function (e) {
        return Io ? Po.apply(this, arguments) || 0 : $o(this, e, arguments.length > 1 ? arguments[1] : void 0)
      },
    }
  )
  var Mo = lt.map,
  ...
  var Do,
    Uo = function (e) {
      if (ti(e)) throw TypeError("The method doesn't accept regular expressions")
      return e
    },
    Zo = Ue('match'),
    Fo = function (e) {
  ...
  var ea = lo.end,
    ...
    na = ta
      ...
      : ''.trimEnd
  $e({ target: 'String', proto: !0, forced: ta }, { trimEnd: na, trimRight: na })
  var ra = t(function (e) {
      function t() {
        return {
          baseUrl: null,
    ...
    { target: 'Array', proto: !0, forced: !ia || !oa },
    {
      splice: function (e, t) {
        var n,
          ...
          f = arguments.length
        if (
          (0 === f ? (n = r = 0) : 1 === f ? ((n = 0), (r = c - u)) : ((n = f - 2), (r = la(aa(se(t), 0), c - u))),
          c + n - r > sa)
        )
          throw TypeError(ca)
        ...
        if (((i.length = r), n < r)) {
          ...
          for (o = c - r; o > u; o--) (l = o + n - 1), (a = o + r - 1) in s ? (s[l] = s[a]) : delete s[l]
  ...
  var xa = {},
    ...
    Ea = /^([^:]+:\/*[^/]*)[\s\S]*$/
  function _a(e, t) {
    xa[' ' + e] || (wa.test(e) ? (xa[' ' + e] = e + '/') : (xa[' ' + e] = Aa(e, '/', !0)))
    ...
    Ra = function (e, t) {
      ...
      var n = {
        replace: function (t, r) {
          return (r = (r = r.source || r).replace(ba, '$1')), (e = e.replace(t, r)), n
        },
        getRegex: function () {
        ...
        Eo(e, [
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              if (n) {
                var r = t[t.length - 1]
                if (r && 'paragraph' === r.type) return { raw: n[0], text: n[0].trimRight() }
                ...
                var n = t[0],
                  r = (function (e, t) {
                    ...
                    return t
                      ...
                      .map(function (e) {
                        var t = e.match(/^\s+/)
                        return null === t ? e : To(t, 1)[0].length >= r.length ? e.slice(r.length) : e
                      })
                      .join('\n')
                  })(n, t[3] || '')
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (t) return { type: 'heading', raw: t[0], depth: t[1].length, text: t[2] }
            },
          },
          {
            key: 'nptable',
                ...
                if (n.header.length === n.align.length) {
                  ...
                  for (r = 0; r < i; r++)
                    /^ *-+: *$/.test(n.align[r])
                      ...
                      ? (n.align[r] = 'left')
                      : (n.align[r] = null)
                  for (i = n.cells.length, r = 0; r < i; r++) n.cells[r] = qa(n.cells[r], n.header.length)
                  return n
                }
              }
            },
              ...
              if (t) {
                for (
                  var n,
                    ...
                    u = t[2],
                    f = u.length > 1,
                    p = { type: 'list', raw: c, ordered: f, start: f ? +u : '', loose: !1, items: [] },
                  ...
                  (c = n = h[v]),
                    ...
                    v !== d - 1 &&
                      ...
                      (u.length > 1 ? 1 === i.length : i.length > 1 || (this.options.smartLists && i !== u)) &&
                        ((o = h.slice(v + 1).join('\n')),
                    ...
                    p.items.push({ type: 'list_item', raw: c, task: l, checked: s, loose: a, text: n })
                return p
              }
            },
          },
            ...
            value: function (e) {
              ...
              if (t)
                return (
                  ...
                  { tag: t[1].toLowerCase().replace(/\s+/g, ' '), raw: t[0], href: t[2], title: t[3] }
                )
            },
          },
          {
              ...
              if (t) {
                ...
                if (n.header.length === n.align.length) {
                  ...
                  for (i = n.cells.length, r = 0; r < i; r++)
                    n.cells[r] = qa(n.cells[r].replace(/^ *\| *| *\| *$/g, ''), n.header.length)
                  return n
                }
              }
            },
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              if (n) {
                var r = t[t.length - 1]
                return r && 'text' === r.type ? { raw: n[0], text: n[0] } : { type: 'text', raw: n[0], text: n[0] }
              }
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (t) return { type: 'strong', raw: t[0], text: t[4] || t[3] || t[2] || t[1] }
            },
          },
          {
            key: 'em',
            value: function (e) {
              ...
              if (t) return { type: 'em', raw: t[0], text: t[6] || t[5] || t[4] || t[3] || t[2] || t[1] }
            },
          },
          {
            key: 'codespan',
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              if (i)
                return (
                  (r = '@' === i[2] ? 'mailto:' + (n = Da(this.options.mangle ? t(i[1]) : i[1])) : (n = Da(i[1]))),
                  { type: 'link', raw: i[0], text: n, href: r, tokens: [{ type: 'text', raw: n, text: n }] }
                )
            },
          },
          {
            ...
            value: function (e, t) {
              ...
              if ((n = this.rules.inline.url.exec(e))) {
                var r, i
                if ('@' === n[2]) i = 'mailto:' + (r = Da(this.options.mangle ? t(n[0]) : n[0]))
                else {
                  var o
                  do {
  ...
  ;(Ba.def = Ha(Ba.def).replace('label', Ba._label).replace('title', Ba._title).getRegex()),
    (Ba.bullet = /(?:[*+-]|\d{1,9}\.)/),
    (Ba.item = /^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/),
    ...
    (Ba.paragraph = Ha(Ba._paragraph)
      ...
      .replace('tag', Ba._tag)
      .getRegex()),
    (Ba.blockquote = Ha(Ba.blockquote).replace('paragraph', Ba.paragraph).getRegex()),
    (Ba.normal = Wa({}, Ba)),
    (Ba.gfm = Wa({}, Ba.normal, {
      nptable:
  ...
  ;(Va.em = Ha(Va.em)
    ...
    (Va._email = /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/),
    (Va.autolink = Ha(Va.autolink).replace('scheme', Va._scheme).replace('email', Va._email).getRegex()),
    (Va._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
    (Va.tag = Ha(Va.tag).replace('comment', Ba._comment).replace('attribute', Va._attribute).getRegex()),
    (Va._label = /(?:\[[^\[\]]*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
    ...
    (Va.gfm.url = Ha(Va.gfm.url, 'i').replace('email', Va.gfm._extended_email).getRegex()),
    (Va.breaks = Wa({}, Va.gfm, {
  ...
  var tl = (function () {
      function e(t) {
        ...
        this.options.pedantic
          ...
          : this.options.gfm &&
            ((n.block = Ya.gfm), this.options.breaks ? (n.inline = Ja.breaks) : (n.inline = Ja.gfm)),
                ...
                for (e = e.replace(/^ +$/gm, ''); e; )
                  if ((t = this.tokenizer.space(e))) (e = e.substring(t.raw.length)), t.type && o.push(t)
                    ...
                    (e = e.substring(t.raw.length)),
                      t.type ? o.push(t) : (((i = o[o.length - 1]).raw += '\n' + t.raw), (i.text += '\n' + t.text))
                    ...
                    (e = e.substring(t.raw.length)), (t.tokens = this.blockTokens(t.text, [], a)), o.push(t)
                ...
                for (t = 0; t < l; t++)
                  switch ((a = e[t]).type) {
                    ...
                    case 'heading':
                      ...
                      break
                    case 'table':
                      for (a.tokens = { header: [], cells: [] }, i = a.header.length, n = 0; n < i; n++)
            ...
            },
            {
              ...
              value: function (e) {
                for (
                  ...
                  if ((t = this.tokenizer.escape(e))) (e = e.substring(t.raw.length)), n.push(t)
                  else if ((t = this.tokenizer.tag(e, r, i)))
                    (e = e.substring(t.raw.length)), (r = t.inLink), (i = t.inRawBlock), n.push(t)
                  else if ((t = this.tokenizer.link(e)))
                    (e = e.substring(t.raw.length)),
                      'link' === t.type && (t.tokens = this.inlineTokens(t.text, [], !0, i)),
                      n.push(t)
                    ...
                    (e = e.substring(t.raw.length)), (t.tokens = this.inlineTokens(t.text, [], r, i)), n.push(t)
                  else if ((t = this.tokenizer.em(e)))
                    (e = e.substring(t.raw.length)), (t.tokens = this.inlineTokens(t.text, [], r, i)), n.push(t)
                  else if ((t = this.tokenizer.codespan(e))) (e = e.substring(t.raw.length)), n.push(t)
                  else if ((t = this.tokenizer.br(e))) (e = e.substring(t.raw.length)), n.push(t)
                  else if ((t = this.tokenizer.del(e)))
                    (e = e.substring(t.raw.length)), (t.tokens = this.inlineTokens(t.text, [], r, i)), n.push(t)
                  else if ((t = this.tokenizer.autolink(e, el))) (e = e.substring(t.raw.length)), n.push(t)
                  else if (r || !(t = this.tokenizer.url(e, el))) {
                    if ((t = this.tokenizer.inlineText(e, i, Qa))) (e = e.substring(t.raw.length)), n.push(t)
                    else if (e) {
      ...
      return (
        Eo(e, [
          ...
          },
          {
            key: 'link',
            value: function (e, t, n) {
              if (null === (e = rl(this.options.sanitize, this.options.baseUrl, e))) return n
              var r = '<a href="' + il(e) + '"'
                  ...
                  switch ((u = e[t]).type) {
                    ...
                    case 'table':
                      for (s = '', l = '', i = u.header.length, n = 0; n < i; n++)
                        l += this.renderer.tablecell(this.parseInline(u.tokens.header[n]), {
                          header: !0,
                          align: u.align[n],
                        })
                      for (s += this.renderer.tablerow(l), c = '', i = u.cells.length, n = 0; n < i; n++) {
                        for (l = '', o = (a = u.tokens.cells[n]).length, r = 0; r < o; r++)
                          l += this.renderer.tablecell(this.parseInline(a[r]), { header: !1, align: u.align[r] })
                    ...
                    case 'blockquote':
                      ...
                      continue
                    case 'list':
                      for (f = u.ordered, p = u.start, h = u.loose, i = u.items.length, c = '', n = 0; n < i; n++)
                          ...
                          d.task &&
                            ...
                            h
                              ? d.tokens.length > 0 && 'text' === d.tokens[0].type
                                ? ((d.tokens[0].text = b + ' ' + d.tokens[0].text),
                                  d.tokens[0].tokens &&
                                    d.tokens[0].tokens.length > 0 &&
                                    'text' === d.tokens[0].tokens[0].type &&
                                    (d.tokens[0].tokens[0].text = b + ' ' + d.tokens[0].tokens[0].text))
                    ...
                    case 'paragraph':
                      ...
                      continue
                    case 'text':
                      for (c = u.tokens ? this.parseInline(u.tokens) : u.text; t + 1 < x && 'text' === e[t + 1].type; )
  ...
  function yl(e, t, n) {
    ...
    if (('function' == typeof t && ((n = t), (t = null)), (t = fl({}, yl.defaults, t || {})), pl(t), n)) {
      var r,
        i = t.highlight
      try {
        r = tl.lex(e, t)
    ...
    try {
      ...
      if (((e.message += '\nPlease report this to https://github.com/markedjs/marked.'), t.silent))
        return '<p>An error occurred:</p><pre>' + hl(e.message + '', !0) + '</pre>'
      throw e
    }
  }
  ;(yl.options = yl.setOptions = function (e) {
  ...
  return function () {
    ...
    function i(e, t) {
      ...
      return (
        2 === n.length && (e = n[0] + '<aside class="notes">' + bl(n[1].trim()) + '</aside>'),
        '<script type="text/template">' + (e = e.replace(/<\/script>/g, ml)) + '</script>'
      )
    }
    function o(e, t) {
      t = r(t)
      for (
        var n,
          o,
          a,
          l = new RegExp(t.separator + (t.verticalSeparator ? '|' + t.verticalSeparator : ''), 'mg'),
      ...
      for (var p = '', h = 0, g = f.length; h < g; h++)
        f[h] instanceof Array
          ? ((p += '<section ' + t.attributes + '>'),
            ...
            (p += '</section>'))
          : (p += '<section ' + t.attributes + ' data-markdown>' + i(f[h], t) + '</section>')
      return p
    }
    function a(e) {
            ...
            ? a.push(
                (function (e) {
                  return new Promise(function (t, n) {
                    ...
                    null != o && '' != o && r.overrideMimeType('text/html; charset=' + o),
                      (r.onreadystatechange = function (e, r) {
                        4 === r.readyState &&
                          ((r.status >= 200 && r.status < 300) || 0 === r.status ? t(r, i) : n(r, i))
                      }.bind(this, e, r)),
                      r.open('GET', i, !0)
                    try {
                      r.send()
    ...
    function l(e, t, n) {
      ...
      if ((r = o.exec(l))) {
        var s = r[1]
        for (l = l.substring(0, r.index) + l.substring(o.lastIndex), e.nodeValue = l; (i = a.exec(s)); )
              ...
              if (null != n && null != n.childNodes && n.childNodes.length > 0)
                for (var a = n, s = 0; s < n.childNodes.length; s++) {
                  ...
                  'section' == c.nodeName && ((p = c), (a = c)),
                    ('function' != typeof c.setAttribute && c.nodeType != Node.COMMENT_NODE) || e(p, c, a, i, o)
                }
