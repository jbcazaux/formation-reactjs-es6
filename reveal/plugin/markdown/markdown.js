!(function (e, t) {
  ...
  var Ke = {
      ...
      getterFor: function (e) {
        return function (t) {
          var n
          if (!ze(t) || (n = Ce(t)).type !== e) throw TypeError('Incompatible receiver, ' + e + ' required')
          return n
        }
      },
    },
  ...
  ;(se.exports = function (e, t, n, r) {
    ...
    'function' == typeof n &&
      ...
      e !== Xe ? (i ? !a && e[t] && (o = !0) : delete e[t], o ? (e[t] = n) : We(e, t, n)) : o ? (e[t] = n) : Qe(t, n)
  ...
  var ut = p,
    ...
    at = function (e, t) {
      return arguments.length < 2 ? ot(ut[e]) || ot(it[e]) : (ut[e] && ut[e][t]) || (it[e] && it[e][t])
    },
    lt = {},
    st = Math.ceil,
    ct = Math.floor,
  ...
  Cn
    ...
    : kn && (!(yn = kn.match(/Edge\/(\d+)/)) || yn[1] >= 74) && (yn = kn.match(/Chrome\/(\d+)/)) && (En = yn[1])
  var xn = En && +En,
    wn = xn,
    Bn = D,
    Sn =
    ...
    return [
      ...
      function (e, r) {
        ...
        for (var g, d = '', v = 0, A = 0; A < h.length; A++) {
          D = h[A]
          for (var y = String(D[0]), E = kr(br(vr(D.index), s.length), 0), m = [], k = 1; k < D.length; k++)
  ...
  if (
    ...
    for (
      var iu = function (e, t) {
          ...
          ru ? u && !i && (e = e.source) : e instanceof iu && (i && (t = Hr.call(e)), (e = e.source)),
    ...
    su(
      ...
      function () {
        var e = cu(this),
          t = String(e.source),
          n = e.flags
        return '/' + t + '/' + String(void 0 === n && e instanceof RegExp && !('flags' in Du) ? pu.call(e) : n)
      },
      { unsafe: !0 }
    )
  var Au = ee,
        ...
        [
          ...
          function (e, u) {
            ...
            var o = qu(e),
              ...
              l = Gu(o, RegExp),
              s = o.unicode,
              c = (o.ignoreCase ? 'i' : '') + (o.multiline ? 'm' : '') + (o.unicode ? 'u' : '') + (Xu ? 'g' : 'y'),
            ...
            for (var h = 0, D = 0, g = []; D < a.length; ) {
              ...
              if (null === v || (d = Ju(Vu(f.lastIndex + (Xu ? D : 0)), a.length)) === h) D = Hu(a, D, s)
              else {
  ...
  var va,
    ...
    dl = Ka(el, function () {
      ...
      return ((t.constructor = {})[Qa] = n), !(gl = t.then(function () {}) instanceof n) || (!e && Xa && !hl)
    }),
    vl =
      dl ||
      !Ma(function (e) {
            ...
            try {
              c
                ? (u || (2 === e.rejection && bl(e), (e.rejection = 1)),
                  ...
                  o === s.promise ? p(al('Promise-chain cycle')) : (a = Al(o)) ? a.call(o, f, p) : f(o))
                : p(r)
            } catch (e) {
              h && !l && h.exit(), p(e)
            }
    ...
    El = function (e, t, n) {
      var r, u
      pl
        ? (((r = ll.createEvent('Event')).promise = t), (r.reason = n), r.initEvent(e, !1, !0), wa.dispatchEvent(r))
  ...
  if (
    ...
    ((va = function (e) {
      nl(this, { type: el, done: !1, notified: !1, parent: !1, reactions: [], rejection: !1, state: 0, value: void 0 })
    }).prototype = Ta(ol, {
      then: function (e, t) {
        var n = rl(this),
          r = cl(Na(this, il))
  ...
  $l(
    { target: 'Array', proto: !0, forced: !ql },
    {
      slice: function (e, t) {
        ...
        for (r = new (void 0 === n ? Array : n)(Hl(l - a, 0)), u = 0; a < l; a++, u++) a in i && Nl(r, u, i[a])
        return (r.length = u), r
      },
    }
  )
  ...
  var fs =
      ...
      function (e, t) {
        var n
        return (
          null !== e ? ((ls.prototype = ts(e)), (n = new ls()), (ls.prototype = null), (n[as] = e)) : (n = cs()),
          void 0 === t ? n : ns(n, t)
        )
      },
    ps = fs,
  ...
  var ds,
    ...
    Ts = Mn('iterator'),
    Os = !1
  ;[].keys && ('next' in (As = [].keys()) ? (vs = Bs(Bs(As))) !== Object.prototype && (ds = vs) : (Os = !0)),
    (null == ds ||
      ws(function () {
        var e = {}
    ...
    tc = function (e, t, n, r, u, i, o) {
      ...
      if (
        (d &&
          ...
          Ys !== Object.prototype &&
            a.next &&
            (Us(a) !== Ys && (qs ? qs(a, Ys) : 'function' != typeof a[Xs] && Gs(a, Xs, ec)), Zs(a, f, !0))),
        u == Js &&
          D &&
          D.name !== Js &&
          ((p = !0),
  ...
  var Qc = x,
    ...
    nf = function (e, t, n, r) {
      var u = String(Qc(e)),
        i = '<' + t
      return '' !== n && (i += ' ' + n + '="' + String(r).replace(ef, '&quot;') + '"'), i + '>' + u + '</' + t + '>'
    }
  nn(
    {
      target: 'String',
    ...
    { target: 'Array', proto: !0, forced: !pf },
    {
      splice: function (e, t) {
        var n,
          ...
          f = arguments.length
        if (
          (0 === f ? (n = r = 0) : 1 === f ? ((n = 0), (r = s - c)) : ((n = f - 2), (r = Df(hf(af(t), 0), s - c))),
          s + n - r > gf)
        )
          throw TypeError(df)
        ...
        if (((u.length = r), n < r)) {
          ...
          for (i = s - r; i > c; i--) (a = i + n - 1), (o = i + r - 1) in l ? (l[a] = l[o]) : delete l[a]
        ...
        r(e, [
                ...
                if (n.header.length === n.align.length) {
                  ...
                  for (r = 0; r < u; r++)
                    /^ *-+: *$/.test(n.align[r])
                      ...
                      ? (n.align[r] = 'left')
                      : (n.align[r] = null)
                  for (u = n.cells.length, r = 0; r < u; r++) n.cells[r] = Kf(n.cells[r], n.header.length)
                  return n
                }
              }
            },
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              if (u)
                return (
                  (r = '@' === u[2] ? 'mailto:' + (n = Xf(this.options.mangle ? t(u[1]) : u[1])) : (n = Xf(u[1]))),
  ...
  ;(up.punctuation = tp(up.punctuation)
    ...
    (up.emStrong.rDelimAst = tp(up.emStrong.rDelimAst, 'g').replace(/punct/g, up._punctuation).getRegex()),
    (up.emStrong.rDelimUnd = tp(up.emStrong.rDelimUnd, 'g').replace(/punct/g, up._punctuation).getRegex()),
    (up._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
    (up._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/),
    (up._email =
      /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/),
    (up.autolink = tp(up.autolink).replace('scheme', up._scheme).replace('email', up._email).getRegex()),
    (up._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
    (up.tag = tp(up.tag).replace('comment', up._comment).replace('attribute', up._attribute).getRegex()),
    (up._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
    (up._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/),
    (up._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
    (up.link = tp(up.link)
  ...
  var hp = (function () {
      function e(n) {
        ...
        this.options.pedantic
          ...
          : this.options.gfm &&
            ((r.block = lp.gfm), this.options.breaks ? (r.inline = sp.breaks) : (r.inline = sp.gfm)),
              ...
              value: function (e) {
                ...
                for (; e; )
                  if ((u || (i = ''), (u = !1), (t = this.tokenizer.escape(e))))
                    ...
                    (e = e.substring(t.raw.length)), (t.tokens = this.inlineTokens(t.text, [], a, l)), o.push(t)
                  else if ((t = this.tokenizer.autolink(e, pp))) (e = e.substring(t.raw.length)), o.push(t)
  ...
  function Ip(e, t, n) {
    ...
    if (('function' == typeof t && ((n = t), (t = null)), (t = Tp({}, Ip.defaults, t || {})), Op(t), n)) {
      var r,
        u = t.highlight
      try {
        r = Cp.lex(e, t)
                    ...
                    return new Promise(function (t, n) {
                      ...
                      null != i && '' != i && r.overrideMimeType('text/html; charset=' + i),
                        (r.onreadystatechange = function (e, r) {
                          4 === r.readyState &&
                            ((r.status >= 200 && r.status < 300) || 0 === r.status ? t(r, u) : n(r, u))
                        }.bind(this, e, r)),
                        r.open('GET', u, !0)
                      try {
                        r.send()
