!(function (t, e) {
  ...
  ;(Z.exports = function (t, e, n, r) {
    ...
    'function' == typeof n &&
      ...
      t !== $t ? (i ? !c && t[e] && (a = !0) : delete t[e], a ? (t[e] = n) : Gt(t, e, n)) : a ? (t[e] = n) : zt(e, n)
      ...
      Ye(function () {
        ...
        ? function (t, e) {
            for (var n = tn(t), r = arguments.length, o = 1, i = Ve.f, a = Ze.f; r > o; )
              for (var c, u = en(arguments[o++]), f = i ? Be(u).concat(i(u)) : Be(u), s = f.length, l = 0; s > l; )
  ...
  var _o,
    ...
    Ri = function (t, e, n) {
      var r, o
      Ti
        ? (((r = xi.createEvent('Event')).promise = e), (r.reason = n), r.initEvent(t, !1, !0), Go.dispatchEvent(r))
  ...
  if (
    ...
    ((_o = function (t) {
      yi(this, { type: di, done: !1, notified: !1, parent: !1, reactions: [], rejection: !1, state: 0, value: void 0 })
    }).prototype = qo(wi, {
      then: function (t, e) {
        var n = gi(this),
          r = Ei(ei(this, bi))
  ...
  var na =
      ...
      function (t, e) {
        var n
        return (
          null !== t ? ((Zi.prototype = Ui(t)), (n = new Zi()), (Zi.prototype = null), (n[Vi] = t)) : (n = ea()),
          void 0 === e ? n : Ki(n, e)
        )
      },
    ra = H,
      ...
      return {
        ...
        init: function (e) {
          ...
          ;(r.tex = cn(cn({}, t.tex), n.tex)),
            (r.options = cn(cn({}, r.options), t.options)),
