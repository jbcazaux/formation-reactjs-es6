!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(t)
    : ((e = 'undefined' != typeof globalThis ? globalThis : e || self).RevealMath = t())
})(this, function () {
  'use strict'
  function e(e, t, n) {
    return (
    ...
    return {
      ...
      init: function (r) {
        var a = (e = r).getConfig().math || {},
          o = n(n({}, t), a),
          i =
            (o.mathjax || 'https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.0/MathJax.js') +
            '?config=' +
            (o.config || 'TeX-AMS_HTML-full')
        ;(o.tex2jax = n(n({}, t.tex2jax), a.tex2jax)),
