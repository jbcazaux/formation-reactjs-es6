...
var $,
  ...
  D = Math.random(),
  Z = function (t) {
    return 'Symbol(' + String(void 0 === t ? '' : t) + ')_' + (++U + D).toString(36)
  },
  W = q('keys'),
  K = {},
  J = r.WeakMap
...
var Rt = {
  ...
  Ct = (function () {
    var t = /a/,
      e = /b*/g
    return Ot.call(t, 'a'), Ot.call(e, 'a'), 0 !== t.lastIndex || 0 !== e.lastIndex
  })(),
...
var jt =
  ...
  Zt = function (t) {
    return k(qt, t) || (jt && k(Ut, t) ? (qt[t] = Ut[t]) : (qt[t] = Dt('Symbol.' + t))), qt[t]
  },
  Wt = Zt('species'),
  Kt = !i(function () {
    var t = /./
  ...
  Yt = function (t, e, n, r) {
    ...
    if (!o || !l || ('replace' === t && (!Kt || !Jt || Ht)) || ('split' === t && !Bt)) {
      var s = /./[a],
        c = n(
          a,
          ''[t],
          ...
          { REPLACE_KEEPS_$0: Jt, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: Ht }
        ),
        u = c[0],
        p = c[1]
  ...
  X(
    ...
    function () {
      var t = T(this),
        e = String(t.source),
        n = t.flags
      return '/' + e + '/' + String(void 0 === n && t instanceof RegExp && !('flags' in le) ? At.call(t) : n)
    },
    { unsafe: !0 }
  )
var ye = function (t) {
  ...
  return [
    ...
    function (t, r) {
      ...
      for (var m, v = '', y = 0, k = 0; k < h.length; k++) {
        g = h[k]
        for (var b = String(g[0]), w = ke(be(it(g.index), u.length), 0), x = [], S = 1; S < g.length; S++)
...
_t(
  ...
  {
    indexOf: function (t) {
      return Ce ? $e.apply(this, arguments) || 0 : Ie(this, t, arguments.length > 1 ? arguments[1] : void 0)
    },
  }
)
var Me = [].join,
...
var qe,
  ...
  Ke = function (t, e) {
    ...
    return (
      Ze(t) &&
        ('function' != typeof (n = t.constructor) || (n !== Array && !Ze(n.prototype))
  ...
  He = { forEach: Fe(0), map: Fe(1), filter: Fe(2), some: Fe(3), every: Fe(4), find: Fe(5), findIndex: Fe(6) },
...
Ge
  ...
  : Be && (!(qe = Be.match(/Edge\/(\d+)/)) || qe[1] >= 74) && (qe = Be.match(/Chrome\/(\d+)/)) && (Ue = qe[1])
var Xe = Ue && +Ue,
  Qe = Zt('species'),
  tn = function (t) {
    return (
...
_t(
  { target: 'Array', proto: !0, forced: !on || !ln },
  {
    slice: function (t, e) {
      ...
      if (
        Ze(a) &&
        ('function' != typeof (n = a.constructor) || (n !== Array && !Ze(n.prototype))
          ? m(n) && null === (n = n[sn]) && (n = void 0)
          : (n = void 0),
        n === Array || void 0 === n)
      )
        return cn.call(a, l, s)
      for (r = new (void 0 === n ? Array : n)(un(s - l, 0)), i = 0; l < s; l++, i++) l in a && an(r, i, a[l])
      return (r.length = i), r
    },
  }
)
...
if (
  ...
  Et(
    ...
    !Sn ||
      En ||
      i(function () {
        return (xn[yn] = !1), kn(wn) != wn || kn(xn) == xn || '/a/i' != kn(wn, 'i')
      })
  )
) {
  for (
    var Tn = function (t, e) {
        ...
        Sn ? i && !a && (t = t.source) : t instanceof Tn && (a && (e = At.call(t)), (t = t.source)),
...
_t(
  {
    target: 'String',
    proto: !0,
    forced: !!(Mn || ((Rn = Cn(String.prototype, 'endsWith')), !Rn || Rn.writable)) && !Mn,
  },
  {
    endsWith: function (t) {
      var e = String(h(this))
      ...
      (r =
        ...
        ''.split(/.?/).length
          ? function (t, n) {
              ...
              return (
                u === r.length ? (!l && p.test('')) || s.push('') : s.push(r.slice(u)), s.length > i ? s.slice(0, i) : s
              )
            }
      ...
      [
        ...
        function (t, i) {
          ...
          var o = T(t),
            ...
            c = o.unicode,
            u = (o.ignoreCase ? 'i' : '') + (o.multiline ? 'm' : '') + (o.unicode ? 'u' : '') + (Un ? 'y' : 'g'),
          ...
          for (var f = 0, h = 0, g = []; h < l.length; ) {
            ...
            if (null === v || (m = qn(ot(p.lastIndex + (Un ? 0 : h)), l.length)) === f) h = Xt(l, h, c)
            else {
...
var Jn = '\t\n\v\f\r                　\u2028\u2029\ufeff',
  ...
  Yn = function (t) {
    return function (e) {
      var n = String(h(e))
      return 1 & t && (n = n.replace(Hn, '')), 2 & t && (n = n.replace(Bn, '')), n
    }
  },
  ...
  { target: 'Array', proto: !0, forced: !rr || !ir },
  {
    splice: function (t, e) {
      var n,
        ...
        p = arguments.length
      if (
        (0 === p ? (n = r = 0) : 1 === p ? ((n = 0), (r = c - u)) : ((n = p - 2), (r = or(ar(it(e), 0), c - u))),
      ...
      } else if (n > r) for (a = c - r; a > u; a--) (l = a + n - 1), (o = a + r - 1) in s ? (s[l] = s[o]) : delete s[l]
...
var yr = {},
  ...
  wr = /^([^:]+:\/*[^/]*)[\s\S]*$/
function xr(t, e) {
  yr[' ' + t] || (kr.test(t) ? (yr[' ' + t] = t + '/') : (yr[' ' + t] = Sr(t, '/', !0)))
  ...
  _r = function (t, e) {
    ...
    var n = {
      replace: function (e, r) {
        return (r = (r = r.source || r).replace(gr, '$1')), (t = t.replace(e, r)), n
      },
      getRegex: function () {
      ...
      fe(t, [
              ...
              var n = e[0],
                r = (function (t, e) {
                  ...
                  return e
                    ...
                    .map(function (t) {
                      var e = t.match(/^\s+/)
                      return null === e ? t : he(e, 1)[0].length >= r.length ? t.slice(r.length) : t
                    })
                    .join('\n')
                })(n, e[3] || '')
              ...
              if (n.header.length === n.align.length) {
                ...
                for (r = 0; r < i; r++)
                  /^ *-+: *$/.test(n.align[r])
                    ...
                    ? (n.align[r] = 'left')
                    : (n.align[r] = null)
                for (i = n.cells.length, r = 0; r < i; r++) n.cells[r] = Mr(n.cells[r], n.header.length)
                return n
              }
            }
          },
          ...
          value: function (t) {
            ...
            if (e)
              return {
                ...
                text: this.options.sanitize ? (this.options.sanitizer ? this.options.sanitizer(e[0]) : jr(e[0])) : e[0],
              }
          },
        },
        {
            ...
            if (e) {
              ...
              if (n.header.length === n.align.length) {
                ...
                for (i = n.cells.length, r = 0; r < i; r++)
                  n.cells[r] = Mr(n.cells[r].replace(/^ *\| *| *\| *$/g, ''), n.header.length)
                return n
              }
            }
          },
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (e) {
              ...
              return (
                r && i && (n = n.substring(1, n.length - 1)), (n = jr(n, !0)), { type: 'codespan', raw: e[0], text: n }
              )
            }
          },
        },
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            if (i)
              return (
                (r = '@' === i[2] ? 'mailto:' + (n = jr(this.options.mangle ? e(i[1]) : i[1])) : (n = jr(i[1]))),
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            if ((n = this.rules.inline.url.exec(t))) {
              var r, i
              if ('@' === n[2]) i = 'mailto:' + (r = jr(this.options.mangle ? e(n[0]) : n[0]))
              else {
                var a
                do {
...
;(Kr.def = Zr(Kr.def).replace('label', Kr._label).replace('title', Kr._title).getRegex()),
  (Kr.bullet = /(?:[*+-]|\d{1,9}\.)/),
  (Kr.item = /^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/),
  ...
  (Kr.paragraph = Zr(Kr._paragraph)
    ...
    .replace('tag', Kr._tag)
    .getRegex()),
  (Kr.blockquote = Zr(Kr.blockquote).replace('paragraph', Kr.paragraph).getRegex()),
  (Kr.normal = Wr({}, Kr)),
  (Kr.gfm = Wr({}, Kr.normal, {
    nptable:
...
;(Jr.em = Zr(Jr.em)
  ...
  (Jr.autolink = Zr(Jr.autolink).replace('scheme', Jr._scheme).replace('email', Jr._email).getRegex()),
  (Jr._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
  (Jr.tag = Zr(Jr.tag).replace('comment', Kr._comment).replace('attribute', Jr._attribute).getRegex()),
  (Jr._label = /(?:\[[^\[\]]*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
  (Jr._href = /<(?:\\[<>]?|[^\s<>\\])*>|[^\s\x00-\x1f]*/),
  (Jr._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
  (Jr.link = Zr(Jr.link).replace('label', Jr._label).replace('href', Jr._href).replace('title', Jr._title).getRegex()),
  ...
  (Jr.gfm.url = Zr(Jr.gfm.url, 'i').replace('email', Jr.gfm._extended_email).getRegex()),
  (Jr.breaks = Wr({}, Jr.gfm, {
...
var Xr = (function () {
    function t(e) {
      ...
      this.options.pedantic
        ...
        : this.options.gfm && ((n.block = Br.gfm), this.options.breaks ? (n.inline = Yr.breaks) : (n.inline = Yr.gfm)),
            ...
            value: function (t) {
              for (
                ...
                if ((e = this.tokenizer.escape(t))) (t = t.substring(e.raw.length)), n.push(e)
                  ...
                  (t = t.substring(e.raw.length)), (e.tokens = this.inlineTokens(e.text, [], r, i)), n.push(e)
                else if ((e = this.tokenizer.autolink(t, Gr))) (t = t.substring(e.raw.length)), n.push(e)
                else if (r || !(e = this.tokenizer.url(t, Gr))) {
                  if ((e = this.tokenizer.inlineText(t, i, Vr))) (t = t.substring(e.raw.length)), n.push(e)
                  else if (t) {
    ...
    return (
      fe(t, [
        ...
        },
        {
          key: 'link',
          value: function (t, e, n) {
            if (null === (t = ti(this.options.sanitize, this.options.baseUrl, t))) return n
            var r = '<a href="' + ei(t) + '"'
...
function hi(t, e, n) {
  ...
  if (('function' == typeof e && ((n = e), (e = null)), (e = si({}, hi.defaults, e || {})), ci(e), n)) {
    var r,
      i = e.highlight
    try {
      r = Xr.lex(t, e)
  ...
  try {
    ...
    if (((t.message += '\nPlease report this to https://github.com/markedjs/marked.'), e.silent))
      return '<p>An error occurred:</p><pre>' + ui(t.message + '', !0) + '</pre>'
    throw t
  }
}
...
export default function () {
  ...
  function n() {
    var n
    !e || e.closed
      ? (((e = window.open('about:blank', 'reveal.js - Notes', 'width=1100,height=700')).marked = gi),
        e.document.write(
