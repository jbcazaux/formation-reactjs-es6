!(function (t, e) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(e)
    : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).RevealNotes = e())
})(this, function () {
  'use strict'
  var t =
  ...
  var C,
    ...
    Z = Math.random(),
    W = function (t) {
      return 'Symbol(' + String(void 0 === t ? '' : t) + ')_' + (++D + Z).toString(36)
    },
    K = U('keys'),
    J = {},
    F = r.WeakMap
  ...
  var X = {
      ...
      getterFor: function (t) {
        return function (e) {
          var n
          if (!m(e) || (n = L(e)).type !== t) throw TypeError('Incompatible receiver, ' + t + ' required')
          return n
        }
      },
    },
    Q = e(function (t) {
      ...
      ;(t.exports = function (t, e, a, o) {
        ...
        'function' == typeof a &&
          ...
          t !== r ? (l ? !c && t[e] && (s = !0) : delete t[e], s ? (t[e] = a) : z(t, e, a)) : s ? (t[e] = a) : R(e, a)
    ...
    pt = function (t) {
      return function (e, n, r) {
        ...
        } else for (; o > l; l++) if ((t || l in a) && a[l] === n) return t || l || 0
        return !t && -1
      }
    },
      ...
      f:
        ...
        function (t) {
          return (function (t, e) {
            ...
            for (; e.length > i; ) k(r, (n = e[i++])) && (~ft(a, n) || a.push(n))
            return a
          })(t, ht)
        },
    },
  ...
  var Ot = {
    ...
    Lt = (function () {
      var t = /a/,
        e = /b*/g
      return It.call(t, 'a'), It.call(e, 'a'), 0 !== t.lastIndex || 0 !== e.lastIndex
    })(),
  ...
  var Nt =
    ...
    Wt = function (t) {
      return k(Ut, t) || (Nt && k(Dt, t) ? (Ut[t] = Dt[t]) : (Ut[t] = Zt('Symbol.' + t))), Ut[t]
    },
    Kt = Wt('species'),
    Jt = !i(function () {
      var t = /./
    ...
    Vt = function (t, e, n, r) {
      ...
      if (!o || !l || ('replace' === t && (!Jt || !Ft || Bt)) || ('split' === t && !Yt)) {
        var s = /./[a],
          c = n(
            a,
            ''[t],
            ...
            { REPLACE_KEEPS_$0: Ft, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: Bt }
          ),
          u = c[0],
          p = c[1]
      ...
      return function (e, n) {
        ...
        return o < 0 || o >= l
          ? t
            ? ''
            : void 0
          : (r = a.charCodeAt(o)) < 55296 || r > 56319 || o + 1 === l || (i = a.charCodeAt(o + 1)) < 56320 || i > 57343
          ? t
            ? a.charAt(o)
            : r
          : t
    ...
    return [
      ...
      function (t) {
        ...
        for (var l, s = [], c = 0; null !== (l = te(i, a)); ) {
          var u = String(l[0])
          ;(s[c] = u), '' === u && (i.lastIndex = Qt(a, lt(i.lastIndex), o)), c++
        }
        return 0 === c ? null : s
      },
    ]
  ...
  Vt('search', 1, function (t, e, n) {
    return [
      ...
      function (t) {
        ...
        var l = te(i, a)
        return ee(i.lastIndex, o) || (i.lastIndex = o), null === l ? -1 : l.index
      },
    ]
  })
  var ne = {}
    ...
    Q(
      ...
      function () {
        var t = E(this),
          e = String(t.source),
          n = t.flags
        return '/' + e + '/' + String(void 0 === n && t instanceof RegExp && !('flags' in ce) ? zt.call(t) : n)
      },
      { unsafe: !0 }
    )
  var be = function (t) {
    ...
    return [
      ...
      function (t, r) {
        ...
        for (var m, v = '', y = 0, k = 0; k < h.length; k++) {
          g = h[k]
          for (var b = String(g[0]), w = we(xe(at(g.index), u.length), 0), x = [], S = 1; S < g.length; S++)
    ...
    $e = function (t, e) {
      ...
      return (Oe[t] =
        ...
        !i(function () {
          if (r && !a) return !0
          var t = { length: -1 }
          r ? Re(t, 1, { enumerable: !0, get: Ie }) : (t[1] = 1), n.call(t, o, l)
        }))
    },
    Ce = dt.indexOf,
    Le = [].indexOf,
  ...
  At(
    ...
    {
      indexOf: function (t) {
        return Pe ? Le.apply(this, arguments) || 0 : Ce(this, t, arguments.length > 1 ? arguments[1] : void 0)
      },
    }
  )
  var Ne = [].join,
  ...
  var De,
    ...
    Fe = function (t, e) {
      ...
      return (
        Ke(t) &&
          ('function' != typeof (n = t.constructor) || (n !== Array && !Ke(n.prototype))
    ...
    Ye = { forEach: Be(0), map: Be(1), filter: Be(2), some: Be(3), every: Be(4), find: Be(5), findIndex: Be(6) },
  ...
  Qe
    ...
    : Ve && (!(De = Ve.match(/Edge\/(\d+)/)) || De[1] >= 74) && (De = Ve.match(/Chrome\/(\d+)/)) && (Ze = De[1])
  var tn = Ze && +Ze,
    en = Wt('species'),
    nn = function (t) {
      return (
  ...
  At(
    { target: 'Array', proto: !0, forced: !sn || !cn },
    {
      slice: function (t, e) {
        ...
        for (r = new (void 0 === n ? Array : n)(dn(s - l, 0)), i = 0; l < s; l++, i++) l in a && ln(r, i, a[l])
        return (r.length = i), r
      },
    }
  )
  ...
  if (
    ...
    Et(
      ...
      !En ||
        _n ||
        i(function () {
          return (Tn[bn] = !1), wn(Sn) != Sn || wn(Tn) == Tn || '/a/i' != wn(Sn, 'i')
        })
    )
  ) {
    for (
      var An = function (t, e) {
          ...
          En ? i && !a && (t = t.source) : t instanceof An && (a && (e = zt.call(t)), (t = t.source)),
  ...
  At(
    {
      target: 'String',
      proto: !0,
      forced: !!(Nn || ((In = Pn(String.prototype, 'endsWith')), !In || In.writable)) && !Nn,
    },
    {
      endsWith: function (t) {
        var e = String(h(this))
            ...
            ? function (t, n) {
                ...
                for (
                  ...
                  !(
                    ...
                    a.length > 1 && a.index < r.length && Un.apply(s, a.slice(1)),
                    (l = a[0].length),
                    (u = o),
                    s.length >= i)
                  );
                ...
                return (
                  u === r.length ? (!l && p.test('')) || s.push('') : s.push(r.slice(u)),
        ...
        [
          ...
          function (t, i) {
            ...
            var o = E(t),
              ...
              c = o.unicode,
              u = (o.ignoreCase ? 'i' : '') + (o.multiline ? 'm' : '') + (o.unicode ? 'u' : '') + (Wn ? 'y' : 'g'),
            ...
            for (var f = 0, h = 0, g = []; h < l.length; ) {
              ...
              if (null === v || (m = Dn(lt(p.lastIndex + (Wn ? 0 : h)), l.length)) === f) h = Qt(l, h, c)
              else {
                if ((g.push(l.slice(f, h)), g.length === d)) return g
                for (var y = 1; y <= v.length - 1; y++) if ((g.push(v[y]), g.length === d)) return g
                h = f = m
              }
            }
  ...
  var Bn = '\t\n\v\f\r                　\u2028\u2029\ufeff',
    ...
    Xn = function (t) {
      return function (e) {
        var n = String(h(e))
        return 1 & t && (n = n.replace(Vn, '')), 2 & t && (n = n.replace(Gn, '')), n
      }
    },
  ...
  var nr = Qn.end,
    ...
    ir = rr
      ...
      : ''.trimEnd
  At({ target: 'String', proto: !0, forced: rr }, { trimEnd: ir, trimRight: ir })
  var ar = e(function (t) {
      function e() {
        return {
          baseUrl: null,
    ...
    { target: 'Array', proto: !0, forced: !or || !lr },
    {
      splice: function (t, e) {
        var n,
          ...
          p = arguments.length
        if (
          (0 === p ? (n = r = 0) : 1 === p ? ((n = 0), (r = c - u)) : ((n = p - 2), (r = cr(sr(at(e), 0), c - u))),
          c + n - r > ur)
        )
          throw TypeError(pr)
        for (i = Fe(s, r), a = 0; a < r; a++) (o = u + a) in s && ln(i, a, s[o])
        if (((i.length = r), n < r)) {
          for (a = u; a < c - r; a++) (l = a + n), (o = a + r) in s ? (s[l] = s[o]) : delete s[l]
          for (a = c; a > c - r + n; a--) delete s[a - 1]
        } else if (n > r)
          for (a = c - r; a > u; a--) (l = a + n - 1), (o = a + r - 1) in s ? (s[l] = s[o]) : delete s[l]
  ...
  var Sr = {},
    ...
    _r = /^([^:]+:\/*[^/]*)[\s\S]*$/
  function Ar(t, e) {
    Sr[' ' + t] || (Tr.test(t) ? (Sr[' ' + t] = t + '/') : (Sr[' ' + t] = zr(t, '/', !0)))
    ...
    Ir = function (t, e) {
      ...
      var n = {
        replace: function (e, r) {
          return (r = (r = r.source || r).replace(br, '$1')), (t = t.replace(e, r)), n
        },
        getRegex: function () {
        ...
        ge(t, [
                ...
                var n = e[0],
                  r = (function (t, e) {
                    ...
                    return e
                      ...
                      .map(function (t) {
                        var e = t.match(/^\s+/)
                        return null === e ? t : me(e, 1)[0].length >= r.length ? t.slice(r.length) : t
                      })
                      .join('\n')
                  })(n, e[3] || '')
                ...
                if (n.header.length === n.align.length) {
                  ...
                  for (r = 0; r < i; r++)
                    /^ *-+: *$/.test(n.align[r])
                      ...
                      ? (n.align[r] = 'left')
                      : (n.align[r] = null)
                  for (i = n.cells.length, r = 0; r < i; r++) n.cells[r] = Dr(n.cells[r], n.header.length)
                  return n
                }
              }
            },
              ...
              if (e) {
                for (
                  var n,
                    ...
                    u = e[2],
                    p = u.length > 1,
                    d = { type: 'list', raw: c, ordered: p, start: p ? +u : '', loose: !1, items: [] },
                  ...
                  (c = n = f[m]),
                    ...
                    d.items.push({ type: 'list_item', raw: c, task: l, checked: s, loose: o, text: n })
                return d
              }
            },
          },
              ...
              if (e) {
                ...
                if (n.header.length === n.align.length) {
                  ...
                  for (i = n.cells.length, r = 0; r < i; r++)
                    n.cells[r] = Dr(n.cells[r].replace(/^ *\| *| *\| *$/g, ''), n.header.length)
                  return n
                }
              }
            },
          ...
          },
          {
            ...
            value: function (t, e, n) {
              ...
              if (r)
                return (
                  !e && /^<a /i.test(r[0]) ? (e = !0) : e && /^<\/a>/i.test(r[0]) && (e = !1),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (e) return { type: 'strong', raw: e[0], text: e[4] || e[3] || e[2] || e[1] }
            },
          },
          {
            key: 'em',
            value: function (t) {
              ...
              if (e) return { type: 'em', raw: e[0], text: e[6] || e[5] || e[4] || e[3] || e[2] || e[1] }
            },
          },
          {
            key: 'codespan',
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if (i)
                return (
                  (r = '@' === i[2] ? 'mailto:' + (n = Zr(this.options.mangle ? e(i[1]) : i[1])) : (n = Zr(i[1]))),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if ((n = this.rules.inline.url.exec(t))) {
                var r, i
                if ('@' === n[2]) i = 'mailto:' + (r = Zr(this.options.mangle ? e(n[0]) : n[0]))
                else {
                  var a
                  do {
  ...
  ;(Yr.def = Hr(Yr.def).replace('label', Yr._label).replace('title', Yr._title).getRegex()),
    (Yr.bullet = /(?:[*+-]|\d{1,9}\.)/),
    (Yr.item = /^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/),
    ...
    (Yr.paragraph = Hr(Yr._paragraph)
      ...
      .replace('tag', Yr._tag)
      .getRegex()),
    (Yr.blockquote = Hr(Yr.blockquote).replace('paragraph', Yr.paragraph).getRegex()),
    (Yr.normal = Br({}, Yr)),
    (Yr.gfm = Br({}, Yr.normal, {
      nptable:
  ...
  ;(Vr.em = Hr(Vr.em)
    ...
    (Vr._email = /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/),
    (Vr.autolink = Hr(Vr.autolink).replace('scheme', Vr._scheme).replace('email', Vr._email).getRegex()),
    (Vr._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
    (Vr.tag = Hr(Vr.tag).replace('comment', Yr._comment).replace('attribute', Vr._attribute).getRegex()),
    (Vr._label = /(?:\[[^\[\]]*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
    ...
    (Vr.gfm.url = Hr(Vr.gfm.url, 'i').replace('email', Vr.gfm._extended_email).getRegex()),
    (Vr.breaks = Br({}, Vr.gfm, {
  ...
  function ni(t) {
    var e,
      ...
      i = t.length
    for (e = 0; e < i; e++)
      (n = t.charCodeAt(e)), Math.random() > 0.5 && (n = 'x' + n.toString(16)), (r += '&#' + n + ';')
    return r
  }
  var ri = (function () {
      function t(e) {
        ...
        this.options.pedantic
          ...
          : this.options.gfm &&
            ((n.block = Qr.gfm), this.options.breaks ? (n.inline = ti.breaks) : (n.inline = ti.gfm)),
            ...
            },
            {
              ...
              value: function (t) {
                ...
                for (t = t.replace(/^ +$/gm, ''); t; )
                  if ((e = this.tokenizer.space(t))) (t = t.substring(e.raw.length)), e.type && a.push(e)
                  else if ((e = this.tokenizer.code(t, a)))
                    (t = t.substring(e.raw.length)),
                      e.type ? a.push(e) : (((i = a[a.length - 1]).raw += '\n' + e.raw), (i.text += '\n' + e.text))
                  else if ((e = this.tokenizer.fences(t))) (t = t.substring(e.raw.length)), a.push(e)
                  else if ((e = this.tokenizer.heading(t))) (t = t.substring(e.raw.length)), a.push(e)
                  else if ((e = this.tokenizer.nptable(t))) (t = t.substring(e.raw.length)), a.push(e)
                  else if ((e = this.tokenizer.hr(t))) (t = t.substring(e.raw.length)), a.push(e)
                  else if ((e = this.tokenizer.blockquote(t)))
                    (t = t.substring(e.raw.length)), (e.tokens = this.blockTokens(e.text, [], o)), a.push(e)
                  else if ((e = this.tokenizer.list(t))) {
                    for (t = t.substring(e.raw.length), r = e.items.length, n = 0; n < r; n++)
                      e.items[n].tokens = this.blockTokens(e.items[n].text, [], !1)
                    a.push(e)
                  } else if ((e = this.tokenizer.html(t))) (t = t.substring(e.raw.length)), a.push(e)
                  else if (o && (e = this.tokenizer.def(t)))
                    (t = t.substring(e.raw.length)),
                      this.tokens.links[e.tag] || (this.tokens.links[e.tag] = { href: e.href, title: e.title })
                  else if ((e = this.tokenizer.table(t))) (t = t.substring(e.raw.length)), a.push(e)
                  else if ((e = this.tokenizer.lheading(t))) (t = t.substring(e.raw.length)), a.push(e)
                  else if (o && (e = this.tokenizer.paragraph(t))) (t = t.substring(e.raw.length)), a.push(e)
                ...
                for (e = 0; e < l; e++)
                  switch ((o = t[e]).type) {
                    ...
                    case 'heading':
                      ...
                      break
                    case 'table':
                      for (o.tokens = { header: [], cells: [] }, i = o.header.length, n = 0; n < i; n++)
                        (o.tokens.header[n] = []), this.inlineTokens(o.header[n], o.tokens.header[n])
                      for (i = o.cells.length, n = 0; n < i; n++)
                        for (a = o.cells[n], o.tokens.cells[n] = [], r = 0; r < a.length; r++)
                          (o.tokens.cells[n][r] = []), this.inlineTokens(a[r], o.tokens.cells[n][r])
                      break
                    case 'blockquote':
            ...
            },
            {
              ...
              value: function (t) {
                for (
                  ...
                  if ((e = this.tokenizer.escape(t))) (t = t.substring(e.raw.length)), n.push(e)
                  else if ((e = this.tokenizer.tag(t, r, i)))
                    (t = t.substring(e.raw.length)), (r = e.inLink), (i = e.inRawBlock), n.push(e)
                    ...
                    (t = t.substring(e.raw.length)), (e.tokens = this.inlineTokens(e.text, [], r, i)), n.push(e)
                  else if ((e = this.tokenizer.em(t)))
                    (t = t.substring(e.raw.length)), (e.tokens = this.inlineTokens(e.text, [], r, i)), n.push(e)
                  else if ((e = this.tokenizer.codespan(t))) (t = t.substring(e.raw.length)), n.push(e)
                  else if ((e = this.tokenizer.br(t))) (t = t.substring(e.raw.length)), n.push(e)
                  else if ((e = this.tokenizer.del(t)))
                    (t = t.substring(e.raw.length)), (e.tokens = this.inlineTokens(e.text, [], r, i)), n.push(e)
                  else if ((e = this.tokenizer.autolink(t, ni))) (t = t.substring(e.raw.length)), n.push(e)
                  else if (r || !(e = this.tokenizer.url(t, ni))) {
                    if ((e = this.tokenizer.inlineText(t, i, ei))) (t = t.substring(e.raw.length)), n.push(e)
                    else if (t) {
      ...
      return (
        ge(t, [
          ...
          },
          {
            ...
            value: function (t, e, n, r) {
              return this.options.headerIds
                ? '<h' + e + ' id="' + this.options.headerPrefix + r.slug(n) + '">' + t + '</h' + e + '>\n'
                : '<h' + e + '>' + t + '</h' + e + '>\n'
            },
          },
          {
          ...
          },
          {
            key: 'link',
            value: function (t, e, n) {
              if (null === (t = ai(this.options.sanitize, this.options.baseUrl, t))) return n
              var r = '<a href="' + oi(t) + '"'
                  ...
                  switch ((u = t[e]).type) {
                    ...
                    case 'table':
                      ...
                      for (s += this.renderer.tablerow(l), c = '', i = u.cells.length, n = 0; n < i; n++) {
                        for (l = '', a = (o = u.tokens.cells[n]).length, r = 0; r < a; r++)
                          l += this.renderer.tablecell(this.parseInline(o[r]), { header: !1, align: u.align[r] })
                    ...
                    case 'blockquote':
                      ...
                      continue
                    case 'list':
                      for (p = u.ordered, d = u.start, f = u.loose, i = u.items.length, c = '', n = 0; n < i; n++)
                    ...
                    case 'paragraph':
                      ...
                      continue
                    case 'text':
                      for (c = u.tokens ? this.parseInline(u.tokens) : u.text; e + 1 < w && 'text' === t[e + 1].type; )
  ...
  function ki(t, e, n) {
    ...
    if (('function' == typeof e && ((n = e), (e = null)), (e = fi({}, ki.defaults, e || {})), hi(e), n)) {
      var r,
        i = e.highlight
      try {
        r = ri.lex(t, e)
        ...
        ki.walkTokens(r, function (t) {
          'code' === t.type &&
            ...
            i(t.text, t.lang, function (e, n) {
              if (e) return a(e)
              null != n && n !== t.text && ((t.text = n), (t.escaped = !0)), 0 === --o && a()
            }))
        }),
        void (0 === o && a())
      )
    ...
    try {
      ...
      if (((t.message += '\nPlease report this to https://github.com/markedjs/marked.'), e.silent))
        return '<p>An error occurred:</p><pre>' + gi(t.message + '', !0) + '</pre>'
      throw t
    }
  }
  ;(ki.options = ki.setOptions = function (t) {
  ...
  return function () {
    ...
    function n() {
      var n
      !e || e.closed
        ? (((e = window.open('about:blank', 'reveal.js - Notes', 'width=1100,height=700')).marked = bi),
          e.document.write(
              ...
              window.addEventListener('message', function (i) {
                ...
                c &&
                  ...
                  c &&
                    ...
                    (s = t[a].apply(t, o)),
                    e.postMessage(
                      JSON.stringify({ namespace: 'reveal-notes', type: 'return', result: s, callId: l }),
                      '*'
                    ))
              }))
            : alert(
      ...
      function r(n) {
        ...
        if (
          (r.hasAttribute('data-notes') && ((o.notes = r.getAttribute('data-notes')), (o.whitespace = 'pre-wrap')), a)
        ) {
          var l = a.querySelector('aside.notes')
          l
            ? (i = l)
            : a.hasAttribute('data-notes') &&
              ((o.notes = a.getAttribute('data-notes')), (o.whitespace = 'pre-wrap'), (i = null))
        }
        i && ((o.notes = i.innerHTML), (o.markdown = 'string' == typeof i.getAttribute('data-markdown'))),
      ...
      init: function (e) {
        ;(t = e),
          /receiver/i.test(window.location.search) ||
            ...
            t.addKeyBinding({ keyCode: 83, key: 'S', description: 'Speaker notes view' }, function () {
              n()
            }))
      },
      open: n,
