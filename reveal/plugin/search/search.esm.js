...
var n = function (t) {
  ...
  S = Math.random(),
  w = function (t) {
    return 'Symbol(' + String(void 0 === t ? '' : t) + ')_' + (++m + S).toString(36)
  },
  O =
  ...
  P = function (t) {
    return E(_, t) || (O && E(T, t) ? (_[t] = T[t]) : (_[t] = j('Symbol.' + t))), _[t]
  },
  I = {}
I[P('toStringTag')] = 'z'
...
var Y = {
    ...
    getterFor: function (t) {
      return function (e) {
        var n
        if (!c(e) || (n = k(e)).type !== t) throw TypeError('Incompatible receiver, ' + t + ' required')
        return n
      }
    },
  },
  X = e(function (t) {
    ...
    ;(t.exports = function (t, e, i, c) {
      ...
      'function' == typeof i &&
        ...
        t !== r ? (u ? !l && t[e] && (a = !0) : delete t[e], a ? (t[e] = i) : h(t, e, i)) : a ? (t[e] = i) : y(e, i)
...
var jt = {
  ...
  Ct = function (t, e) {
    return arguments.length < 2 ? It(Pt[t]) || It(r[t]) : (Pt[t] && Pt[t][e]) || (r[t] && r[t][e])
  },
  Nt = P('species'),
  At = g.f,
  kt = Ot.f,
...
if (
  ...
  at(
    ...
    !Kt ||
      zt ||
      o(function () {
        return (Ft[Lt] = !1), Mt(Dt) != Dt || Mt(Ft) == Ft || '/a/i' != Mt(Dt, 'i')
      })
  )
) {
  for (
    var Bt = function (t, e) {
        ...
        Kt ? u && !a && (t = t.source) : t instanceof Bt && (a && (e = _t.call(t)), (t = t.source)),
...
var Vt = {}.propertyIsEnumerable,
  ...
  ie = (function () {
    var t = /a/,
      e = /b*/g
    return ne.call(t, 'a'), ne.call(e, 'a'), 0 !== t.lastIndex || 0 !== e.lastIndex
  })(),
  ...
  X(
    ...
    function () {
      var t = f(this),
        e = String(t.source),
        n = t.flags
      return '/' + e + '/' + String(void 0 === n && t instanceof RegExp && !('flags' in le) ? _t.call(t) : n)
    },
    { unsafe: !0 }
  )
var ge = P('species'),
    ...
    return function (e, n) {
      ...
      return c < 0 || c >= u
        ? t
          ? ''
          : void 0
        : (r = i.charCodeAt(c)) < 55296 || r > 56319 || c + 1 === u || (o = i.charCodeAt(c + 1)) < 56320 || o > 57343
        ? t
          ? i.charAt(c)
          : r
        : t
  ...
  Se = function (t, e) {
    ...
    if ('RegExp' !== J(t)) throw TypeError('RegExp#exec called on incompatible receiver')
    return ae.call(t, e)
  },
  we = Math.max,
  Oe = Math.min,
...
!(function (t, e, n, r) {
  ...
  if (!c || !u || ('replace' === t && (!de || !he || ve)) || ('split' === t && !be)) {
    var a = /./[i],
      l = n(
        i,
        ''[t],
        ...
        { REPLACE_KEEPS_$0: he, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: ve }
      ),
      f = l[0],
      s = l[1]
  ...
  return [
    ...
    function (t, r) {
      ...
      for (var v, b = '', x = 0, E = 0; E < h.length; E++) {
        y = h[E]
        for (var m = String(y[0]), S = we(Oe(yt(y.index), s.length), 0), w = [], O = 1; O < y.length; O++)
      ...
      e.call(c, l, function (e, c) {
        ...
        switch (c.charAt(0)) {
          ...
          default:
            ...
            if (f > a) {
              var s = Re(f / 10)
              return 0 === s ? e : s <= a ? (void 0 === o[s - 1] ? c.charAt(1) : o[s - 1] + c.charAt(1)) : e
            }
            l = o[f - 1]
        }
        return void 0 === l ? '' : l
...
export default function () {
            ...
            case 13:
              e.preventDefault(),
                (function () {
                  if (i) {
                    var e = n.value
                    '' === e ? (c && c.remove(), (r = null)) : ((c = new f('slidecontent')), (r = c.apply(e)), (o = 0))
                  }
                  r && (r.length && r.length <= o && (o = 0), r.length > o && (t.slide(r[o].h, r[o].v), o++))
                })(),
                (i = !1)
              break
            default:
  ...
  function f(e, n) {
    ...
    ;(this.setRegex = function (t) {
      ;(t = t.replace(/^[^\w]+|[^\w]+$/g, '').replace(/[^\w'-]+/g, '|')), (l = new RegExp('(' + t + ')', 'i'))
    }),
      ...
      (this.hiliteWords = function (e) {
        if (null != e && e && l && !i.test(e.nodeName)) {
          if (e.hasChildNodes()) for (var n = 0; n < e.childNodes.length; n++) this.hiliteWords(e.childNodes[n])
          var r, s
          if (3 == e.nodeType)
            if ((r = e.nodeValue) && (s = l.exec(r))) {
              for (var p = e; null != p && 'SECTION' != p.nodeName; ) p = p.parentNode
              var g = t.getIndices(p),
                d = f.length,
                h = !1
              for (n = 0; n < d; n++) f[n].h === g.h && f[n].v === g.v && (h = !0)
              h || f.push(g), u[s[0].toLowerCase()] || (u[s[0].toLowerCase()] = c[a++ % c.length])
              ...
              ;(v.nodeValue = v.nodeValue.substring(s[0].length)), e.parentNode.insertBefore(y, v)
            }
        }
      }),
      (this.remove = function () {
        for (var t, e = document.getElementsByTagName(o); e.length && (t = e[0]); )
          t.parentNode.replaceChild(t.firstChild, t)
      }),
      (this.apply = function (t) {
        if (null != t && t) return this.remove(), this.setRegex(t), this.hiliteWords(r), f
      })
  }
  return {
    id: 'search',
      ...
      ;(t = n).registerKeyboardShortcut('CTRL + Shift + F', 'Search'),
        document.addEventListener(
          ...
          function (t) {
            'F' == t.key &&
              (t.ctrlKey || t.metaKey) &&
              (t.preventDefault(), e || u(), 'inline' !== e.style.display ? a() : l())
          },
          !1
        )
    },
