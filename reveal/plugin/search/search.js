  ...
  var n = function (e) {
    ...
    l =
      ...
      !o(function () {
        return (
          7 !=
          Object.defineProperty(((e = 'div'), a ? u.createElement(e) : {}), 'a', {
            get: function () {
              return 7
            },
          }).a
    ...
    H = t(function (e) {
      ...
      ;(e.exports = function (e, t, i, c) {
        ...
        'function' == typeof i &&
          ...
          e !== r ? (u ? !l && e[t] && (a = !0) : delete e[t], a ? (e[t] = i) : h(e, t, i)) : a ? (e[t] = i) : y(t, i)
  ...
  if (
    ...
    for (
      var We = function (e, t) {
          ...
          ze ? u && !a && (e = e.source) : e instanceof We && (a && (t = _e.call(e)), (e = e.source)),
    ...
    if (!c || !u || ('replace' === e && (!yt || !vt || xt)) || ('split' === e && !mt)) {
      var a = /./[i],
        l = n(
          ...
          { REPLACE_KEEPS_$0: vt, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: xt }
        ),
        f = l[0],
        s = l[1]
                ...
                t.preventDefault(),
                  (function () {
                    if (i) {
                      ...
                      '' === t
                        ? (c && c.remove(), (r = null))
                        : ((c = new f('slidecontent')), (r = c.apply(t)), (o = 0))
                    }
        ...
        ;(e = n).registerKeyboardShortcut('CTRL + Shift + F', 'Search'),
          document.addEventListener(
            ...
            function (e) {
              'F' == e.key &&
                (e.ctrlKey || e.metaKey) &&
                (e.preventDefault(), t || u(), 'inline' !== t.style.display ? a() : l())
            },
            !1
          )
      },
