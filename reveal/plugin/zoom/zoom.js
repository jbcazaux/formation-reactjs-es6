!(function (e, o) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(o)
    : ((e = 'undefined' != typeof globalThis ? globalThis : e || self).RevealZoom = o())
})(this, function () {
  'use strict'
  /*!
   ...
   */ var e = {
      ...
      init: function (e) {
        e.getRevealElement().addEventListener('mousedown', function (t) {
          ...
          t[i] && !e.isOverview() && (t.preventDefault(), o.to({ x: t.clientX, y: t.clientY, scale: d, pan: !1 }))
        })
      },
    },
    o = (function () {
      ...
      function m() {
        ...
        n < i
          ...
          t < o
            ...
            : t > window.innerWidth - o && window.scroll(d.x + (1 - (window.innerWidth - t) / o) * (14 / e), d.y)
      }
      function l() {
        return {
        ...
        }),
        {
          to: function (t) {
            if (1 !== e) o.out()
              ...
              void 0 !== t.width &&
                void 0 !== t.height &&
                (t.scale = Math.max(Math.min(window.innerWidth / t.width, window.innerHeight / t.height), 1)),
                t.scale > 1 &&
                  ((t.x *= t.scale),
                  (t.y *= t.scale),
                  r(t, t.scale),
