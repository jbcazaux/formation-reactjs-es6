...
var n,
  ...
  ce = function () {
    ...
    ce = n
      ...
      : (((t = b('iframe')).style.display = 'none'),
        ae.appendChild(t),
        (t.src = String('javascript:')),
        (e = t.contentWindow.document).open(),
        e.write(de('document.F=Object')),
        e.close(),
        e.F)
...
var ue =
    ...
    function (e, t) {
      var i
      return (
        null !== e ? ((le.prototype = w(e)), (i = new le()), (le.prototype = null), (i[oe] = e)) : (i = ce()),
        void 0 === t ? i : ee(i, t)
      )
    },
  he = U('unscopables'),
  ge = Array.prototype
null == ge[he] && R.f(ge, he, { configurable: !0, value: ue(null) })
var ve = function (e) {
    ge[he][e] = !0
  },
...
var Ce,
  ...
  He = i(function (e) {
    ...
    ;(e.exports = function (e, t, a, r) {
      var o = !!r && !!r.unsafe,
        ...
        d = !!r && !!r.noTargetGet
      'function' == typeof a &&
        ('string' != typeof t || N(a, 'name') || k(a, 'name', t),
        (i(a).source = n.join('string' == typeof t ? t : ''))),
        e !== s ? (o ? !d && e[t] && (l = !0) : delete e[t], l ? (e[t] = a) : k(e, t, a)) : l ? (e[t] = a) : L(t, a)
  ...
  Je = function (e, t) {
    var i,
      ...
      d = e.global,
      c = e.stat
    if ((i = d ? s : c ? s[l] || L(l, {}) : (s[l] || {}).prototype))
      for (n in t) {
        if (
          ((r = t[n]),
          (a = e.noTargetGet ? (o = Ge(i, n)) && o.value : i[n]),
          !Ye(d ? n : l + (c ? '.' : '#') + n, e.forced) && void 0 !== a)
        ) {
  ...
  nt = U('iterator'),
  at = !1
;[].keys && ('next' in (Ne = [].keys()) ? (Pe = it(it(Ne))) !== Object.prototype && (Ce = Pe) : (at = !0)),
  null == Ce && (Ce = {}),
  N(Ce, nt) ||
    k(Ce, nt, function () {
      return this
    })
var st = { IteratorPrototype: Ce, BUGGY_SAFARI_ITERATORS: at },
  rt = R.f,
  ot = U('toStringTag'),
  lt = function (e, t, i) {
    e && !N((e = i ? e : e.prototype), ot) && rt(e, ot, { configurable: !0, value: t })
  },
  ...
  mt = (function (e, t, i, n, a, s, r) {
    !(function (e, t, i) {
      var n = t + ' Iterator'
      ;(e.prototype = ue(dt, { next: A(1, i) })), lt(e, n, !1)
    })(i, t, n)
    var o,
      l,
      d,
    ...
    if (
      (f &&
        ...
        ut !== Object.prototype &&
          o.next &&
          (it(o) !== ut && (ct ? ct(o, ut) : 'function' != typeof o[gt] && k(o, gt, vt)), lt(o, u, !0))),
      'values' == a &&
        v &&
        'values' !== v.name &&
        ((h = !0),
      ...
      if (((l = { values: c('values'), keys: s ? p : c('keys'), entries: c('entries') }), r))
        for (d in l) (ht || h || !(d in g)) && He(g, d, l[d])
      else Je({ target: t, proto: !0, forced: ht || h }, l)
    return l
  })(
    Array,
    'Array',
    function (e, t) {
      pt(this, { type: 'Array Iterator', target: g(e), index: 0, kind: t })
    },
    function () {
      var e = ft(this),
        t = e.target,
    ...
    return (
      ...
      r
        ? n
          ...
          : (s.lastIndex = 0)
        : Ot && n && (s.lastIndex = s.global ? n.index + n[0].length : t),
      Ht &&
        n &&
        n.length > 1 &&
        Tt.call(n[0], i, function () {
...
var Bt = Dt
Je({ target: 'RegExp', proto: !0, forced: /./.exec !== Bt }, { exec: Bt })
var Ut = U('species'),
  jt = !o(function () {
    var e = /./
    return (
    ...
    return function (t, i) {
      ...
      return r < 0 || r >= o
        ? e
          ? ''
          : void 0
        : (n = s.charCodeAt(r)) < 55296 || n > 56319 || r + 1 === o || (a = s.charCodeAt(r + 1)) < 56320 || a > 57343
        ? e
          ? s.charAt(r)
          : n
        : e
  ...
  Kt = { codeAt: Vt(!1), charAt: Vt(!0) }.charAt,
  Xt = function (e, t, i) {
  ...
  if (!s || !r || ('replace' === e && (!jt || !Ft || Wt)) || ('split' === e && !_t)) {
    var l = /./[a],
      d = i(
        ...
        { REPLACE_KEEPS_$0: Ft, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: Wt }
      ),
      c = d[0],
      u = d[1]
  ...
  return [
    ...
    function (e, n) {
      ...
      for (var f, m = '', b = 0, y = 0; y < v.length; y++) {
        p = v[y]
        for (var S = String(p[0]), E = Yt(Gt(q(p.index), c.length), 0), R = [], A = 1; A < p.length; A++)
          R.push(void 0 === (f = p[A]) ? f : String(f))
        var k = p.groups
        if (u) {
  ...
  i(function (e, t) {
    ...
    t.default = (function (e) {
      if (e) {
        var t = function (e) {
          ...
          p = function (t) {
            ...
            ;(t.currentFontSize = parseInt(i.getPropertyValue('font-size'), 10)),
          ...
          R = function (e) {
            e.observeMutations &&
              ((e.observer = new MutationObserver(y(e, a))), e.observer.observe(e.element, e.observeMutations))
          },
          A = {
            minSize: 16,
            maxSize: 512,
      ...
      function C(e, t) {
        var n = i({}, A, t),
          a = e.map(function (e) {
            var t = i({}, n, { element: e, active: !0 })
            return (
              (function (e) {
                R(e), (e.newbie = !0), (e.dirty = !0), o.push(e)
              })(t),
              { element: e, fit: y(t, r), unfreeze: S(t), freeze: E(t), unsubscribe: w(t) }
            )
          })
        return d(), a
      }
...
class bi {
  ...
  load(e, t = {}) {
    ;(e.style.display = this.Reveal.getConfig().display),
      ti(e, 'img[data-src], video[data-src], audio[data-src], iframe[data-src]').forEach(e => {
      ...
      ti(e, 'video, audio').forEach(e => {
        ...
        ti(e, 'source[data-src]').forEach(e => {
          ...
          gi && 'VIDEO' === e.tagName && e.setAttribute('playsinline', ''),
          t > 0 && e.load()
      })
      ...
      if (!1 === i.hasAttribute('data-loaded')) {
        ...
        if (s) n.style.backgroundImage = 'url(' + encodeURI(s) + ')'
          ...
          o && e.setAttribute('loop', ''),
            l && (e.muted = !0),
            gi && ((e.muted = !0), e.setAttribute('playsinline', '')),
            r.split(',').forEach(t => {
    ...
    Array.from(e.querySelectorAll('.r-fit-text:not([data-fitted])')).forEach(e => {
      ;(e.dataset.fitted = ''),
        mi(e, { minSize: 24, maxSize: 0.8 * this.Reveal.getConfig().height, observeMutations: !1, observeWindow: !1 })
    })
  }
  unload(e) {
  ...
  startEmbeddedContent(e) {
    e &&
      ...
      ti(e, 'video, audio').forEach(e => {
        ...
        if (
          ('boolean' != typeof t && (t = e.hasAttribute('data-autoplay') || !!ri(e, '.slide-background')),
      ...
      ti(e, 'iframe[src]').forEach(e => {
        ;(ri(e, '.fragment') && !ri(e, '.fragment.visible')) || this.startEmbeddedIframe({ target: e })
      }),
      ti(e, 'iframe[data-src]').forEach(e => {
        ;(ri(e, '.fragment') && !ri(e, '.fragment.visible')) ||
  ...
  startEmbeddedIframe(e) {
    ...
    if (t && t.contentWindow) {
      ...
      if (i && n) {
        ...
        'boolean' != typeof e && (e = t.hasAttribute('data-autoplay') || !!ri(t, '.slide-background')),
  ...
  getSlideNumber(e = this.Reveal.getCurrentSlide()) {
    ...
    if ('function' == typeof i.slideNumber) t = i.slideNumber(e)
      ...
      'string' == typeof i.slideNumber && (n = i.slideNumber),
        /c/.test(n) || 1 !== this.Reveal.getHorizontalSlides().length || (n = 'c')
...
const wi = e => {
  ...
  if (i && i[1])
    return (
      (i = i[1]), { r: parseInt(i.substr(0, 2), 16), g: parseInt(i.substr(2, 2), 16), b: parseInt(i.substr(4, 2), 16) }
    )
...
class Si {
  ...
  sync(e) {
    ...
    n.background &&
      (/^(http|file|\/\/)/gi.test(n.background) || /\.(svg|png|jpg|jpeg|gif|bmp)([?#\s]|$)/gi.test(n.background)
        ? e.setAttribute('data-background-image', n.background)
        : (t.style.background = n.background)),
      (n.background || n.backgroundColor || n.backgroundImage || n.backgroundVideo || n.backgroundIframe) &&
        t.setAttribute(
      ...
      n.backgroundSize && t.setAttribute('data-background-size', n.backgroundSize),
      n.backgroundColor && (t.style.backgroundColor = n.backgroundColor),
      n.backgroundTransition && t.setAttribute('data-background-transition', n.backgroundTransition),
      ...
      n.backgroundPosition && (i.style.backgroundPosition = n.backgroundPosition),
    ...
    if (
      (Array.from(this.element.childNodes).forEach((t, r) => {
        t.classList.remove('past', 'present', 'future'),
          r < i.h ? t.classList.add(a) : r > i.h ? t.classList.add(s) : (t.classList.add('present'), (n = t)),
          (e || r === i.h) &&
            ti(t, '.slide-background').forEach((e, t) => {
      ...
      i && i === t && n !== this.previousBackground && this.element.classList.add('no-transition'),
...
class Ri {
  ...
  run(e, t) {
    if ((this.reset(), e.hasAttribute('data-auto-animate') && t.hasAttribute('data-auto-animate'))) {
      ...
      let a = this.getAutoAnimatableElements(e, t).map(e =>
        this.autoAnimateElements(e.from, e.to, e.options || {}, i, Ei++)
      )
  ...
  autoAnimateElements(e, t, i, n, a) {
    ...
    if (t.classList.contains('fragment') && (delete o.styles.opacity, e.classList.contains('fragment'))) {
      ;(e.className.match(Lt) || [''])[0] === (t.className.match(Lt) || [''])[0] &&
    ...
    if (d.length > 0) {
      ;(r.styles.transition = 'none'),
        (o.styles.transition = 'all '.concat(s.duration, 's ').concat(s.easing, ' ').concat(s.delay, 's')),
  ...
  getAutoAnimateOptions(e, t) {
    ...
    return (
      ...
      e.dataset.autoAnimateDuration && (i.duration = parseFloat(e.dataset.autoAnimateDuration)),
      e.dataset.autoAnimateDelay && (i.delay = parseFloat(e.dataset.autoAnimateDelay)),
      i
    )
  }
  ...
  getAutoAnimatePairs(e, t) {
    ...
    return (
      ...
      this.findAutoAnimateMatches(i, e, t, n, e => e.nodeName + ':::' + e.innerText),
  ...
  getUnmatchedAutoAnimateElements(e) {
    return [].slice.call(e.children).reduce((e, t) => {
      ...
      return (
        ...
        t.querySelector('[data-auto-animate-target]') && (e = e.concat(this.getUnmatchedAutoAnimateElements(t))),
        e
      )
    }, [])
  }
  ...
  update(e, t) {
    ...
    if (n && this.Reveal.getConfig().fragments && (t = t || this.sort(n.querySelectorAll('.fragment'))).length) {
      ...
      Array.from(t).forEach((t, n) => {
        if (
          (t.hasAttribute('data-fragment-index') && (n = parseInt(t.getAttribute('data-fragment-index'), 10)),
          (a = Math.max(a, n)),
          n <= e)
        ) {
          ...
          t.classList.remove('visible'),
            t.classList.remove('current-fragment'),
            e && (i.hidden.push(t), this.Reveal.dispatchEvent({ target: t, type: 'hidden', bubbles: !1 }))
        }
      }),
  ...
  goto(e, t = 0) {
    ...
    if (i && this.Reveal.getConfig().fragments) {
      ...
      if (n.length) {
        ...
        return (
          a.hidden.length &&
            this.Reveal.dispatchEvent({ type: 'fragmenthidden', data: { fragment: a.hidden[0], fragments: a.hidden } }),
          a.shown.length &&
            this.Reveal.dispatchEvent({ type: 'fragmentshown', data: { fragment: a.shown[0], fragments: a.shown } }),
  ...
  activate() {
    if (this.Reveal.getConfig().overview && !this.isActive()) {
      ;(this.active = !0),
        ...
        ti(this.Reveal.getRevealElement(), '.slides section').forEach(e => {
      ...
      this.Reveal.dispatchEvent({
        type: 'overviewshown',
        data: { indexh: i.h, indexv: i.v, currentSlide: this.Reveal.getCurrentSlide() },
      })
    }
  }
  layout() {
    this.Reveal.getHorizontalSlides().forEach((e, t) => {
      e.setAttribute('data-index-h', t),
        ai(e, 'translate3d(' + t * this.overviewSlideWidth + 'px, 0, 0)'),
        e.classList.contains('stack') &&
          ti(e, 'section').forEach((e, i) => {
            e.setAttribute('data-index-h', t),
              e.setAttribute('data-index-v', i),
              ai(e, 'translate3d(0, ' + i * this.overviewSlideHeight + 'px, 0)')
          })
    }),
      Array.from(this.Reveal.getBackgroundsElement().childNodes).forEach((e, t) => {
        ai(e, 'translate3d(' + t * this.overviewSlideWidth + 'px, 0, 0)'),
          ti(e, '.slide-background').forEach((e, t) => {
  ...
  onDocumentKeyDown(e) {
    ...
    !1 === v &&
      ...
      v
        ...
        : (27 !== i && 79 !== i) ||
          (!1 === this.Reveal.closeOverlay() && this.Reveal.overview.toggle(), e.preventDefault && e.preventDefault()),
      this.Reveal.cueAutoSlide()
  }
}
class xi {
  ...
  readURL() {
    ...
    if (!/^[0-9]*$/.test(a[0]) && s.length) {
      let e, n
      ;/\/[-\d]+$/g.test(s) &&
        ((n = parseInt(s.split('/').pop(), 10)), (n = isNaN(n) ? void 0 : n), (s = s.split('/').shift()))
      try {
  ...
  getHash(e) {
    ...
    if ((this.Reveal.getConfig().fragmentInURL || (a.f = void 0), 'string' == typeof n && n.length))
      (t = '/' + n), a.f >= 0 && (t += '/' + a.f)
    else {
...
class Ci {
  ...
  render() {
    ...
    ;(this.element = document.createElement('aside')),
      ...
      this.Reveal.getRevealElement().appendChild(this.element),
      (this.controlsLeft = ti(t, '.navigate-left')),
      (this.controlsRight = ti(t, '.navigate-right')),
      (this.controlsUp = ti(t, '.navigate-up')),
      (this.controlsDown = ti(t, '.navigate-down')),
      (this.controlsPrev = ti(t, '.navigate-prev')),
      (this.controlsNext = ti(t, '.navigate-next')),
...
class Ii {
  ...
  registerPlugin(e) {
    ...
    'string' != typeof t
      ...
      ? ((this.registeredPlugins[t] = e), 'loaded' === this.state && 'function' == typeof e.init && e.init(this.Reveal))
...
class Ti {
  ...
  setupPDF() {
    let e = this.Reveal.getConfig(),
      ...
      a = t.width,
      s = t.height
    li('@page{size:' + i + 'px ' + n + 'px; margin: 0px;}'),
      li(
    ...
    ti(this.Reveal.getRevealElement(), '.slides section').forEach(function (e) {
      ...
      ti(this.Reveal.getRevealElement(), '.slides section').forEach(function (t) {
        if (!1 === t.classList.contains('stack')) {
          ...
          ;(c = Math.min(c, e.pdfMaxPagesPerSlide)),
            ((1 === c && e.center) || t.classList.contains('center')) && (l = Math.max((n - d) / 2, 0))
          ...
          if (
            ...
            (t.style.top = l + 'px'),
            (t.style.width = a + 'px'),
            t.slideBackgroundElement && u.insertBefore(t.slideBackgroundElement, t),
            e.showNotes)
          ) {
          ...
          if (e.pdfSeparateFragments) {
            ...
            ti(u, '.fragment:not(.fade-out)').forEach(function (e) {
...
class Di {
  ...
  onTouchMove(e) {
    if (this.isSwipePrevented(e.target)) return !0
    let t = this.Reveal.getConfig()
    if (this.touchCaptured) pi && e.preventDefault()
    else {
      this.Reveal.onUserInput(e)
      ...
      if (1 === e.touches.length && 2 !== this.touchStartCount) {
        ...
        s > 40 && Math.abs(s) > Math.abs(r)
          ? ((this.touchCaptured = !0),
            'linear' === t.navigationMode ? (t.rtl ? this.Reveal.next() : this.Reveal.prev()) : this.Reveal.left())
          : s < -40 && Math.abs(s) > Math.abs(r)
          ? ((this.touchCaptured = !0),
            'linear' === t.navigationMode ? (t.rtl ? this.Reveal.prev() : this.Reveal.next()) : this.Reveal.right())
          : r > 40 && a.up
          ? ((this.touchCaptured = !0), 'linear' === t.navigationMode ? this.Reveal.prev() : this.Reveal.up())
          : r < -40 &&
            a.down &&
            ((this.touchCaptured = !0), 'linear' === t.navigationMode ? this.Reveal.next() : this.Reveal.down()),
          t.embedded ? (this.touchCaptured || this.Reveal.isVerticalSlide()) && e.preventDefault() : e.preventDefault()
      }
    }
  }
  onTouchEnd(e) {
...
class Hi {
  ...
  render() {
    ...
    this.context.save(),
      ...
      this.playing &&
        (this.context.beginPath(),
        this.context.arc(i, n, t, r, s, !1),
        (this.context.lineWidth = this.thickness),
        (this.context.strokeStyle = '#fff'),
        this.context.stroke()),
      this.context.translate(i - 14, n - 14),
      this.playing
        ? ((this.context.fillStyle = '#fff'), this.context.fillRect(0, 0, 10, a), this.context.fillRect(18, 0, 10, a))
        : (this.context.beginPath(),
...
function Ui(e, t) {
  ...
  function z(n) {
    return (
      ...
      (l = { ...Bi, ...l, ...t, ...n, ...di() }),
      H(),
      window.addEventListener('load', re, !1),
      M.load(l.plugins, l.dependencies).then(B),
      new Promise(e => i.on('ready', e))
    )
  }
  function H() {
    !0 === l.embedded
      ? (v.viewport = ri(e, '.reveal-viewport') || e)
    ...
    ;(d = !0),
      ...
      setTimeout(() => {
        v.slides.classList.remove('no-transition'),
          ...
          Q({ type: 'ready', data: { indexh: n, indexv: a, currentSlide: r } })
      }, 1),
      I.isPrintingPDF() &&
        ($(),
  ...
  function U() {
    l.showHiddenSlides ||
      ti(v.wrapper, 'section[data-visibility="hidden"]').forEach(e => {
        e.parentNode.removeChild(e)
      })
  }
  function j() {
    v.slides.classList.add('no-transition'),
      gi ? v.wrapper.classList.add('no-hover') : v.wrapper.classList.remove('no-hover'),
      R.render(),
      S.render(),
      C.render(),
      P.render(),
      ...
      window.addEventListener(
        ...
        e => {
          ...
          if (
            ...
            if (!1 === kt.test(t.method)) {
              const e = i[t.method].apply(i, t.args)
              Z('callback', { method: t.method, result: e })
  ...
  function K(e) {
    ...
    v.wrapper.classList.remove(t.transition),
      ...
      l.shuffle && ke(),
      ii(v.wrapper, 'embedded', l.embedded),
      ii(v.wrapper, 'rtl', l.rtl),
      ii(v.wrapper, 'center', l.center),
      !1 === l.pause && fe(),
      l.previewLinks
      ...
      n > 1 &&
        ...
        ((o = new Hi(v.wrapper, () => Math.min(Math.max((Date.now() - b) / f, 0), 1))), o.on('click', st), (y = !1)),
  ...
  function X() {
    window.addEventListener('resize', it, !1),
      ...
      v.pauseOverlay.addEventListener('click', fe, !1),
      l.focusBodyOnPageVisibilityChange && document.addEventListener('visibilitychange', nt, !1)
  }
  function $() {
    D.unbind(),
      T.unbind(),
      ...
      v.pauseOverlay.removeEventListener('click', fe, !1)
  }
  function Y(t, i, n) {
  ...
  function J(e) {
    'string' == typeof e.layout && (g.layout = e.layout),
      ...
      g.layout ? ai(v.slides, g.layout + ' ' + g.overview) : ai(v.slides, g.overview)
  }
  function Q({ target: e = v.wrapper, type: t, data: i, bubbles: n = !0 }) {
  ...
  function ae() {
    if (l.help) {
      ...
      for (let t in i)
        i[t].key &&
          i[t].description &&
          (e += '<tr><td>'.concat(i[t].key, '</td><td>').concat(i[t].description, '</td></tr>'))
      ;(e += '</table>'),
  ...
  function re() {
    if (v.wrapper && !I.isPrintingPDF()) {
      if (!l.disableLayout) {
        gi && !l.embedded && document.documentElement.style.setProperty('--vh', 0.01 * window.innerHeight + 'px')
        const e = le(),
          t = h
        oe(l.width, l.height),
          ...
          1 === h
            ? ((v.slides.style.zoom = ''),
              ...
              J({ layout: '' }))
            : h > 1 && fi && window.devicePixelRatio < 2
          ...
          'none' !== n.style.display &&
            (l.center || n.classList.contains('center')
              ? n.classList.contains('stack')
                ? (n.style.top = 0)
                : (n.style.top = Math.max((e.height - n.scrollHeight) / 2, 0) + 'px')
              : (n.style.top = ''))
        }
  ...
  function Se(e, t, i, o) {
    ...
    void 0 !== t || k.isActive() || (t = ce(d[e])),
      s && s.parentNode && s.parentNode.classList.contains('stack') && de(s.parentNode, a)
    const c = u.concat()
    u.length = 0
    let h = n || 0,
      g = a || 0
    ;(n = Le('.slides>section', void 0 === e ? n : e)),
      (a = Le('.slides>section.present>section', void 0 === t ? a : t))
    let f = n !== h || a !== g
    f || (s = null)
    let m = d[n],
    ...
    e: for (let e = 0, t = u.length; e < t; e++) {
      ...
      v.viewport.classList.add(u[e]), Q({ type: u[e] })
    }
    for (; c.length; ) v.viewport.classList.remove(c.pop())
    f && Q({ type: 'slidechanged', data: { indexh: n, indexv: a, previousSlide: s, currentSlide: r, origin: o } }),
  ...
  function Ee() {
    $(),
      ...
      !1 === l.autoPlayMedia ? w.stopEmbeddedContent(r, { unloadIframes: !1 }) : w.startEmbeddedContent(r),
      k.isActive() && k.layout()
  }
  function Re(e = r) {
  ...
  function Le(e, t) {
    ...
    if (n) {
        ...
        n.classList.remove('past'),
          ...
          a
            ...
            ? (n.classList.add(s ? 'future' : 'past'),
              l.fragments &&
                ti(n, '.fragment').forEach(e => {
                  e.classList.add('visible'), e.classList.remove('current-fragment')
                }))
            : e > t &&
              (n.classList.add(s ? 'past' : 'future'),
              l.fragments &&
                ti(n, '.fragment.visible').forEach(e => {
                  e.classList.remove('visible', 'current-fragment')
                }))
      }
      let e = i[t],
      ...
      e.classList.add('present'),
        ...
        s || Q({ target: e, type: 'visible', bubbles: !1 })
  ...
  function xe() {
    ...
    if (s && void 0 !== n) {
      ...
      He() ? v.wrapper.classList.add('has-vertical-slides') : v.wrapper.classList.remove('has-vertical-slides'),
        ze() ? v.wrapper.classList.add('has-horizontal-slides') : v.wrapper.classList.remove('has-horizontal-slides')
    }
  }
  function Ce({ includeFragments: e = !1 } = {}) {
    let t = v.wrapper.querySelectorAll('.slides>section'),
      i = v.wrapper.querySelectorAll('.slides>section.present>section'),
      s = { left: n > 0, right: n < t.length - 1, up: a > 0, down: a < i.length - 1 }
    if (
      (l.loop && (t.length > 1 && ((s.left = !0), (s.right = !0)), i.length > 1 && ((s.up = !0), (s.down = !0))),
      t.length > 1 && 'linear' === l.navigationMode && ((s.right = s.right || s.down), (s.left = s.left || s.up)),
      !0 === e)
    ) {
  ...
  function qe() {
    let e = Me()
    return { indexh: e.h, indexv: e.v, indexf: e.f, paused: be(), overview: k.isActive() }
  }
  function We(e) {
    if ('object' == typeof e) {
  ...
  function Ke() {
    f && !y && ((y = !0), Q({ type: 'autoslidepaused' }), clearTimeout(m), o && o.setPlaying(!1))
  }
  function Xe() {
    f && y && ((y = !1), Q({ type: 'autoslideresumed' }), _e())
  }
  function $e() {
    ;(c.hasNavigatedHorizontally = !0),
      l.rtl
        ? (k.isActive() || !1 === A.next()) && Ce().left && Se(n + 1, 'grid' === l.navigationMode ? a : void 0)
        : (k.isActive() || !1 === A.prev()) && Ce().left && Se(n - 1, 'grid' === l.navigationMode ? a : void 0)
  }
  function Ye() {
    ;(c.hasNavigatedHorizontally = !0),
      l.rtl
        ? (k.isActive() || !1 === A.prev()) && Ce().right && Se(n - 1, 'grid' === l.navigationMode ? a : void 0)
        : (k.isActive() || !1 === A.next()) && Ce().right && Se(n + 1, 'grid' === l.navigationMode ? a : void 0)
  }
  function Ge() {
  ...
  function Qe() {
    if (!1 === A.prev())
      if (Ce().up) Ge()
        ...
        let e
        if (
          ((e = l.rtl ? ti(v.wrapper, '.slides>section.future').pop() : ti(v.wrapper, '.slides>section.past').pop()), e)
        ) {
  ...
  function tt(e) {
    'running' === p &&
      ...
      ((p = 'idle'),
      Q({ type: 'slidetransitionend', data: { indexh: n, indexv: a, previousSlide: s, currentSlide: r } }))
  }
  function it(e) {
    re()
  }
...
let ji = Ui,
  Fi = []
;(ji.initialize = e => (
  Object.assign(ji, new Ui(document.querySelector('.reveal'), e)), Fi.map(e => e(ji)), ji.initialize()
)),
