  ...
  w = (b.default = (function (e) {
    if (e) {
      var t = function (e) {
        ...
        A = function (e) {
          e.observeMutations &&
            ((e.observer = new MutationObserver(b(e, a))), e.observer.observe(e.element, e.observeMutations))
        },
        E = {
          minSize: 16,
          maxSize: 512,
      ...
      var i = y({}, E, t),
        a = e.map(function (e) {
          ...
          return (
            ...
            { element: e, fit: b(t, s), unfreeze: R(t), freeze: S(t), unsubscribe: w(t) }
          )
        })
      return l(), a
    }
...
class R {
  ...
  layout(e) {
    Array.from(e.querySelectorAll('.r-fit-text')).forEach(e => {
      w(e, { minSize: 24, maxSize: 0.8 * this.Reveal.getConfig().height, observeMutations: !1, observeWindow: !1 })
    })
  }
  unload(e) {
  ...
  getSlideNumber(e = this.Reveal.getCurrentSlide()) {
    ...
    if ('function' == typeof i.slideNumber) t = i.slideNumber(e)
      ...
      'string' == typeof i.slideNumber && (a = i.slideNumber),
        /c/.test(a) || 1 !== this.Reveal.getHorizontalSlides().length || (a = 'c')
...
const A = e => {
  ...
  return n ? { r: parseInt(n[1], 10), g: parseInt(n[2], 10), b: parseInt(n[3], 10), a: parseFloat(n[4]) } : null
}
class E {
  constructor(e) {
    this.Reveal = e
  ...
  sync(e) {
    ...
    e.classList.remove('has-dark-background'),
      ...
      (i.innerHTML = ''),
      a.background &&
        (/^(http|file|\/\/)/gi.test(a.background) || /\.(svg|png|jpg|jpeg|gif|bmp)([?#\s]|$)/gi.test(a.background)
          ? e.setAttribute('data-background-image', a.background)
          : (t.style.background = a.background)),
      (a.background || a.backgroundColor || a.backgroundImage || a.backgroundVideo || a.backgroundIframe) &&
        t.setAttribute(
      ...
      a.backgroundPosition && (i.style.backgroundPosition = a.backgroundPosition),
    ...
    if (
      (Array.from(this.element.childNodes).forEach((i, o) => {
        i.classList.remove('past', 'present', 'future'),
          o < a.h ? i.classList.add(s) : o > a.h ? i.classList.add(r) : (i.classList.add('present'), (n = i)),
          (e || o === a.h) &&
...
class C {
  ...
  run(e, t) {
    ...
    if (
      ...
      let s = this.getAutoAnimatableElements(e, t).map(e =>
  ...
  getAutoAnimateOptions(t, i) {
    ...
    return (
      ...
      t.dataset.autoAnimateDuration && (a.duration = parseFloat(t.dataset.autoAnimateDuration)),
      t.dataset.autoAnimateDelay && (a.delay = parseFloat(t.dataset.autoAnimateDelay)),
      a
    )
  }
  ...
  getAutoAnimatePairs(e, t) {
    ...
    return (
      ...
      this.findAutoAnimateMatches(i, e, t, a, e => e.nodeName + ':::' + e.innerText),
      ...
      Array.from(t).forEach((t, a) => {
        if (
          ...
          t.classList.add('visible'),
            ...
            n || (i.shown.push(t), this.Reveal.dispatchEvent({ target: t, type: 'visible', bubbles: !1 }))
        } else {
  ...
  goto(e, t = 0) {
    ...
    if (i && this.Reveal.getConfig().fragments) {
      ...
      if (a.length) {
        ...
        return (
          n.hidden.length &&
            this.Reveal.dispatchEvent({ type: 'fragmenthidden', data: { fragment: n.hidden[0], fragments: n.hidden } }),
          n.shown.length &&
            this.Reveal.dispatchEvent({ type: 'fragmentshown', data: { fragment: n.shown[0], fragments: n.shown } }),
...
class N {
  ...
  activate() {
    if (this.Reveal.getConfig().overview && !this.isActive()) {
      ...
      this.Reveal.dispatchEvent({
        type: 'overviewshown',
        data: { indexh: a.h, indexv: a.v, currentSlide: this.Reveal.getCurrentSlide() },
      })
    }
  }
  layout() {
    ...
    !1 === h &&
      ...
      80 === i || 33 === i
        ...
        ? (this.Reveal.overview.isActive() && this.Reveal.overview.deactivate(),
          e.shiftKey ? this.Reveal.prev({ skipFragments: e.altKey }) : this.Reveal.next({ skipFragments: e.altKey }))
...
class D {
  ...
  getIndicesFromHash(e = window.location.hash) {
    ...
    if (/^[0-9]*$/.test(i[0]) || !t.length) {
      ...
      return e.fragmentInURL && ((t = parseInt(i[2], 10)), isNaN(t) && (t = void 0)), { h: n, v: s, f: t }
    }
    {
      let e, i
      ;/\/[-\d]+$/g.test(t) &&
  ...
  getHash(e) {
    ...
    if ((this.Reveal.getConfig().fragmentInURL || (n.f = void 0), 'string' == typeof a && a.length))
      (t = '/' + a), n.f >= 0 && (t += '/' + n.f)
    else {
    ...
    i.forEach(function (i, n) {
      if (!1 === i.classList.contains('stack')) {
        ...
        if (a) {
          ...
          t.classList.add('slide-number'), t.classList.add('slide-number-pdf'), (t.innerHTML = e), m.appendChild(t)
        }
...
class W {
  ...
  render() {
    ...
    this.context.save(),
      ...
      this.playing
        ? ((this.context.fillStyle = '#fff'), this.context.fillRect(0, 0, 10, n), this.context.fillRect(18, 0, 10, n))
        : (this.context.beginPath(),
...
function V(s, l) {
  arguments.length < 2 && ((l = arguments[0]), (s = document.querySelector('.reveal')))
  const h = {}
  let u,
    g,
    p,
  ...
  function ue(e) {
    ...
    if (((V.wrapper = s), (V.slides = s.querySelector('.slides')), !V.slides))
      throw 'Unable to find slides container (<div class="slides">).'
    return (
      (y = { ...K, ...y, ...l, ...e, ...d() }),
      ge(),
      window.addEventListener('load', Fe, !1),
  ...
  function ge() {
    !0 === y.embedded
      ? (V.viewport = r(s, '.reveal-viewport') || s)
    ...
    ;(w = !0),
      ...
      setTimeout(() => {
        V.slides.classList.remove('no-transition'),
          ...
          Ce({ type: 'ready', data: { indexh: u, indexv: g, currentSlide: m } })
      }, 1),
      le.isPrintingPDF() &&
        (Ee(),
  ...
  function Se(t) {
    ...
    V.wrapper.classList.remove(a.transition),
      ...
      n > 1 &&
        ...
        ((b = new W(V.wrapper, () => Math.min(Math.max((Date.now() - Y) / j, 0), 1))), b.on('click', Ft), (_ = !1)),
  ...
  function Ae() {
    window.addEventListener('resize', It, !1),
      ...
      y.keyboard && ie.bind(),
      y.progress && se.bind(),
      y.respondToHashChanges && ae.bind(),
      ne.bind(),
      de.bind(),
      V.slides.addEventListener('click', Dt, !1),
      V.slides.addEventListener('transitionend', Mt, !1),
      V.pauseOverlay.addEventListener('click', je, !1),
      y.focusBodyOnPageVisibilityChange && document.addEventListener('visibilitychange', Tt, !1)
  }
  function Ee() {
    ce.unbind(),
      de.unbind(),
      ...
      V.slides.removeEventListener('click', Dt, !1),
      V.slides.removeEventListener('transitionend', Mt, !1),
      V.pauseOverlay.removeEventListener('click', je, !1)
  }
  function ke(e, t, i) {
  ...
  function xe(e) {
    'string' == typeof e.layout && (F.layout = e.layout),
      ...
      F.layout ? n(V.slides, F.layout + ' ' + F.overview) : n(V.slides, F.overview)
  }
  function Ce({ target: t = V.wrapper, type: i, data: a, bubbles: n = !0 }) {
    let s = document.createEvent('HTMLEvents', 1, 2)
    return s.initEvent(i, n, !0), e(s, a), t.dispatchEvent(s), t === V.wrapper && Pe(i), s
  }
  function Pe(t, i) {
    if (y.postMessageEvents && window.parent !== window.self) {
      let a = { namespace: 'reveal', eventName: t, state: bt() }
      e(a, i), window.parent.postMessage(JSON.stringify(a), '*')
    }
  }
  function Ne(e = 'a') {
    Array.from(V.wrapper.querySelectorAll(e)).forEach(e => {
      ;/^(http|www)/gi.test(e.getAttribute('href')) && e.addEventListener('click', zt, !1)
    })
  }
  function Me(e = 'a') {
    Array.from(V.wrapper.querySelectorAll(e)).forEach(e => {
      ;/^(http|www)/gi.test(e.getAttribute('href')) && e.removeEventListener('click', zt, !1)
    })
  }
  function De(e) {
    ze(),
  ...
  function Ie(e) {
    'boolean' == typeof e ? (e ? Te() : ze()) : V.overlay ? ze() : Te()
  }
  function Te() {
    if (y.help) {
      ze(),
    ...
    if (V.wrapper && !le.isPrintingPDF()) {
      if (!y.disableLayout) {
        ...
        He(y.width, y.height),
          ...
          (x = Math.min(e.presentationWidth / e.width, e.presentationHeight / e.height)),
          (x = Math.max(x, y.minScale)),
          (x = Math.min(x, y.maxScale)),
          1 === x
            ? ((V.slides.style.zoom = ''),
              (V.slides.style.left = ''),
              (V.slides.style.top = ''),
              ...
              xe({ layout: '' }))
            : x > 1 && f && window.devicePixelRatio < 2
            ? ((V.slides.style.zoom = x),
              (V.slides.style.left = ''),
              (V.slides.style.top = ''),
              (V.slides.style.bottom = ''),
              (V.slides.style.right = ''),
        ...
        for (let t = 0, a = i.length; t < a; t++) {
          ...
          'none' !== a.style.display &&
            (y.center || a.classList.contains('center')
              ? a.classList.contains('stack')
                ? (a.style.top = 0)
                : (a.style.top = Math.max((e.height - a.scrollHeight) / 2, 0) + 'px')
              : (a.style.top = ''))
        }
        t !== x && Ce({ type: 'resize', data: { oldScale: t, scale: x, size: e } })
      }
  ...
  function $e() {
    if (y.pause) {
      ...
      Rt(), V.wrapper.classList.add('paused'), !1 === e && Ce({ type: 'paused' })
    }
  }
  function je() {
    const e = V.wrapper.classList.contains('paused')
    V.wrapper.classList.remove('paused'), wt(), e && Ce({ type: 'resumed' })
  }
  function Xe(e) {
    'boolean' == typeof e ? (e ? $e() : je()) : Ye() ? je() : $e()
  }
  function Ye() {
    return V.wrapper.classList.contains('paused')
  }
  function _e(e) {
    'boolean' == typeof e ? (e ? At() : St()) : _ ? At() : St()
  }
  function Je() {
    return !(!j || _)
  }
  function Qe(e, t, i, a) {
    if (
      Ce({ type: 'beforeslidechange', data: { indexh: void 0 === e ? u : e, indexv: void 0 === t ? g : t, origin: a } })
        .defaultPrevented
    )
      return
    p = m
    const n = V.wrapper.querySelectorAll('.slides>section')
    if (0 === n.length) return
    void 0 !== t || te.isActive() || (t = Ue(n[e])),
      p && p.parentNode && p.parentNode.classList.contains('stack') && Be(p.parentNode, g)
    const s = L.concat()
    L.length = 0
    let r = u || 0,
      o = g || 0
    ;(u = it('.slides>section', void 0 === e ? u : e)),
      (g = it('.slides>section.present>section', void 0 === t ? g : t))
    let l = u !== r || g !== o
    l || (p = null)
    let d = n[u],
    ...
    e: for (let e = 0, t = L.length; e < t; e++) {
      ...
      V.viewport.classList.add(L[e]), Ce({ type: L[e] })
    }
    for (; s.length; ) V.viewport.classList.remove(s.pop())
    l && Ce({ type: 'slidechanged', data: { indexh: u, indexv: g, previousSlide: p, currentSlide: m, origin: a } }),
  ...
  function it(e, i) {
    let a = t(V.wrapper, e),
      ...
      s = le.isPrintingPDF()
    if (n) {
      y.loop && (i %= n) < 0 && (i = n + i), (i = Math.max(Math.min(i, n - 1), 0))
      for (let e = 0; e < n; e++) {
        let n = a[e],
          r = y.rtl && !Oe(n)
        n.classList.remove('past'),
          ...
          s
            ...
            : e < i
            ? (n.classList.add(r ? 'future' : 'past'),
              y.fragments &&
                t(n, '.fragment').forEach(e => {
                  e.classList.add('visible'), e.classList.remove('current-fragment')
                }))
            : e > i &&
              (n.classList.add(r ? 'past' : 'future'),
              y.fragments &&
                t(n, '.fragment.visible').forEach(e => {
                  e.classList.remove('visible', 'current-fragment')
                }))
      }
      let e = a[i],
      ...
      e.classList.add('present'),
        ...
        r || Ce({ target: e, type: 'visible', bubbles: !1 })
  ...
  function at() {
    ...
    if (n && void 0 !== u) {
      ...
      v && (s = te.isActive() ? 6 : y.mobileViewDistance), le.isPrintingPDF() && (s = Number.MAX_VALUE)
      for (let r = 0; r < n; r++) {
        let o = a[r],
          l = t(o, 'section'),
          d = l.length
        if (
          ((e = Math.abs((u || 0) - r) || 0),
          y.loop && (e = Math.abs(((u || 0) - r) % (n - s)) || 0),
          e < s ? J.load(o) : J.unload(o),
          d)
        ) {
          let t = Ue(o)
          for (let a = 0; a < d; a++) {
            let n = l[a]
            ;(i = r === (u || 0) ? Math.abs((g || 0) - a) : Math.abs(a - t)), e + i < s ? J.load(n) : J.unload(n)
          }
        }
      }
      gt() ? V.wrapper.classList.add('has-vertical-slides') : V.wrapper.classList.remove('has-vertical-slides'),
        ut() ? V.wrapper.classList.add('has-horizontal-slides') : V.wrapper.classList.remove('has-horizontal-slides')
    }
  }
  function nt({ includeFragments: e = !1 } = {}) {
    let t = V.wrapper.querySelectorAll('.slides>section'),
      i = V.wrapper.querySelectorAll('.slides>section.present>section'),
      a = { left: u > 0, right: u < t.length - 1, up: g > 0, down: g < i.length - 1 }
    if (
      (y.loop && (t.length > 1 && ((a.left = !0), (a.right = !0)), i.length > 1 && ((a.up = !0), (a.down = !0))),
      t.length > 1 && 'linear' === y.navigationMode && ((a.right = a.right || a.down), (a.left = a.left || a.up)),
      !0 === e)
    ) {
  ...
  function ot(e) {
    ...
    if (e) {
      let i = Oe(e),
        s = i ? e.parentNode : e,
        r = dt()
      ;(a = Math.max(r.indexOf(s), 0)), (n = void 0), i && (n = Math.max(t(e.parentNode, 'section').indexOf(e), 0))
    }
    if (!e && m) {
  ...
  function bt() {
    let e = ot()
    return { indexh: e.h, indexv: e.v, indexf: e.f, paused: Ye(), overview: te.isActive() }
  }
  function yt(e) {
    if ('object' == typeof e) {
    ...
    if ((Rt(), m && !1 !== y.autoSlide)) {
      ...
      i
        ...
        !j ||
          ...
          Ye() ||
          te.isActive() ||
          (Ve() && !ee.availableRoutes().next && !0 !== y.loop) ||
          ((X = setTimeout(() => {
  ...
  function St() {
    j && !_ && ((_ = !0), Ce({ type: 'autoslidepaused' }), clearTimeout(X), b && b.setPlaying(!1))
  }
  function At() {
    j && _ && ((_ = !1), Ce({ type: 'autoslideresumed' }), wt())
  }
  function Et({ skipFragments: e = !1 } = {}) {
    ;(A.hasNavigatedHorizontally = !0),
      y.rtl
        ? (te.isActive() || e || !1 === ee.next()) && nt().left && Qe(u + 1, 'grid' === y.navigationMode ? g : void 0)
        : (te.isActive() || e || !1 === ee.prev()) && nt().left && Qe(u - 1, 'grid' === y.navigationMode ? g : void 0)
  }
  function kt({ skipFragments: e = !1 } = {}) {
    ;(A.hasNavigatedHorizontally = !0),
      y.rtl
        ? (te.isActive() || e || !1 === ee.prev()) && nt().right && Qe(u - 1, 'grid' === y.navigationMode ? g : void 0)
        : (te.isActive() || e || !1 === ee.next()) && nt().right && Qe(u + 1, 'grid' === y.navigationMode ? g : void 0)
  }
  function Lt({ skipFragments: e = !1 } = {}) {
    ;(te.isActive() || e || !1 === ee.prev()) && nt().up && Qe(u, g - 1)
  }
  function xt({ skipFragments: e = !1 } = {}) {
    ;(A.hasNavigatedVertically = !0), (te.isActive() || e || !1 === ee.next()) && nt().down && Qe(u, g + 1)
  }
  function Ct({ skipFragments: e = !1 } = {}) {
    if (e || !1 === ee.prev())
      if (nt().up) Lt({ skipFragments: e })
      else {
        let i
        if (
          ((i = y.rtl ? t(V.wrapper, '.slides>section.future').pop() : t(V.wrapper, '.slides>section.past').pop()),
          i && i.classList.contains('stack'))
        ) {
          let e = i.querySelectorAll('section').length - 1 || void 0
          Qe(u - 1, e)
        } else Et({ skipFragments: e })
      }
  }
  function Pt({ skipFragments: e = !1 } = {}) {
    if (((A.hasNavigatedHorizontally = !0), (A.hasNavigatedVertically = !0), e || !1 === ee.next())) {
      let t = nt()
      t.down && t.right && y.loop && We() && (t.down = !1),
        t.down ? xt({ skipFragments: e }) : y.rtl ? Et({ skipFragments: e }) : kt({ skipFragments: e })
    }
  }
  function Nt(e) {
    y.autoSlideStoppable && St()
  }
  function Mt(e) {
    'running' === $ &&
      /section/gi.test(e.target.nodeName) &&
      (($ = 'idle'),
      Ce({ type: 'slidetransitionend', data: { indexh: u, indexv: g, previousSlide: p, currentSlide: m } }))
  }
  function Dt(e) {
    const t = r(e.target, 'a[href^="#"]')
    if (t) {
      const i = t.getAttribute('href'),
        a = ae.getIndicesFromHash(i)
