...
!(function (e, t) {
  ...
  var D,
    ...
    H = O.inspectSource,
    F = r.WeakMap,
    U = 'function' == typeof F && /native code/.test(H(F)),
    B = n(function (e) {
  ...
  var ee,
    ...
    ie = n(function (e) {
      ...
      ;(e.exports = function (e, t, a, o) {
        var s = !!o && !!o.unsafe,
          ...
          u = !!o && !!o.noTargetGet
        'function' == typeof a &&
          ('string' != typeof t || w(a, 'name') || N(a, 'name', t),
          (n(a).source = i.join('string' == typeof t ? t : ''))),
          e !== r ? (s ? !u && e[t] && (l = !0) : delete e[t], l ? (e[t] = a) : N(e, t, a)) : l ? (e[t] = a) : M(t, a)
    ...
    Oe = function (e, t) {
      var n,
        ...
        u = e.global,
        c = e.stat
      if ((n = u ? r : c ? r[l] || M(l, {}) : (r[l] || {}).prototype))
        for (i in t) {
          if (
            ((o = t[i]),
            (a = e.noTargetGet ? (s = Ie(n, i)) && s.value : n[i]),
            !Me(u ? i : l + (c ? '.' : '#') + i, e.forced) && void 0 !== a)
          ) {
    ...
    Fe = B('wks'),
    Ue = r.Symbol,
    Be = He ? Ue : (Ue && Ue.withoutSetter) || _,
    qe = function (e) {
    ...
    _e = function (e, t) {
      ...
      return (
        Te(e) &&
          ('function' != typeof (n = e.constructor) || (n !== Array && !Te(n.prototype))
            ? m(n) && null === (n = n[We]) && (n = void 0)
            : (n = void 0)),
        new (void 0 === n ? Array : n)(0 === t ? 0 : t)
      )
    },
    Ve = oe('navigator', 'userAgent') || '',
    Ke = r.process,
    $e = Ke && Ke.versions,
    Xe = $e && $e.v8
  Xe
    ? (te = (ee = Xe.split('.'))[0] + ee[1])
    : Ve && (!(ee = Ve.match(/Edge\/(\d+)/)) || ee[1] >= 74) && (ee = Ve.match(/Chrome\/(\d+)/)) && (te = ee[1])
  var Ye = te && +te,
    Ge = qe('species'),
    Je = function (e) {
      return (
  ...
  Oe(
    { target: 'Array', proto: !0, forced: !tt || !nt },
    {
      concat: function (e) {
        var t,
          n,
  ...
  var rt = function (e) {
      ...
      return function (s, l, u, c) {
        for (
          var d,
            ...
            y = 0,
            b = c || _e,
            w = t ? b(s, m) : n ? b(s, 0) : void 0;
          m > y;
          y++
        )
          if ((o || y in g) && ((h = p((d = g[y]), y, f)), e))
            if (t) w[y] = h
            else if (h)
              switch (e) {
                case 3:
    ...
    lt = { forEach: st(0), map: st(1), filter: st(2), some: st(3), every: st(4), find: st(5), findIndex: st(6) },
    ut = function (e, t) {
      var n = [][e]
      return (
        !!n &&
    ...
    ft = function (e, t) {
      ...
      return (dt[e] =
        ...
        !a(function () {
          if (i && !o) return !0
          var e = { length: -1 }
          i ? ct(e, 1, { enumerable: !0, get: ht }) : (e[1] = 1), n.call(e, r, s)
        }))
    },
    vt = lt.forEach,
    gt = ut('forEach'),
  ...
  Oe({ target: 'Array', proto: !0, forced: [].forEach != mt }, { forEach: mt })
  var yt = lt.map,
    bt = Je('map'),
    wt = ft('map')
  Oe(
  ...
  var St =
    ...
    At =
      ...
      a(function () {
        ...
        ? function (e, t) {
            for (var n = De(e), i = arguments.length, r = 1, a = Ee.f, s = u.f; i > r; )
              for (var l, c = v(arguments[r++]), d = a ? St(c).concat(a(c)) : St(c), h = d.length, f = 0; h > f; )
                (l = d[f++]), (o && !s.call(c, l)) || (n[l] = c[l])
            return n
          }
        : Et
  Oe({ target: 'Object', stat: !0, forced: Object.assign !== At }, { assign: At })
  var Rt,
    xt = o
  ...
  var It =
      ...
      function (e, t) {
        var n
        return (
          null !== e ? ((Pt.prototype = L(e)), (n = new Pt()), (Pt.prototype = null), (n[Ct] = e)) : (n = Mt()),
          void 0 === t ? n : xt(n, t)
        )
      },
    Ot = Se.f,
    ...
    jt = {
      f: function (e) {
        return Dt && '[object Window]' == Tt.call(e)
          ? (function (e) {
              try {
                return Ot(e)
              } catch (e) {
    ...
    Ut = qe('toStringTag'),
    Bt = function (e, t, n) {
      e && !w((e = n ? e : e.prototype), Ut) && Ft(e, Ut, { configurable: !0, value: t })
    },
    qt = lt.forEach,
    Wt = K('hidden'),
    _t = 'Symbol',
    ...
    tn = B('symbols'),
    nn = B('op-symbols'),
    rn = B('string-to-symbol-registry'),
    an = B('symbol-to-string-registry'),
    on = B('wks'),
    sn = r.QObject,
    ...
    cn = function (e, t) {
      ...
      return Kt(n, { type: _t, tag: e, description: t }), o || (n.description = t), n
    },
    dn = He
      ? function (e) {
    ...
    hn = function (e, t, n) {
      ...
      return (
        ...
        w(tn, i)
          ? (n.enumerable
              ? (w(e, Wt) && e[Wt][i] && (e[Wt][i] = !1), (n = It(n, { enumerable: c(0, !1) })))
              : (w(e, Wt) || Qt(e, Wt, c(1, {})), (e[Wt][i] = !0)),
            un(e, i, n))
          : Qt(e, i, n)
      )
    },
    ...
    vn = function (e) {
      var t = y(e, !0),
        n = en.call(this, t)
      return (
        !(this === Xt && w(tn, t) && !w(nn, t)) &&
        (!(n || !w(this, t) || !w(tn, t) || (w(this, Wt) && this[Wt][t])) || n)
      )
    },
    gn = function (e, t) {
      var n = p(e),
  ...
  if (
    (ze ||
      (ie(
        (Yt = function () {
          ...
          return o && ln && un(Xt, t, { configurable: !0, set: n }), cn(t, e)
        }).prototype,
        'toString',
        function () {
          return $t(this).tag
      ...
      o &&
        (Qt(Yt.prototype, 'description', {
          configurable: !0,
          get: function () {
            return $t(this).description
          },
        }),
        ie(Xt, 'propertyIsEnumerable', vn, { unsafe: !0 }))),
    Oe({ global: !0, wrap: !0, forced: !ze, sham: !ze }, { Symbol: Yt }),
    qt(St(on), function (e) {
      !(function (e) {
        var t = re.Symbol || (re.Symbol = {})
        w(t, e) || Ht(t, e, { value: zt.f(e) })
      })(e)
    }),
    Oe(
      { target: _t, stat: !0, forced: !ze },
      {
        for: function (e) {
          var t = String(e)
    ...
    Oe(
      { target: 'Object', stat: !0, forced: !ze, sham: !o },
      {
        create: function (e, t) {
    ...
    Oe({ target: 'Object', stat: !0, forced: !ze }, { getOwnPropertyNames: pn, getOwnPropertySymbols: mn }),
    Oe(
      {
        target: 'Object',
        stat: !0,
    ...
    var yn =
      ...
      a(function () {
        var e = Yt()
        return '[null]' != Gt([e]) || '{}' != Gt({ a: e }) || '{}' != Gt(Object(e))
      })
    Oe(
      { target: 'JSON', stat: !0, forced: yn },
      {
        stringify: function (e, t, n) {
          for (var i, r = [e], a = 1; arguments.length > a; ) r.push(arguments[a++])
          if (((i = t), (m(t) || void 0 !== e) && !dn(e)))
            return (
              Te(t) ||
                (t = function (e, t) {
  ...
  if (o && 'function' == typeof wn && (!('description' in wn.prototype) || void 0 !== wn().description)) {
    var Sn = {},
      En = function () {
        var e = arguments.length < 1 || void 0 === arguments[0] ? void 0 : String(arguments[0]),
          t = this instanceof En ? new wn(e) : void 0 === e ? wn() : wn(e)
        return '' === e && (Sn[t] = !0), t
      }
    Ae(En, wn)
    ...
    bn(kn, 'description', {
      ...
      Oe({ global: !0, forced: !0 }, { Symbol: En })
  }
    ...
    { target: 'Array', stat: !0, forced: _n },
    {
      from: function (e) {
        var t,
          ...
          h = Hn(s),
          f = 0
        if ((d && (c = at(c, u > 2 ? arguments[2] : void 0, 2)), null == h || (l == Array && Mn(h))))
          for (n = new l((t = de(s.length))); t > f; f++) (o = d ? c(s[f], f) : s[f]), je(n, f, o)
        else
          for (a = (r = h.call(s)).next, n = new l(); !(i = a.call(r)).done; f++)
            (o = d ? Ln(r, c, [i.value, f], !0) : i.value), je(n, f, o)
        return (n.length = f), n
      },
    }
  )
  var Vn = pe.indexOf,
    Kn = [].indexOf,
    $n = !!Kn && 1 / [1].indexOf(1, -0) < 0,
    Xn = ut('indexOf'),
    Yn = ft('indexOf', { ACCESSORS: !0, 1: 0 })
  Oe(
    { target: 'Array', proto: !0, forced: $n || !Xn || !Yn },
    {
      indexOf: function (e) {
  ...
  var Gn = Je('splice'),
    Jn = ft('splice', { ACCESSORS: !0, 0: 0, 1: 2 }),
    Qn = Math.max,
    Zn = Math.min,
    ei = 9007199254740991,
    ti = 'Maximum allowed length exceeded'
  Oe(
    { target: 'Array', proto: !0, forced: !Gn || !Jn },
    {
      splice: function (e, t) {
        var n,
          i,
          ...
          d = arguments.length
        if (
          (0 === d ? (n = i = 0) : 1 === d ? ((n = 0), (i = u - c)) : ((n = d - 2), (i = Zn(Qn(ue(t), 0), u - c))),
          u + n - i > ei)
        )
          throw TypeError(ti)
  ...
  var si =
    ...
    vi = { start: fi(1), end: fi(2), trim: fi(3) },
    gi = Se.f,
    pi = x.f,
    mi = P.f,
    yi = vi.trim,
    ...
    ki = function (e) {
      ...
      if ('string' == typeof u && u.length > 2)
        if (43 === (t = (u = yi(u)).charCodeAt(0)) || 45 === t) {
  ...
  if (Me(bi, !wi(' 0o1') || !wi('0b1') || wi('+0x1'))) {
    for (
      ...
      w(wi, (Ai = xi[Li])) && !w(Ri, Ai) && mi(Ri, Ai, pi(wi, Ai))
  ...
  On || ie(Object.prototype, 'toString', Ci, { unsafe: !0 })
  var Pi,
    Ni,
    Mi,
    Ii = r.Promise,
    ...
    Ti = n(function (e) {
      ...
      ;(e.exports = function (e, n, i, r, a) {
        ...
        if (a) o = e
          ...
          if (Mn(s)) {
            for (l = 0, u = de(e.length); u > l; l++)
              if ((c = r ? f(L((h = e[l]))[0], h[1]) : f(e[l])) && c instanceof t) return c
            return new t(!1)
          }
          o = s.call(e)
        }
        for (d = o.next; !(h = d.call(o)).done; )
          if ('object' == typeof (c = Ln(o, f, h.value, r)) && c && c instanceof t) return c
        return new t(!1)
      }).stop = function (e) {
        return new t(!0, e)
      }
    ...
    zi = /(iphone|ipod|ipad).*applewebkit/i.test(Ve),
    Hi = r.location,
    Fi = r.setImmediate,
    Ui = r.clearImmediate,
    Bi = r.process,
  ...
  ;(Fi && Ui) ||
    ...
    'process' == h(Bi)
      ...
      : qi && !zi
      ? ((Mi = (Ni = new qi()).port2), (Ni.port1.onmessage = Yi), (Pi = at(Mi.postMessage, Mi, 1)))
      : !r.addEventListener || 'function' != typeof postMessage || r.importScripts || a(Gi) || 'file:' === Hi.protocol
      ? (Pi =
          Ki in k('script')
            ? function (e) {
  ...
  var Ji,
    ...
    or = x.f,
    sr = ar.set,
    lr = r.MutationObserver || r.WebKitMutationObserver,
    ur = r.process,
    cr = r.Promise,
    dr = 'process' == h(ur),
    hr = or(r, 'queueMicrotask'),
    fr = hr && hr.value
  fr ||
    ((Ji = function () {
      var e, t
    ...
    dr
      ...
      : lr && !zi
      ? ((tr = !0),
        (nr = document.createTextNode('')),
        new lr(Ji).observe(nr, { characterData: !0 }),
        (er = function () {
          nr.data = tr = !tr
        }))
      : cr && cr.resolve
      ? ((ir = cr.resolve(void 0)),
        (rr = ir.then),
        (er = function () {
          rr.call(ir, Ji)
        }))
  ...
  var vr,
    ...
    Dr = Tr,
    jr = 'process' == h(Ir),
    zr = !!(Mr && Mr.createEvent && r.dispatchEvent),
      ...
      if (!t.notified) {
        ...
        yr(function () {
          for (var r = t.value, a = 1 == t.state, o = 0; i.length > o; ) {
            ...
            try {
              d
                ? (a || (2 === t.rejection && Kr(e, t), (t.rejection = 1)),
                  !0 === d ? (s = r) : (v && v.enter(), (s = d(r)), v && (v.exit(), (u = !0))),
                  s === c.promise ? f(Nr('Promise-chain cycle')) : (l = Br(s)) ? l.call(s, h, f) : h(s))
                : f(r)
            } catch (e) {
              v && !u && v.exit(), f(e)
            }
    ...
    Wr = function (e, t, n) {
      var i, a
      zr
        ? (((i = Mr.createEvent('Event')).promise = t), (i.reason = n), i.initEvent(e, !1, !0), r.dispatchEvent(i))
  ...
  Fr &&
    ...
    ((vr = function (e) {
      Lr(this, { type: Rr, done: !1, notified: !1, parent: !1, reactions: [], rejection: !1, state: 0, value: void 0 })
      ...
      then: function (e, t) {
        ...
        return (
          ...
          (i.domain = jr ? Ir.domain : void 0),
          (n.parent = !0),
          n.reactions.push(i),
          0 != n.state && qr(this, n, !1),
          i.promise
        )
      },
      catch: function (e) {
    ...
    Oe({ global: !0, wrap: !0, forced: Fr }, { Promise: Pr }),
    Bt(Pr, Rr, !1),
    (function (e) {
      var t = oe(e),
        n = P.f
  ...
  var Qr,
    ...
    ta = RegExp.prototype.exec,
    na = String.prototype.replace,
    ia = ta,
    ra = ((Qr = /a/), (Zr = /b*/g), ta.call(Qr, 'a'), ta.call(Zr, 'a'), 0 !== Qr.lastIndex || 0 !== Zr.lastIndex),
    aa = ea.UNSUPPORTED_Y || ea.BROKEN_CARET,
    oa = void 0 !== /()??/.exec('')[1]
  ;(ra || oa || aa) &&
    (ia = function (e) {
      var t,
      ...
      return (
        ...
        o
          ? i
            ...
            : (a.lastIndex = 0)
          : ra && i && (a.lastIndex = a.global ? i.index + i[0].length : t),
        oa &&
          i &&
          i.length > 1 &&
          na.call(i[0], n, function () {
  ...
  var sa = ia
  Oe({ target: 'RegExp', proto: !0, forced: /./.exec !== sa }, { exec: sa })
  var la,
    ua,
    ca,
    da = function (e) {
    ...
    ma = qe('iterator'),
    ya = !1
  ;[].keys && ('next' in (ca = [].keys()) ? (ua = pa(pa(ca))) !== Object.prototype && (la = ua) : (ya = !0)),
    null == la && (la = {}),
    w(la, ma) ||
      N(la, ma, function () {
        return this
      })
  var ba = { IteratorPrototype: la, BUGGY_SAFARI_ITERATORS: ya },
    wa = ba.IteratorPrototype,
    Sa = function () {
      return this
    },
    Ea = ba.IteratorPrototype,
    ka = ba.BUGGY_SAFARI_ITERATORS,
    Aa = qe('iterator'),
    Ra = 'keys',
    xa = 'values',
    La = 'entries',
  ...
  !(function (e, t, n, i, r, a, o) {
    !(function (e, t, n) {
      var i = t + ' Iterator'
      ;(e.prototype = It(wa, { next: c(1, n) })), Bt(e, i, !1), (Cn[i] = Sa)
    })(n, t, i)
    var s,
      l,
      u,
    ...
    if (
      (m &&
        ...
        Ea !== Object.prototype &&
          s.next &&
          (pa(s) !== Ea && (si ? si(s, Ea) : 'function' != typeof s[Aa] && N(s, Aa, Ca)), Bt(s, h, !0))),
      r == xa &&
        g &&
        g.name !== xa &&
        ((f = !0),
      ...
      if (((l = { values: d(xa), keys: a ? p : d(Ra), entries: d(La) }), o))
        for (u in l) (ka || f || !(u in v)) && ie(v, u, l[u])
      else Oe({ target: t, proto: !0, forced: ka || f }, l)
  })(
    String,
    'String',
    function (e) {
      Ma(this, { type: Na, string: String(e), index: 0 })
    },
    function () {
      var e,
        t = Ia(this),
      ...
      return i >= n.length
        ? { value: void 0, done: !0 }
        : ((e = Pa(n, i)), (t.index += e.length), { value: e, done: !1 })
    }
  )
  var Oa = qe('species'),
    Ta = !a(function () {
      ...
      if (!o || !s || ('replace' === e && (!Ta || !Da || za)) || ('split' === e && !Ha)) {
        var l = /./[r],
          u = n(
            ...
            { REPLACE_KEEPS_$0: Da, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: za }
          ),
          c = u[0],
          d = u[1]
        ie(String.prototype, e, c),
          ie(
            RegExp.prototype,
            r,
            2 == t
          ...
          ''.split(/.?/).length
            ? function (e, n) {
                ...
                for (
                  ...
                  !(
                    (l = v.lastIndex) > f &&
                    (c.push(a.slice(f, s.index)),
                    s.length > 1 && s.index < a.length && _a.apply(c, s.slice(1)),
                    (u = s[0].length),
                    (f = l),
                    c.length >= o)
                  );
                ...
                return (
                  f === a.length ? (!u && v.test('')) || c.push('') : c.push(a.slice(f)),
        ...
        [
          ...
          function (e, r) {
            ...
            var o = L(e),
              ...
              l = ji(o, RegExp),
              u = o.unicode,
              c = (o.ignoreCase ? 'i' : '') + (o.multiline ? 'm' : '') + (o.unicode ? 'u' : '') + ($a ? 'y' : 'g'),
              d = new l($a ? o : '^(?:' + o.source + ')', c),
              h = void 0 === r ? Ka : r >>> 0
            if (0 === h) return []
            ...
            for (var f = 0, v = 0, g = []; v < s.length; ) {
              d.lastIndex = $a ? v : 0
              var p,
                m = qa(d, $a ? s : s.slice(v))
              if (null === m || (p = Va(de(d.lastIndex + ($a ? 0 : v)), s.length)) === f) v = Ba(s, v, u)
              else {
  ...
  var lo = '.slides section',
    uo = '.slides>section',
    co = '.slides>section.present>section',
    ho = /registerPlugin|registerKeyboardShortcut|addKeyBinding|addEventListener/,
    fo = /fade-(down|up|right|left|out|in-then-out|in-then-semi-out)|semi-fade-out|current-visible|shrink|grow/,
    vo = Math.max,
    go = Math.min,
    po = Math.floor,
    mo = /\$([$&'`]|\d\d?|<[^>]*>)/g,
    ...
    return [
      ...
      function (e, i) {
        ...
        for (var p, m = '', y = 0, b = 0; b < v.length; b++) {
          g = v[b]
          for (var w = String(g[0]), S = vo(go(ue(g.index), c.length), 0), E = [], k = 1; k < g.length; k++)
            E.push(void 0 === (p = g[k]) ? p : String(p))
          var A = g.groups
          if (d) {
  ...
  var wo = function (e, t) {
    ...
    Mo = navigator.userAgent,
    Io = document.createElement('div'),
    Oo = /(iphone|ipod|ipad|android)/gi.test(Mo) || ('MacIntel' === navigator.platform && navigator.maxTouchPoints > 1),
    To = /chrome/i.test(Mo) && !/edge/i.test(Mo),
    Do = /android/gi.test(Mo),
    jo = 'zoom' in Io.style && !Oo && (To || /Version\/[\d\.]+.*Safari/.test(Mo)),
    zo = t(
      n(function (e, t) {
        ...
        t.default = (function (e) {
          if (e) {
            var t = function (e) {
                ...
                'requestAnimationFrame' in e
                  ? function () {
                      e.cancelAnimationFrame(l),
                        (l = e.requestAnimationFrame(function () {
                          return d(
                            s.filter(function (e) {
              ...
              g = function (t) {
                ...
                ;(t.currentFontSize = parseInt(n.getPropertyValue('font-size'), 10)),
              ...
              k = function (e) {
                e.observeMutations &&
                  ((e.observer = new MutationObserver(b(e, r))), e.observer.observe(e.element, e.observeMutations))
              },
              A = {
                minSize: 16,
                maxSize: 512,
          ...
          function C(e, t) {
            var i = n({}, A, t),
              r = e.map(function (e) {
                var t = n({}, i, { element: e, active: !0 })
                return (
                  (function (e) {
                    k(e), (e.newbie = !0), (e.dirty = !0), s.push(e)
                  })(t),
                  { element: e, fit: b(t, o), unfreeze: S(t), freeze: E(t), unsubscribe: w(t) }
                )
              })
            return u(), r
          }
      ...
      return (
        no(e, [
          ...
          },
          {
            ...
            value: function (e) {
              ...
              ;(e.style.display = this.Reveal.getConfig().display),
                So(e, 'img[data-src], video[data-src], audio[data-src], iframe[data-src]').forEach(function (e) {
                ...
                So(e, 'video, audio').forEach(function (e) {
                  ...
                  So(e, 'source[data-src]').forEach(function (e) {
                    ...
                    Oo && 'VIDEO' === e.tagName && e.setAttribute('playsinline', ''),
                    t > 0 && e.load()
                })
                ...
                if (!1 === i.hasAttribute('data-loaded')) {
                  ...
                  if (o) r.style.backgroundImage = 'url(' + encodeURI(o) + ')'
                    ...
                    l && c.setAttribute('loop', ''),
                      u && (c.muted = !0),
                      Oo && ((c.muted = !0), c.setAttribute('playsinline', '')),
          ...
          },
          {
            ...
            value: function (e) {
              ...
              t &&
                ...
                So(t, 'iframe[src]').forEach(function (e) {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              e &&
                ...
                (So(e, 'img[src$=".gif"]').forEach(function (e) {
                ...
                So(e, 'video, audio').forEach(function (e) {
                  if (!xo(e, '.fragment') || xo(e, '.fragment.visible')) {
                    ...
                    if (
                      ('boolean' != typeof n && (n = e.hasAttribute('data-autoplay') || !!xo(e, '.slide-background')),
                ...
                So(e, 'iframe[src]').forEach(function (e) {
                  ;(xo(e, '.fragment') && !xo(e, '.fragment.visible')) || t.startEmbeddedIframe({ target: e })
                }),
                So(e, 'iframe[data-src]').forEach(function (e) {
                  ;(xo(e, '.fragment') && !xo(e, '.fragment.visible')) ||
          ...
          },
          {
            ...
            value: function (e) {
              var t = !!xo(e.target, 'html'),
                n = !!xo(e.target, '.present')
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (t && t.contentWindow) {
                var n = !!xo(e.target, 'html'),
                  i = !!xo(e.target, '.present')
                if (n && i) {
                  var r = this.Reveal.getConfig().autoPlayMedia
                  'boolean' != typeof r && (r = t.hasAttribute('data-autoplay') || !!xo(t, '.slide-background')),
              ...
              if (
                (Array.from(this.element.childNodes).forEach(function (e, n) {
                  e.classList.remove('past', 'present', 'future'),
                    ...
                    (t || n === i.h) &&
                      So(e, '.slide-background').forEach(function (e, t) {
                        e.classList.remove('past', 'present', 'future'),
                          t < i.v
                ...
                c && c === u && r !== this.previousBackground && this.element.classList.add('no-transition'),
              ...
              if (this.Reveal.getConfig().parallaxBackgroundImage) {
                ...
                ;(u =
                  'number' == typeof this.Reveal.getConfig().parallaxBackgroundVertical
                    ...
                    : (n - d) / (h - 1)),
                  (c = h > 0 ? u * e.v : 0),
                  (this.element.style.backgroundPosition = o + 'px ' + -c + 'px')
              }
            },
          },
        ]),
    ...
    _o = ft('filter')
  Oe(
    { target: 'Array', proto: !0, forced: !Wo || !_o },
    {
      filter: function (e) {
  ...
  var Vo = [].join,
    ...
    $o = ut('join', ',')
  Oe(
    { target: 'Array', proto: !0, forced: Ko || !$o },
    {
      join: function (e) {
  ...
  var Xo = function (e) {
    ...
    Yo = { left: Xo(!1), right: Xo(!0) }.left,
    Go = ut('reduce'),
    Jo = ft('reduce', { 1: 0 })
  Oe(
    { target: 'Array', proto: !0, forced: !Go || !Jo },
    {
      reduce: function (e) {
  ...
  var Qo = Je('slice'),
    Zo = ft('slice', { ACCESSORS: !0, 0: 0, 1: 2 }),
    es = qe('species'),
    ts = [].slice,
    ns = Math.max
  Oe(
    { target: 'Array', proto: !0, forced: !Qo || !Zo },
    {
      slice: function (e, t) {
        ...
        if (
          Te(a) &&
          ('function' != typeof (n = a.constructor) || (n !== Array && !Te(n.prototype))
            ? m(n) && null === (n = n[es]) && (n = void 0)
            : (n = void 0),
          n === Array || void 0 === n)
        )
          return ts.call(a, s, l)
  ...
  Oe(
    { target: 'Object', stat: !0, forced: is },
    {
      keys: function (e) {
        return St(De(e))
      },
  ...
  var rs = 0,
      ...
      return (
        no(e, [
          ...
          },
          {
            key: 'reset',
            value: function () {
              So(this.Reveal.getRevealElement(), '[data-auto-animate]:not([data-auto-animate=""])').forEach(function (
                e
              ) {
            ...
            value: function (e, t, n, i, r) {
              ...
              t.classList.contains('fragment') &&
                ...
                e.classList.contains('fragment') &&
                  (e.className.match(fo) || [''])[0] === (t.className.match(fo) || [''])[0] &&
                  'forward' === i.slideDirection &&
                  t.classList.add('visible', 'disabled'))
              if (!1 !== n.translate || !1 !== n.scale) {
                var l = this.Reveal.getScale(),
                  u = { x: (o.x - s.x) / l, y: (o.y - s.y) / l, scaleX: o.width / s.width, scaleY: o.height / s.height }
                ...
                if (c || d) {
                  var h = []
                  c && h.push('translate('.concat(u.x, 'px, ').concat(u.y, 'px)')),
                    d && h.push('scale('.concat(u.scaleX, ', ').concat(u.scaleY, ')')),
          ...
          },
          {
            ...
            value: function (e, t) {
              var n = ('function' == typeof this.Reveal.getConfig().autoAnimateMatcher
                ...
                Array.from(t).forEach(function (t, r) {
                  if (
                    ...
                    t.classList.remove('visible'),
                      t.classList.remove('current-fragment'),
                      s && (i.hidden.push(t), n.Reveal.dispatchEvent({ target: t, type: 'hidden', bubbles: !1 }))
                  }
                }),
            ...
            value: function () {
              ...
              if (this.Reveal.getConfig().overview && !this.isActive()) {
                ;(this.active = !0),
                  ...
                  So(this.Reveal.getRevealElement(), lo).forEach(function (t) {
            ...
            value: function () {
              ...
              this.Reveal.getHorizontalSlides().forEach(function (t, n) {
                t.setAttribute('data-index-h', n),
                  Ao(t, 'translate3d(' + n * e.overviewSlideWidth + 'px, 0, 0)'),
                  t.classList.contains('stack') &&
                    So(t, 'section').forEach(function (t, i) {
                      t.setAttribute('data-index-h', n),
                        t.setAttribute('data-index-v', i),
                        Ao(t, 'translate3d(0, ' + i * e.overviewSlideHeight + 'px, 0)')
                    })
              }),
                Array.from(this.Reveal.getBackgroundsElement().childNodes).forEach(function (t, n) {
                  Ao(t, 'translate3d(' + n * e.overviewSlideWidth + 'px, 0, 0)'),
                    So(t, '.slide-background').forEach(function (t, n) {
                ...
                if ('object' === Za(t.keyboard))
                  for (d in t.keyboard)
                    if (parseInt(d, 10) === n) {
                      ...
                      'function' == typeof m
                        ? m.apply(null, [e])
                        : 'string' == typeof m && 'function' == typeof this.Reveal[m] && this.Reveal[m].call(),
                        (p = !0)
                    }
                if (!1 === p)
                  for (d in this.bindings)
                    if (parseInt(d, 10) === n) {
                      ...
                      'function' == typeof y
                        ? y.apply(null, [e])
                        : 'string' == typeof y && 'function' == typeof this.Reveal[y] && this.Reveal[y].call(),
                        (p = !0)
                    }
                !1 === p &&
                  ((p = !0),
                  80 === n || 33 === n
                    ...
                    : 70 === n
                    ? ((f = t.embedded ? this.Reveal.getViewportElement() : document.documentElement),
                      (v =
                        (f = f || document.documentElement).requestFullscreen ||
                        f.webkitRequestFullscreen ||
                        f.webkitRequestFullScreen ||
                        f.mozRequestFullScreen ||
                        f.msRequestFullscreen) && v.apply(f))
                    : 65 === n
          ...
          },
          {
            ...
            value: function () {
              ...
              if (!/^[0-9]*$/.test(r[0]) && a.length) {
                var o, s
                ;/\/[-\d]+$/g.test(a) &&
                  ((s = parseInt(a.split('/').pop(), 10)), (s = isNaN(s) ? void 0 : s), (a = a.split('/').shift()))
                try {
                ...
                var c,
                  d = e.hashOneBasedIndex ? 1 : 0,
                  h = parseInt(r[0], 10) - d || 0,
                  f = parseInt(r[1], 10) - d || 0
                e.fragmentInURL && ((c = parseInt(r[2], 10)), isNaN(c) && (c = void 0)),
                  (h === t.h && f === t.v && void 0 === c) || this.Reveal.slide(h, f, c)
              }
            },
          },
          {
        ...
        no(e, [
          {
            ...
            value: function () {
              ...
              ;(this.element = document.createElement('aside')),
                ...
                this.Reveal.getRevealElement().appendChild(this.element),
                (this.controlsLeft = So(t, '.navigate-left')),
                (this.controlsRight = So(t, '.navigate-right')),
                (this.controlsUp = So(t, '.navigate-up')),
                (this.controlsDown = So(t, '.navigate-down')),
                (this.controlsPrev = So(t, '.navigate-prev')),
                (this.controlsNext = So(t, '.navigate-next')),
          ...
          },
          {
            ...
            value: function () {
              ...
              ;[]
                .concat(
                  oo(this.controlsLeft),
                  oo(this.controlsRight),
                  oo(this.controlsUp),
                  oo(this.controlsDown),
                  oo(this.controlsPrev),
                  oo(this.controlsNext)
                )
                .forEach(function (e) {
    ...
    vs = function (e) {
      return function (t) {
        for (var n, i = p(t), r = St(i), a = r.length, s = 0, l = []; a > s; )
          (n = r[s++]), (o && !fs.call(i, n)) || l.push(e ? [n, i[n]] : i[n])
        return l
      }
    },
    gs = { entries: vs(!0), values: vs(!1) }.values
  Oe(
  ...
  var ps = function (e, t) {
        ...
        no(e, [
          {
            ...
            value: function () {
              var e = this.Reveal.getConfig(),
                ...
                r = t.width,
                a = t.height
              Co('@page{size:' + n + 'px ' + i + 'px; margin: 0px;}'),
                Co(
                ...
                this.Reveal.layoutSlideContents(r, a)
                ...
                So(this.Reveal.getRevealElement(), lo).forEach(function (t) {
                  if (!1 === t.classList.contains('stack')) {
                    var s = (n - r) / 2,
                      l = (i - a) / 2,
                      u = t.scrollHeight,
                      c = Math.max(Math.ceil(u / i), 1)
                    ;((1 === (c = Math.min(c, e.pdfMaxPagesPerSlide)) && e.center) || t.classList.contains('center')) &&
                      (l = Math.max((i - u) / 2, 0))
                    var d = document.createElement('div')
                    if (
                      ((d.className = 'pdf-page'),
                      (d.style.height = (i + e.pdfPageHeightOffset) * c + 'px'),
                      t.parentNode.insertBefore(d, t),
                      d.appendChild(t),
                      (t.style.left = s + 'px'),
                      (t.style.top = l + 'px'),
                      (t.style.width = r + 'px'),
                      t.slideBackgroundElement && d.insertBefore(t.slideBackgroundElement, t),
                      e.showNotes)
                    ) {
                      ...
                      if (h) {
                        ...
                        v.classList.add('speaker-notes'),
                          v.classList.add('speaker-notes-pdf'),
                          v.setAttribute('data-layout', f),
                          (v.innerHTML = h),
                          'separate-page' === f
                            ? d.parentNode.insertBefore(v, d.nextSibling)
                            : ((v.style.left = '8px'),
                              (v.style.bottom = '8px'),
                              (v.style.width = n - 16 + 'px'),
                              d.appendChild(v))
                      }
                    }
                    if (o) {
                      var g = document.createElement('div')
                      g.classList.add('slide-number'),
                        g.classList.add('slide-number-pdf'),
                        (g.innerHTML = t.getAttribute('data-slide-number')),
                        d.appendChild(g)
                    }
                    if (e.pdfSeparateFragments) {
                      var p,
                        m,
                        y = this.Reveal.fragments.sort(d.querySelectorAll('.fragment'), !0)
                      ...
                      So(d, '.fragment:not(.fade-out)').forEach(function (e) {
        ...
        no(e, [
          ...
          },
          {
            ...
            value: function (e) {
              if (this.isSwipePrevented(e.target)) return !0
              var t = this.Reveal.getConfig()
              if (this.touchCaptured) Do && e.preventDefault()
              else {
                this.Reveal.onUserInput(e)
    ...
    As = qe('unscopables'),
    Rs = Array.prototype
  null == Rs[As] && P.f(Rs, As, { configurable: !0, value: It(null) })
  Oe(
  ...
  function Ps(e, t) {
    ...
    function j(n) {
      return (
        ...
        (l = ao(ao(ao(ao(ao({}, Ls), l), t), n), Po())),
        z(),
        window.addEventListener('load', oe, !1),
        M.load(l.plugins, l.dependencies).then(H),
        new Promise(function (e) {
          return s.on('ready', e)
        })
      )
    ...
    function z() {
      !0 === l.embedded
        ? (v.viewport = xo(e, '.reveal-viewport') || e)
    ...
    function F() {
      l.showHiddenSlides ||
        So(v.wrapper, 'section[data-visibility="hidden"]').forEach(function (e) {
          e.parentNode.removeChild(e)
        })
    }
    function U() {
      v.slides.classList.add('no-transition'),
        Oo ? v.wrapper.classList.add('no-hover') : v.wrapper.classList.remove('no-hover'),
        k.render(),
        S.render(),
        C.render(),
        P.render(),
    ...
    function K(e) {
      ...
      if (('object' === Za(e) && wo(l, e), !1 !== s.isReady())) {
        ...
        v.wrapper.classList.remove(t.transition),
          ...
          l.shuffle && Re(),
          Eo(v.wrapper, 'embedded', l.embedded),
          Eo(v.wrapper, 'rtl', l.rtl),
          Eo(v.wrapper, 'center', l.center),
          !1 === l.pause && pe(),
          l.previewLinks
    ...
    function $() {
      window.addEventListener('resize', nt, !1),
        l.touch && T.bind(),
        l.keyboard && x.bind(),
        l.progress && P.bind(),
        ...
        l.focusBodyOnPageVisibilityChange && document.addEventListener('visibilitychange', it, !1)
    }
    function X() {
      T.unbind(),
        O.unbind(),
        ...
        P.unbind(),
        L.unbind(),
        window.removeEventListener('resize', nt, !1),
    ...
    function J(e) {
      'string' == typeof e.layout && (f.layout = e.layout),
        ...
        f.layout ? Ao(v.slides, f.layout + ' ' + f.overview) : Ao(v.slides, f.overview)
    }
    function Q(e) {
      var t = e.target,
    ...
    function Z(e, t) {
      if (l.postMessageEvents && window.parent !== window.self) {
        var n = { namespace: 'reveal', eventName: e, state: qe() }
    ...
    function oe() {
      if (v.wrapper && !I.isPrintingPDF()) {
        if (!l.disableLayout) {
          Oo && !l.embedded && document.documentElement.style.setProperty('--vh', 0.01 * window.innerHeight + 'px')
          var e = le(),
            t = h
          se(l.width, l.height),
            ...
            1 === (h = Math.min(h, l.maxScale))
              ? ((v.slides.style.zoom = ''),
                ...
                J({ layout: '' }))
              : h > 1 && jo && window.devicePixelRatio < 2
    ...
    function pe() {
      var e = v.wrapper.classList.contains('paused')
      v.wrapper.classList.remove('paused'), _e(), e && Q({ type: 'resumed' })
    }
    function me(e) {
    ...
    function Se(e, t, o, s) {
      ...
      if (0 !== u.length) {
        void 0 !== t || R.isActive() || (t = ce(u[e])),
          r && r.parentNode && r.parentNode.classList.contains('stack') && ue(r.parentNode, i)
        var c = d.concat()
        d.length = 0
        var h = n || 0,
          f = i || 0
        ...
        p && Q({ type: 'slidechanged', data: { indexh: n, indexv: i, previousSlide: r, currentSlide: a, origin: s } }),
    ...
    function xe(e, t) {
      ...
      if (i) {
          ...
          o.classList.remove('past'),
            ...
            r
              ...
              ? (o.classList.add(s ? 'future' : 'past'),
                l.fragments &&
                  So(o, '.fragment').forEach(function (e) {
                    e.classList.add('visible'), e.classList.remove('current-fragment')
                  }))
              : a > t &&
                (o.classList.add(s ? 'past' : 'future'),
                l.fragments &&
                  So(o, '.fragment.visible').forEach(function (e) {
                    e.classList.remove('visible', 'current-fragment')
                  }))
        }
        var u = n[t],
        ...
        u.classList.add('present'),
          ...
          c || Q({ target: u, type: 'visible', bubbles: !1 })
      ...
      if (r && void 0 !== n) {
        ...
        for (var o = 0; o < r; o++) {
          ...
          if (
            ...
            for (var d = ce(s), h = 0; h < c; h++) {
              var f = u[h]
              e + (o === (n || 0) ? Math.abs((i || 0) - h) : Math.abs(h - d)) < a ? w.load(f) : w.unload(f)
            }
        }
        ze() ? v.wrapper.classList.add('has-vertical-slides') : v.wrapper.classList.remove('has-vertical-slides'),
    ...
    function Ce() {
      var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
        ...
        r = void 0 !== t && t,
        a = v.wrapper.querySelectorAll(uo),
        o = v.wrapper.querySelectorAll(co),
        ...
        t
          ...
          : ((p = l.autoSlide),
            0 === a.querySelectorAll('.fragment').length &&
              So(a, 'video, audio').forEach(function (e) {
    ...
    function $e() {
      p && b && ((b = !1), Q({ type: 'autoslideresumed' }), _e())
    }
    function Xe() {
      ;(c.hasNavigatedHorizontally = !0),
        l.rtl
          ? (R.isActive() || !1 === A.next()) && Ce().left && Se(n + 1, 'grid' === l.navigationMode ? i : void 0)
          : (R.isActive() || !1 === A.prev()) && Ce().left && Se(n - 1, 'grid' === l.navigationMode ? i : void 0)
    }
    function Ye() {
      ;(c.hasNavigatedHorizontally = !0),
        l.rtl
          ? (R.isActive() || !1 === A.prev()) && Ce().right && Se(n - 1, 'grid' === l.navigationMode ? i : void 0)
          : (R.isActive() || !1 === A.next()) && Ce().right && Se(n + 1, 'grid' === l.navigationMode ? i : void 0)
    }
    function Ge() {
    ...
    function Qe() {
      ...
      if (!1 === A.prev())
        if (Ce().up) Ge()
          ...
          (e = l.rtl ? So(v.wrapper, '.slides>section.future').pop() : So(v.wrapper, '.slides>section.past').pop())
        ) {
  ...
  return (
    (Ns.initialize = function (e) {
      return (
        Object.assign(Ns, new Ps(document.querySelector('.reveal'), e)),
        Ms.map(function (e) {
          return e(Ns)
        }),
        Ns.initialize()
